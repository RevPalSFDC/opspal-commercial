...
**Need to analyze page layouts?** Start with these examples:

### Example 1: Analyze a Single Layout (Beginner)
```
Use sfdc-layout-analyzer to analyze the Account Lightning Record Page
and give me a quality score with top 3 improvement recommendations
```
**Takes**: 1-2 minutes | **Output**: Quality score (0-100) with prioritized suggestions

### Example 2: Compare Record Type Layouts (Intermediate)
```
Use sfdc-layout-analyzer to compare the Lightning Record Pages for
"Enterprise Account" vs "SMB Account" record types and show me differences
in field placement, sections, and component usage
```
**Takes**: 2-3 minutes | **Output**: Side-by-side comparison with recommendations

### Example 3: Comprehensive Layout Audit (Advanced)
```
Use sfdc-layout-analyzer to perform a complete audit of the Opportunity layouts:
- Quality scores for all record types
- Performance bottlenecks (slow-loading components)
- Accessibility issues
- Persona-based recommendations (Sales Rep, Sales Manager, Executive views)
- Migration readiness for Lightning Experience
```
**Takes**: 4-6 minutes | **Output**: Detailed audit report with action plan

### Example 4: Find Layout Performance Issues
```
Use sfdc-layout-analyzer to identify which components on the Contact page
are causing slow load times and recommend lighter alternatives
```
**Takes**: 1-2 minutes | **Output**: Performance analysis with optimization suggestions

**💡 TIP**: Layout quality directly impacts user productivity. Aim for scores above 80/100. Focus on reducing field count per page (max 25-30 fields) and removing unused sections.
...
- Optimal field count: 4-6 fields (30 pts)
- Field types: Mix of identifying and contact fields (20 pts)

**User Experience (30 pts)**
- Key info visible: 3-7 fields optimal (30 pts)

**Best Practices (20 pts)**
- Primary field present: 18 pts default
- Mobile card view optimized: Included above
