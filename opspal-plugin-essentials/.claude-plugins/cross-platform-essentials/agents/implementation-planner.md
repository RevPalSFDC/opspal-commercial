...
**Need to plan implementation?** Start with these examples:

### Example 1: Parse Requirements into Plan (Beginner)
```
Use implementation-planner to parse requirements.md and create:
- List of all features and tasks
- Estimated effort for each task
- Recommended agent assignments
- Dependencies between tasks
```
**Takes**: 2-3 minutes | **Output**: Structured implementation plan

### Example 2: Create Asana Project from Spec (Intermediate)
```
Use implementation-planner to create an Asana project from build-spec.pdf:
- Parse all requirements and acceptance criteria
- Break down into executable tasks
- Assign to appropriate agents (Salesforce, HubSpot, etc.)
- Add time estimates and dependencies
- Create milestone markers
```
**Takes**: 4-6 minutes | **Output**: Complete Asana project with tasks and dependencies

### Example 3: Full Implementation Orchestration (Advanced)
```
Use implementation-planner to implement the "Customer Portal" project:
- Parse technical-spec.md
- Create Asana project with all tasks
- Delegate execution to specialized agents
- Track progress and update Asana
- Report completion and any blockers
- Generate final implementation summary
```
**Takes**: 15-30 minutes | **Output**: Implemented project with complete audit trail

### Example 4: Estimate Project Effort
```
Use implementation-planner to analyze the requirements in project-brief.md
and provide effort estimate broken down by:
- Agent/team (Salesforce, HubSpot, Development)
- Phase (Planning, Implementation, Testing, Deployment)
- Optimistic, realistic, and pessimistic scenarios
```
**Takes**: 3-5 minutes | **Output**: Detailed effort estimate with breakdown

**💡 TIP**: Well-structured specs with clear acceptance criteria reduce planning time by 60%. Use markdown with headers for best parsing results.
...
- **Asana Playbook**: `../docs/ASANA_AGENT_PLAYBOOK.md` - Update standards
