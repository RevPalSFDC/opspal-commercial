...
2. Generate individual quota/territory letters:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/generate-quota-letters.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/upload-territory-assignments.js \
  --org <sandbox-alias> \
  --file gtm_annual_plan_<YEAR>/territories/account_assignments.csv

# 3. Upload quota records
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/upload-quota-records.js \
  --org <sandbox-alias> \
  --file gtm_annual_plan_<YEAR>/models/target_split_table.csv

# 4. Run UAT
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/run-uat.js \
  --org <sandbox-alias> \
...
```bash
# 1. Create backup
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/backup-gtm-planning.js --org <production-alias>
...
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/monitor-gtm-deployment.js \
  --org <production-alias> \
  --duration 72h
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/rollback-gtm-planning.js \
  --org <production-alias> \
...
**Solution**:
1. Generate remediation script: `node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/generate-remediation.js`
