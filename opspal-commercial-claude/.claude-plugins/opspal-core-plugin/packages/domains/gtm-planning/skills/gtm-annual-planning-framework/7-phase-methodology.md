...
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/upload-territory-assignments.js --org <sandbox>

# Run UAT
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/run-uat.js --org <sandbox>
```

### Production Cutover
```bash
# Create backup
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/backup-gtm-planning.js --org <production>

# Deploy and monitor
sf project deploy start --target-org <production>
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/monitor-gtm-deployment.js --duration 72h
```
