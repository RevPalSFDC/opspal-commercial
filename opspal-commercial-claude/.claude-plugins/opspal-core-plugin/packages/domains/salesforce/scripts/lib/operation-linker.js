...
Examples:
  ...
  node operation-linker.js record peregrine-main '{"type":"advocate-mapping","outputs":["advocate-analysis.json"],"stats":{"recordCount":134}}'

  # Discover integrations for renewal import
  node operation-linker.js discover peregrine-main renewal-import

  # List all operations
  node operation-linker.js list peregrine-main

  # List only renewal imports
  node operation-linker.js list peregrine-main renewal-import

  # Link renewal import to advocate mapping
  node operation-linker.js link peregrine-main renewal-import-2025-10-03-a3f4 advocate-mapping-2025-10-02-b7k9

  # Clean operations older than 30 days
  node operation-linker.js clean peregrine-main 30

  # Export operation graph
  node operation-linker.js graph peregrine-main
            `);
    }
}
