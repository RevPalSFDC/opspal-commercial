...
const jsonbWrapperPath = path.resolve(__dirname, '../../../../opspal-core/developer-tools-plugin/scripts/lib/supabase-jsonb-wrapper.js');
...
const dataQualityEnforcerPath = path.resolve(__dirname, '../../../../opspal-core/cross-platform-plugin/scripts/lib/reflection-data-quality-enforcer.js');
...
const taxonomyClassifierPath = path.resolve(__dirname, '../../../../opspal-core/cross-platform-plugin/scripts/lib/taxonomy-classifier.js');
...
async function submitReflection(reflectionPath) {
  ...
  try {
    ...
    console.log('   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/query-reflections.js recent');
    console.log('   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/query-reflections.js topIssues');
