...
class ErrorRecovery {
    ...
    categorizeError(error) {
        ...
        if (message.includes('invalid field') ||
            ...
            return ErrorCategory.FIELD_ERROR;
        }
        ...
        if (message.includes('required field missing') ||
            ...
            return ErrorCategory.REQUIRED_FIELD;
        }
...
if (require.main === module) {
    (async () => {
        ...
        if (args.length < 2) {
            ...
            console.log('  enhanced-error-recovery.js wedgewood-production stats');
            console.log('  enhanced-error-recovery.js wedgewood-production reset');
            process.exit(1);
        }
