...
```javascript
const BulkOperationValidator = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-operation-validator');
...
```javascript
const { BusinessProcessCoverageTracker } = require('../../../opspal-core/cross-platform-plugin/scripts/lib/business-process-coverage-tracker');
...
```javascript
const { UserExpectationTracker } = require('../../../opspal-core/cross-platform-plugin/scripts/lib/user-expectation-tracker');
...
```javascript
const QualityGateValidator = require('../../../opspal-core/cross-platform-plugin/scripts/lib/quality-gate-validator');
...
```javascript
const { asanaTaskReader } = require('../../../opspal-core/cross-platform-plugin/scripts/lib/asana-task-reader');
...
```javascript
const formatter = require('../../../opspal-core/cross-platform-plugin/scripts/lib/asana-update-formatter');
const commentMgr = require('../../../opspal-core/cross-platform-plugin/scripts/lib/asana-comment-manager');
...
async function completeCPQAssessment(orgAlias, asanaTaskId) {
    ...
    const orgValidator = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-context-validator');
...
- Asana: `../../../opspal-core/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md`
