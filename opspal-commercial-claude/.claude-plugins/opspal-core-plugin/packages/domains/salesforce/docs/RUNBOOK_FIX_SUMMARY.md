...
**File**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/generate-enhanced-runbook.sh`
...
**File**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/RUNBOOK_GENERATION_TROUBLESHOOTING.md`
...
bash .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/generate-enhanced-runbook.sh peregrine-production
```
...
```bash
export CLAUDE_PLUGIN_ROOT=$(pwd)/.claude-plugins/opspal-core-plugin/packages/domains/salesforce
/generate-runbook
```
...
- Implementation: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/generate-enhanced-runbook.sh`
- Path Utilities: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/path-conventions.js`
- Troubleshooting: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/RUNBOOK_GENERATION_TROUBLESHOOTING.md`
