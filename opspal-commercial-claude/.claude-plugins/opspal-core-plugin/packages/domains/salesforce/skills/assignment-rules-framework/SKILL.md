...
# Detect conflicts
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-overlap-detector.js detect --rule-file <json-file>
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js validate --rule-file <json-file> --org [org]

# Deploy rule
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js deploy --rule-xml <xml-file> --org [org]

# Activate rule
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js activate --rule-name "<name>" --object <Lead|Case> --org [org]
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/criteria-evaluator.js Lead.assignmentRules-meta.xml sample-leads.json
```
...
```bash
# Check entry count
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-parser.js Lead.assignmentRules-meta.xml | grep "Entries:"
