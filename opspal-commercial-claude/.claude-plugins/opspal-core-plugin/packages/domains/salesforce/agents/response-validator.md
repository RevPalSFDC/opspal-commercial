...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type validation --format json)`
...
**Location**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/lib/response-sanity-checker.js`
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/response-sanity-checker.js validate \
  --response /path/to/response.txt \
  --context org=rentable-sandbox,operation=field-analysis
...
**Settings Location**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/.claude-plugin/settings.json`
...
```bash
#!/bin/bash
# Location: .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/hooks/post-agent-response.sh
...
# Run smart detection
NEEDS_VALIDATION=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-detection.js check \
