...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-complexity-calculator.js calculate \
...
```bash
# Start segment
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-segment-manager.js start \
  --name Sales_Manager \
  --segment-type metadata

# Complete segment
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-segment-manager.js complete \
  --name Sales_Manager \
  --segment-type metadata

# List segments
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-segment-manager.js list --name Sales_Manager

# Get status
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-segment-manager.js status \
  --name Sales_Manager \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-anti-pattern-detector.js detect \
  --permission-set ./force-app/main/default/permissionsets/Sales_Manager.permissionset-meta.xml
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-complexity-calculator.js breakdown \
  --permission-set Sales_Manager

# Identify refactoring candidates
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-refactoring-suggester.js suggest \
  --permission-set Sales_Manager
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-anti-pattern-detector.js report \
  --permission-set Sales_Manager

# Apply fix
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-anti-pattern-fixer.js fix \
  --permission-set Sales_Manager \
