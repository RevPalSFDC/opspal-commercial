...
# Example: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field sample-org-production Contact Practice
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/picklist-describer.js describe <object>
