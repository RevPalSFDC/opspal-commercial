...
```bash
# Safe CPQ Quote creation
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-write-operations.js createRecordSafe SBQQ__Quote__c myorg \
  --payload '{
    "Name":"Q-12345",
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field <org> Product2 Price
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field <org> Quote Total

# Get complete CPQ object metadata
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> Product2
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> Quote
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> QuoteLineItem | jq '.fields[] | select(.name | contains("Price"))'
```
...
Setting up products
  ↓
1. Run: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> Product2
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/cpq-field-validator.js <org> --matrix

# Validate specific fields
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/cpq-field-validator.js <org> --report data/field-validation.json
```

**2. Relationship Name Resolver** (`scripts/lib/relationship-name-resolver.js`)
```bash
# Map actual child relationship names
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/relationship-name-resolver.js <org> --map

# Get specific relationship
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/relationship-name-resolver.js <org> --get SBQQ__DiscountSchedule__c SBQQ__DiscountTier__c
```

**3. Safe Query Executor** (`scripts/lib/safe-query-executor.js`)
```bash
# Validate SOQL before execution
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/safe-query-executor.js validate "<soql>"

# Execute with auto-cleaning
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/safe-query-executor.js execute <org> "<soql>"
```
...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type cpq_operations --format json)`
