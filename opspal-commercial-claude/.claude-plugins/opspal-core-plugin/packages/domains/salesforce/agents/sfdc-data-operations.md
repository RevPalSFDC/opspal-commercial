...
@import ../../../opspal-core/shared-docs/context7-usage-guide.md
...
```javascript
const BulkJobStatusChecker = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-job-status-checker.js');
...
const DataQualityFramework = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/data-quality-framework');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js smartOperation update Account data.json

# Batch queries
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/batch-query-executor.js --object Account --batchSize 200

# API call optimization
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --batch-operations --optimize-calls
```
...
2. If not present, run: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/init-project.sh "project-name" "org-alias"`
