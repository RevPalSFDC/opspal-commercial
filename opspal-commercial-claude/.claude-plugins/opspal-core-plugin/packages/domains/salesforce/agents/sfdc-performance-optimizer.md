...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --monitor-all --alert-threshold 80

# Generate EXPLAIN plans for slow queries
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --explain-queries --performance-threshold 1000

# Benchmark query performance
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --benchmark --object Account --compare-indexes

# Monitor specific operations
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --monitor-operations --track-limits --alert-email

# Optimize bulk operations
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --operation query --monitor-performance --optimize-chunks

# Use composite API for efficient operations
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --batch-operations --monitor-limits --optimize-calls
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --monitor-all --performance-dashboard --alert-email admin@company.com

# Monitor specific objects with detailed analysis
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --monitor-objects "Account,Contact,Opportunity" --generate-explain-plans --performance-threshold 500

# Benchmark query performance improvements
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --benchmark-queries --compare-before-after --optimization-tracking

# Real-time governor limit monitoring
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --monitor-limits --alert-threshold 80 --trend-analysis --predictive-alerts
```

### Bulk Operation Performance Monitoring
```bash
# Monitor bulk operations with performance tracking
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --operation import --monitor-performance --optimize-chunks --alert-slow-operations

# Performance comparison between API types
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --compare-apis --benchmark-performance --generate-recommendations

# Monitor and optimize large data operations
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --operation query --size-threshold 10000 --performance-monitoring --adaptive-optimization
```

### Composite API Performance Optimization
```bash
# Monitor API call efficiency
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --monitor-efficiency --track-call-reduction --performance-analytics

# Optimize batch operations with monitoring
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --batch-optimize --monitor-limits --efficiency-reporting

# Performance benchmarking for batch operations
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --benchmark-batches --compare-strategies --optimization-recommendations
```
