...
- **Design Guidelines**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/REPORT_DASHBOARD_DESIGN_GUIDELINES.md`
- **sfdc-report-designer Agent**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-report-designer.md`
- **sfdc-dashboard-designer Agent**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-dashboard-designer.md`
- **sfdc-reports-dashboards Agent**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-reports-dashboards.md`
