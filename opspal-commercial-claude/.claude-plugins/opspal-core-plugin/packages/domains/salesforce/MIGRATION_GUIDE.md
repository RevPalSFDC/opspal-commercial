...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/routing-toolkit.js validate

# Test your migration
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/routing-toolkit.js test "your operation here"

# Analyze usage
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/routing-toolkit.js analyze
```
