...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-best-practices-validator.js ./flows/MyFlow.flow-meta.xml --verbose
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-version-manager.js listVersions MyFlow myorg

# Rollback to previous version if needed
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-version-manager.js activateVersion MyFlow 4 myorg
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-metadata-operations.js deployFieldPlusFlsPlusRT <object> <org> \
  --fields '[...]'
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-version-manager.js activateVersion MyFlow 3 myorg
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-version-manager.js cleanup MyFlow myorg --keep 5
```
...
- **CLI Help**: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-metadata-operations.js --help`
