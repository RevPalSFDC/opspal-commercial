...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-orchestrator-optimizer.js <options>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-orchestrator-optimizer.js --portal my-portal
```
