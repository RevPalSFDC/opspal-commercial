...
HEAD=1 PORTAL=example-company node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/scrape-sfdc-sync-settings.js
```
...
```bash
# Use saved session
PORTAL=example-company node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/scrape-sfdc-sync-settings.js
```
...
1. Run script in headed mode: `HEAD=1 PORTAL=x node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/scrape-sfdc-sync-settings.js`
...
- [HubSpot UI Patterns](../../../opspal-core/cross-platform-plugin/runbooks/playwright/hubspot-ui-patterns.md)
- [Authentication Patterns](../../../opspal-core/cross-platform-plugin/runbooks/playwright/authentication-patterns.md)
- [Screenshot Documentation](../../../opspal-core/cross-platform-plugin/runbooks/playwright/screenshot-documentation.md)
