...
if [[ -f "$ERROR_HANDLER" ]]; then
    ...
    # Lenient mode - reflection submission should not block
...
if [ ! -f "$SUBMIT_SCRIPT" ]; then
    ...
    echo -e "      ${GREEN}/plugin list | grep hubspot-plugin${NC}"
    echo -e ""
    echo -e "   2. Reinstall plugin from marketplace:"
    echo -e "      ${GREEN}/plugin uninstall hubspot-plugin@revpal-internal-plugins${NC}"
    echo -e "      ${GREEN}/plugin install hubspot-plugin@revpal-internal-plugins${NC}"
    echo -e ""
...
if node "$SUBMIT_SCRIPT" "$REFLECTION_FILE" 2>&1; then
    echo -e "${GREEN}✅ Submission successful${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    exit 0
else
    echo -e "${RED}⚠️  Submission failed${NC}"
    echo -e "   Reflection saved locally: $REFLECTION_FILE"
    echo -e "   You can manually submit later:"
    echo -e "   ${YELLOW}node $SUBMIT_SCRIPT $REFLECTION_FILE${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
