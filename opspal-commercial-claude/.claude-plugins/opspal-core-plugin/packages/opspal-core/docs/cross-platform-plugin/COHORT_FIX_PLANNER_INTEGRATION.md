...
**Location:** `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/cohort-fix-planner.js`  
...
```javascript
const { CohortFixPlanner } = require('./.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/cohort-fix-planner');
...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/cohort-fix-planner.js tool-contract
