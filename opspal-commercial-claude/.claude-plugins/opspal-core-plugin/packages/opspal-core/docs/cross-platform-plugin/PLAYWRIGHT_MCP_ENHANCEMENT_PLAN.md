...
**File**: `cross-platform-plugin/scripts/lib/playwright-mcp-helper.js`
...
**File**: `cross-platform-plugin/runbooks/playwright/setup-and-configuration.md`
...
**File**: `cross-platform-plugin/scripts/lib/playwright-network-inspector.js`
...
**File**: `cross-platform-plugin/scripts/lib/playwright-console-monitor.js`
...
**File**: `cross-platform-plugin/scripts/lib/playwright-compatibility-layer.js`
...
**File**: `cross-platform-plugin/scripts/lib/task-router.js`
...
### Cross-Platform Plugin (7 agents)
...
- **Existing Scrapers**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-*.js`
- **Current Command**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/commands/playwright-test.md`
- **Salesforce Plugin**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/CLAUDE.md`
- **HubSpot Plugin**: `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/CLAUDE.md`
- **Cross-Platform Plugin**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/CLAUDE.md`
