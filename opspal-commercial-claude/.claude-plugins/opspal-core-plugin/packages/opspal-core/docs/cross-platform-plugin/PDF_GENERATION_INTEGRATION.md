...
- `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/executive-reporter.js` (lines 54-56 - PDF stub)
- `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/pdf-generator.js` (Complete implementation)
- `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/agents/pdf-generator.md` (Agent documentation)
