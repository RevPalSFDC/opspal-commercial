...
```javascript
{
  ...
  "discovered": [
    {
      ...
      "scope": "plugin:cross-platform-plugin",
      "path": ".claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/agents/plugin-doctor.md",
      "fields": {
        "name": "plugin-doctor",
  ...
  "failed": [
    {
      "path": ".claude-plugins/opspal-core-plugin/packages/domains/hubspot/agents/custom.md",
      "filename": "custom.md",
  ...
  "duplicates": [
    {
      ...
      "locations": [
        {
          "path": ".claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-custom-validator.md",
