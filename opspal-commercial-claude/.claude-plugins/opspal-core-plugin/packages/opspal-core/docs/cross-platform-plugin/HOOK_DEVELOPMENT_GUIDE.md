...
**Location**: `cross-platform-plugin/hooks/lib/error-handler.sh`
...
source "$(dirname "${BASH_SOURCE[0]}")/../../../cross-platform-plugin/hooks/lib/error-handler.sh"
...
- Error Handler Library: `cross-platform-plugin/hooks/lib/error-handler.sh`
