...
- **Hook File**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/hooks/pre-compact.sh`
- **Hook Type**: PreCompact
- **Registered In**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/.claude-plugin/hooks.json`
...
jq '.hooks.PreCompact' .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/.claude-plugin/hooks.json

# 3. Trigger hook manually (if transcript exists)
bash .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/hooks/pre-compact.sh
...
- **Hook File**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/hooks/post-tool-use.sh`
...
- **Library File**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/status-line-helper.js`
...
# Test batch helper
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/status-line-helper.js test-batch
```
...
- **Library File**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/hook-logger.js`
- **Type**: JavaScript library
...
# Only errors
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/hook-logger.js query post-tool-use error

# All hooks
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/hook-logger.js query '*'
```

**Analytics Summary:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/hook-logger.js analytics post-tool-use
```
...
- **Template Directory**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/output-styles/`
- **Formatter Library**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/output-formatter.js`
...
- **Dashboard Script**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js`
...
**Performance Metrics:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js performance
```
...
**Error Analysis:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js errors
```

**Trend Analysis (Last N Days):**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js trends 30
```

**Generate Report:**
```bash
# Markdown report to stdout
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js report markdown

# JSON report to stdout
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js report json

# Save to file
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js report markdown --save
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js watch 3000
```
...
- **Implementation**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/hooks/`
- **Hook Configuration**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/.claude-plugin/hooks.json`
