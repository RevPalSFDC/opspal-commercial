...
**Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/automation-audit-v2-orchestrator.js`
...
**Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/executive-reporter.js`
...
**Cause**: Incorrect relative path to cross-platform-plugin

**Fix**: Use correct relative path:
```javascript
// From salesforce-plugin/scripts/lib/
require('../../../cross-platform-plugin/scripts/lib/pdf-generator')
