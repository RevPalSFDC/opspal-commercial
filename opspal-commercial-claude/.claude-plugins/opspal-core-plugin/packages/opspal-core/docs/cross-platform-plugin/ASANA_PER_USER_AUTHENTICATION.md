...
**Default Workspace**: `REDACTED_WORKSPACE_ID`
...
# Test the token
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-auth-helper.js test

# Get your user info
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-auth-helper.js whoami
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-auth-helper.js check
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-auth-helper.js setup
```
...
**Problem**: `Token works but you don't have access to workspace REDACTED_WORKSPACE_ID`
...
2. Check workspace settings: https://app.asana.com/0/REDACTED_WORKSPACE_ID/settings
...
1. Invite user to workspace `REDACTED_WORKSPACE_ID`
