...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/generate-v3-29-0-pdf.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/hook-analytics-dashboard.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/test-asana-integration-e2e.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/test-mermaid-lucid-conversion.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/validate-pdf-integration.js
```
