...
- **Salesforce diagrams**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/instances/<org>/diagrams/`
- **HubSpot diagrams**: `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/instances/<portal>/diagrams/`
- **Cross-platform**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/diagrams/`
