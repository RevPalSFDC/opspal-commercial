...
**Core Scripts** (`.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/solution-template-system/core/`):
...
**Deployers** (`.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/solution-template-system/deployers/`):
...
**Tracking** (`.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/solution-template-system/tracking/`):
