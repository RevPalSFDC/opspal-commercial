...
- **Asana Task Manager Agent**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/agents/asana-task-manager.md` (reference implementation)
