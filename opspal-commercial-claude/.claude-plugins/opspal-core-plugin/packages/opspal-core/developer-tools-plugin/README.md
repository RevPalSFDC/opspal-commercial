...
> - `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/` - Salesforce user features
> - `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/` - HubSpot user features
> - `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/` - Cross-platform user features
>
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/analyze-dependencies.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/announce-marketplace.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/build-marketplace-catalog.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/generate-test-suite.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/scaffold-plugin.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/send-plugin-release-notification.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/test-plugin-installation.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/test-slack-simple.js
```
