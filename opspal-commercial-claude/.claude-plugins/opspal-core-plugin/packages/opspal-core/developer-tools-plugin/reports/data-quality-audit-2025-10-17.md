...
**Analysis:**
- CSV parser (.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/csv-parser.js) does not preserve newlines within quoted fields
...
**Component:** `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-operation-validator.js`
...
**Component:** `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-workflow-auditor.js`
...
**Severity:** Low
**Priority:** P3
**Component:** `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/csv-parser.js`
...
**Full inventory:** See `.claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/reports/validation-coverage-map.md`
