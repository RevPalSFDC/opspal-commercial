...
class WorkPacketBuilder {
  constructor(options = {}) {
    ...
    this.agentRegistry = {
      'salesforce-apex': 'salesforce-plugin:sfdc-apex-developer',
      'salesforce-flow': 'salesforce-plugin:flow-segmentation-specialist',
      'salesforce-metadata': 'salesforce-plugin:sfdc-metadata-manager',
      'salesforce-data': 'salesforce-plugin:sfdc-data-operations',
      'salesforce-permission': 'salesforce-plugin:sfdc-permission-orchestrator',
      'salesforce-report': 'salesforce-plugin:sfdc-reports-dashboards',
      ...
      'data-migration': 'salesforce-plugin:sfdc-data-operations',
      'data-validation': 'data-validation-agent',
      'integration': 'salesforce-plugin:sfdc-integration-specialist',
      'cross-platform': 'unified-orchestrator',
      'documentation': 'documentation-agent',
      'review': 'salesforce-plugin:code-reviewer'
    };
  }
