...
async function diagnose(projectPath) {
  ...
  if (hasIssues) {
    ...
    console.log('  3. Post-reflect hook did not run (check .claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/)');
    ...
    console.log('  • Manually submit: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/submit-reflection.js .claude/SESSION_REFLECTION_*.json');
    ...
    console.log('  • Run: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/query-reflections.js recent');
  }
