...
class MigrationExecutor {
  ...
  async migrateAgents() {
    ...
    const agentUpdates = {
      'sfdc-revops-auditor': this.updateRevOpsAuditor,
      'sfdc-cpq-assessor': this.updateCPQAssessor,
      'sfdc-automation-auditor': this.updateAutomationAuditor
    };
    ...
    for (const [agentName, updateFn] of Object.entries(agentUpdates)) {
...
**Service Contract**: See \`.claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/config/central_services.json\`
