...
cp .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/templates/specifications/salesforce-implementation.md ./specs/my-project.md

# HubSpot workflow
cp .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/templates/specifications/hubspot-workflow.md ./specs/my-workflow.md

# Integration project
cp .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/templates/specifications/integration-project.md ./specs/my-integration.md
```
...
- **Implementation Planner Agent**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/agents/implementation-planner.md`
- **Plan Generator Script**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/project-plan-generator.js`
- **Asana Playbook**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md`
- **Templates**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/templates/specifications/`
