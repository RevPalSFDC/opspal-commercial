...
✓ Copied to: .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/solutions/installed/lead-management/
...
Target: .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/solutions/installed/lead-management
...
```
.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/solutions/installed/<solution-name>/
```
