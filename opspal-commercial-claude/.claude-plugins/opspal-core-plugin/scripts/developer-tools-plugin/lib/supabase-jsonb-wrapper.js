 ...
 *
 * Searches in order:
 * 1. .claude-plugins/developer-tools-plugin/schemas/{tableName}-schema.json
 * 2. .claude-plugins/salesforce-plugin/schemas/{tableName}-schema.json
 * 3. .claude-plugins/hubspot-core-plugin/schemas/{tableName}-schema.json
 *
