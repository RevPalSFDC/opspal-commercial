...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-cli.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/post-deployment-state-verifier.js <org-alias> ValidationRule Opportunity.Require_Closed_Date_When_Won
...
# 1. Assess complexity
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-complexity-calculator.js assess --formula-length 80 --nesting-depth 1 --field-count 2
...
# 3. Dry run
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-cli.js --input instances/myOrg/validation-rules/Account-validation-rules.json --org myOrg --dry-run

# 4. Deploy
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-cli.js --input instances/myOrg/validation-rules/Account-validation-rules.json --org myOrg
```
...
# 1. Assess complexity
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-complexity-calculator.js assess --formula-length 380 --nesting-depth 5 --field-count 8
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-validation-bypass.js deactivate \
  --org myOrg \
  --object Opportunity \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-validation-bypass.js reactivate --org myOrg --object Opportunity
```
...
```bash
# Export from sandbox
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-migrator.js export \
  --org devOrg \
  --object Opportunity \
...
```javascript
const ValidationRuleOrchestrator = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-orchestrator');
...
```
COMMAND SYNTAX:
  node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-cli.js --input <file> --org <org> [--dry-run] [--verbose]
