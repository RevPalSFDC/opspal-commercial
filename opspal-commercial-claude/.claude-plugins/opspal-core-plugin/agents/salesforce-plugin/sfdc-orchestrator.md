...
node ../cross-platform-plugin/scripts/lib/progress-monitor.js status

# Run a progress check
node ../cross-platform-plugin/scripts/lib/progress-monitor.js check --verbose

# Capture snapshot
node ../cross-platform-plugin/scripts/lib/progress-monitor.js snapshot --json

# Reset after user provides input
node ../cross-platform-plugin/scripts/lib/progress-monitor.js reset
```
