...
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/hubspot-merge-strategy-selector.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-lift-and-shift.js \
...
**Command**:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-clustering-engine.js <snapshot-file>
```
...
**Command**:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-canonical-selector.js <bundles-file> [config]
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-executor.js <canonical-map> <config>

# Live execution after approval
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-executor.js <canonical-map> <config> --execute
```
...
**Critical Discovery** (Rentable cleanup):
