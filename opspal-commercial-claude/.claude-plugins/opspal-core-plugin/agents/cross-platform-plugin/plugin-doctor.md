...
1. Agent Discovery Failure (5 occurrences)
   ...
   Location: .claude-plugins/hubspot-plugin/agents/hubspot-workflow-orchestrator.md:1-5
...
1. hubspot-workflow-orchestrator
   Location: .claude-plugins/hubspot-plugin/agents/hubspot-workflow-orchestrator.md
   Issue: Missing required field 'name' in YAML frontmatter
   Fix: Add 'name: hubspot-workflow-orchestrator' to frontmatter

2. sfdc-custom-validator (DUPLICATE NAME)
   Location 1: .claude-plugins/salesforce-plugin/agents/sfdc-custom-validator.md
...
`.claude-plugins/cross-platform-plugin/scripts/lib/`
...
- **User Guide**: `.claude-plugins/cross-platform-plugin/docs/PLUGIN_DOCTOR_GUIDE.md`
- **Developer Guide**: `.claude-plugins/cross-platform-plugin/docs/PLUGIN_DOCTOR_INTERNALS.md`
- **Reflection System**: `.claude-plugins/salesforce-plugin/commands/reflect.md`
