...
**User Input:**
```
"Run a revenue operations audit for the hivemq org"
```
...
3. Verify agent file exists: `ls .claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/`
...
- **Auto-Router Script**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/auto-agent-router.js`
- **Hook Script**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/user-prompt-hybrid.sh`
