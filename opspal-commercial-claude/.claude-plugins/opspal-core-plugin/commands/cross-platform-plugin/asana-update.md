---
description: Update or create Asana tasks based on HubSpot work completed in linked project
...
## OBJECTIVE
Analyze HubSpot work completed in the current directory and either update existing Asana tasks or create new ones in the linked Asana projects. Uses `.asana-links.json` to determine which projects to update.
...
- Get workspace, project GIDs, and HubSpot portal context
...
- Add file references
- Include portal context (which HubSpot portal)
...
- Include HubSpot portal ID in description
...
---
Auto-generated from HubSpot work on [timestamp]
Portal: {portal_name}
```
...
**Flow:**
1. Scan directory for HubSpot work indicators
...
### Mode 2: Interactive
Ask user to describe HubSpot work completed.

**Flow:**
1. Prompt: "Describe the HubSpot work you completed:"
2. Ask: "Which portal? (production/sandbox/staging)"
3. User provides summary and portal
4. Confirm files/changes
5. Generate task(s) with portal context
6. Apply to Asana
...
**Example 1: Automatic detection with portal context**
```
User: /asana-update
Assistant: Scanning directory for completed HubSpot work...
