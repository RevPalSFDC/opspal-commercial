...
```javascript
const { AsanaTaskReader } = require('./.claude-plugins/cross-platform-plugin/scripts/lib/asana-task-reader');
...
```bash
# Parse specific task
node ./.claude-plugins/cross-platform-plugin/scripts/lib/asana-task-reader.js 1211748609238981
