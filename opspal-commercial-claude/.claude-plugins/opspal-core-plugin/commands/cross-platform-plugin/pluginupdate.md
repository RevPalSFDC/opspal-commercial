...
```bash
node .claude-plugins/cross-platform-plugin/scripts/lib/plugin-update-manager.js
```
...
```bash
node .claude-plugins/cross-platform-plugin/scripts/lib/plugin-update-manager.js --check-only
```
...
```bash
node .claude-plugins/cross-platform-plugin/scripts/lib/plugin-update-manager.js --fix
```
...
```bash
node .claude-plugins/cross-platform-plugin/scripts/lib/plugin-update-manager.js --verbose
```
