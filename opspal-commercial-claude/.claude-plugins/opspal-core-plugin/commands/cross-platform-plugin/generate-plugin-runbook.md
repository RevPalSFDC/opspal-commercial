...
/generate-plugin-runbook --plugin .claude-plugins/salesforce-plugin

# Generate with custom output
/generate-plugin-runbook --plugin .claude-plugins/hubspot-plugin --output ./docs
```
...
node .claude-plugins/cross-platform-plugin/scripts/lib/runbook-framework/plugin-runbook-generator.js \
...
✅ Plugin runbook generated successfully!
   Output: .claude-plugins/salesforce-plugin/docs/runbooks
```
