...
2. **Based on configuration method:**
   ...
   **If "Create new config file":**
   - Generate template: `node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-config-loader.js template > dedup-config.json`
   - Show template location
   - Wait for user to edit file
   - Validate config: `node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-config-loader.js validate dedup-config.json`

   **If "Use existing config":**
   - Ask for config file path
   - Validate: `node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-config-loader.js validate {path}`
...
- **Ledger**: `node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-ledger.js --help`
- **Configuration**: `node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/dedup-config-loader.js --help`
