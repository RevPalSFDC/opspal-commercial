...
**Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/flows/`
...
```javascript
const { TemplateRegistry } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-template-registry');
...
```javascript
const FlowNLPModifier = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-nlp-modifier');
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-author.js create \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-nlp-modifier.js \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js \
  --flow "./flows/MyFlow.flow-meta.xml" \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-deployment-manager.js deploy \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.fixed.flow-meta.xml --checks all
```
...
for flow in flows/*.xml; do
  echo "=== $flow ==="
  node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js "$flow" --auto-fix --dry-run
done
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-template-registry.js apply lead-assignment \
  --name CA_Lead_Assignment \
  --params "assignmentField=State,assignmentValue=California"

# 2. Auto-fix generated Flow
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js CA_Lead_Assignment.xml --auto-fix
...
# Apply fixes
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js flows/MyFlow.xml --auto-fix
...
for flow in legacy-flows/*.fixed.xml; do
  node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js "$flow" --checks all
done
```
...
- name: Validate Fixed Flows
  run: |
    for flow in flows/*.fixed.xml; do
      node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js "$flow" --checks all --sarif --output report.sarif
    done
...
- **Flow CLI Reference**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/FLOW_CLI_REFERENCE.md`
- **Template Library**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/flows/README.md`
- **NLP Modifier Guide**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-nlp-modifier.md`
