...
node .claude-plugins/cross-platform-plugin/scripts/lib/playwright-mcp-helper.js help

# Verify session status
node .claude-plugins/cross-platform-plugin/scripts/lib/playwright-mcp-helper.js check-session myorg salesforce
```
...
node .claude-plugins/salesforce-plugin/scripts/scrape-sf-connected-apps.js
```
