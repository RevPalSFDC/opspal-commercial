...
run_tests() {
  ...
  # Run validation
  if [ -f "$MARKETPLACE_ROOT/.claude-plugins/developer-tools-plugin/scripts/validate-plugin.js" ]; then
    node "$MARKETPLACE_ROOT/.claude-plugins/developer-tools-plugin/scripts/validate-plugin.js" "$PLUGIN_DIR" || {
  ...
  if [ -f "$MARKETPLACE_ROOT/.claude-plugins/developer-tools-plugin/scripts/test-plugin-installation.js" ]; then
    node "$MARKETPLACE_ROOT/.claude-plugins/developer-tools-plugin/scripts/test-plugin-installation.js" \
...
send_slack_notification() {
  ...
  SCRIPT_PATH="$MARKETPLACE_ROOT/.claude-plugins/developer-tools-plugin/scripts/send-plugin-release-notification.js"
...
regenerate_catalog() {
  ...
  CATALOG_SCRIPT="$MARKETPLACE_ROOT/.claude-plugins/developer-tools-plugin/scripts/build-marketplace-catalog.js"
