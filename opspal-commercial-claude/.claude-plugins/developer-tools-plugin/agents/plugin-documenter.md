  ...
  check-docs:
    ...
    steps:
      ...
      - name: Generate Documentation
        run: |
          node .claude-plugins/developer-tools-plugin/scripts/generate-readme.js --all
...
3. Verify script path is correct: `.claude-plugins/developer-tools-plugin/scripts/generate-readme.js`
4. Check file permissions: `ls -la .claude-plugins/developer-tools-plugin/scripts/*.js`
