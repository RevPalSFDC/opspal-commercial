...
1. **Run the plugin validator**:
   ```bash
   node .claude-plugins/developer-tools-plugin/scripts/validate-plugin.js <plugin-directory>
   ```
...
node .claude-plugins/developer-tools-plugin/scripts/validate-plugin.js .claude-plugins/salesforce-plugin
```
...
```bash
node .claude-plugins/developer-tools-plugin/scripts/validate-plugin.js . --json
```
