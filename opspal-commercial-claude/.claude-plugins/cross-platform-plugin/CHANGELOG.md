...
node .claude-plugins/cross-platform-plugin/scripts/hook-analytics-dashboard.js watch
```
...
- Documentation: `.claude-plugins/cross-platform-plugin/docs/HOOK_ENHANCEMENTS_2025-11.md`
...
# Get analytics
node .claude-plugins/cross-platform-plugin/scripts/lib/hook-logger.js analytics
```
