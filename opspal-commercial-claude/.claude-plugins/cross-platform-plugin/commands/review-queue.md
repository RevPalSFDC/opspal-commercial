...
node .claude-plugins/cross-platform-plugin/scripts/lib/governance/review-queue.js list

# Approve via script
node .claude-plugins/cross-platform-plugin/scripts/lib/governance/review-queue.js approve \
  --id rev_abc123 \
  --user $(whoami)

# Export pending to JSON
node .claude-plugins/cross-platform-plugin/scripts/lib/governance/review-queue.js export \
  --format json \
