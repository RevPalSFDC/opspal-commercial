...
```
.claude-plugins/cross-platform-plugin/
├── agents/
...
- **Existing Scrapers**: `.claude-plugins/salesforce-plugin/scripts/scrape-*.js`
- **Current Command**: `.claude-plugins/salesforce-plugin/commands/playwright-test.md`
- **Salesforce Plugin**: `.claude-plugins/salesforce-plugin/CLAUDE.md`
- **HubSpot Plugin**: `.claude-plugins/hubspot-plugin/CLAUDE.md`
- **Cross-Platform Plugin**: `.claude-plugins/cross-platform-plugin/CLAUDE.md`
