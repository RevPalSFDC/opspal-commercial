...
**Location**: `.claude-plugins/salesforce-plugin/scripts/lib/automation-audit-v2-orchestrator.js`
...
**Location**: `.claude-plugins/salesforce-plugin/scripts/lib/executive-reporter.js`
