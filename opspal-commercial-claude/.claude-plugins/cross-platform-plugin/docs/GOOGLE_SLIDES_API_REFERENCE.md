...
**Path:** `.claude-plugins/cross-platform-plugin/scripts/lib/google-slides-manager.js`
...
**Path:** `.claude-plugins/cross-platform-plugin/scripts/lib/google-slides-content-generator.js`
...
**Path:** `.claude-plugins/cross-platform-plugin/scripts/lib/google-slides-layout-engine.js`
...
**Path:** `.claude-plugins/cross-platform-plugin/scripts/lib/google-slides-template-manager.js`
