...
node .claude-plugins/cross-platform-plugin/scripts/lib/plugin-version-checker.js --format=json

# Text output (human-readable)
node .claude-plugins/cross-platform-plugin/scripts/lib/plugin-version-checker.js --format=text

# Force refresh cache
node .claude-plugins/cross-platform-plugin/scripts/lib/plugin-version-checker.js --force-refresh
```
...
```bash
# Basic tests
bash .claude-plugins/cross-platform-plugin/scripts/lib/test-version-checker.sh

# Verbose output
bash .claude-plugins/cross-platform-plugin/scripts/lib/test-version-checker.sh --verbose
```
...
2. Check GitHub API manually:
   ...
   curl -H "Accept: application/vnd.github.v3+json" \
     "https://api.github.com/repos/RevPalSFDC/opspal-plugin-internal-marketplace/contents/.claude-plugins/salesforce-plugin/.claude-plugin/plugin.json" \
