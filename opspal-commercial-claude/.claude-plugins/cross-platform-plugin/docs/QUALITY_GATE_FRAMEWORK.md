...
node .claude-plugins/cross-platform-plugin/scripts/lib/quality-gate-validator.js \
  report_generation \
...
bash .claude-plugins/cross-platform-plugin/hooks/post-task-verification.sh <<EOF
{
  "taskType": "deployment",
  "deliverable": {
    "status": "success",
...
Edit `.claude-plugins/cross-platform-plugin/config/quality-gate-rules.json`:
...
```
.claude-plugins/cross-platform-plugin/scripts/lib/quality-gate-validator.js
```
...
```
.claude-plugins/cross-platform-plugin/config/quality-gate-rules.json
```
