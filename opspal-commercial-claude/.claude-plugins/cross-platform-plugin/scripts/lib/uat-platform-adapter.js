    ...
    try {
      switch (this.platform) {
        case 'salesforce':
          ...
          const SalesforceAdapter = require('../../salesforce-plugin/scripts/lib/uat-salesforce-adapter');
        ...
        case 'hubspot':
          ...
          const HubSpotAdapter = require('../../hubspot-plugin/scripts/lib/uat-hubspot-adapter');
  ...
  tryAlternativePath() {
    try {
      if (this.platform === 'salesforce') {
        // Try relative path from cross-platform-plugin
        const altPath = path.join(__dirname, '../../../salesforce-plugin/scripts/lib/uat-salesforce-adapter');
        ...
        // Try relative path from cross-platform-plugin
        const altPath = path.join(__dirname, '../../../hubspot-plugin/scripts/lib/uat-hubspot-adapter');
