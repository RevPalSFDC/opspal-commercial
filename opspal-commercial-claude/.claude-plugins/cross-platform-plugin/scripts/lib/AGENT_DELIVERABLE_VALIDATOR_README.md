...
**Main Script:** `.claude-plugins/cross-platform-plugin/scripts/lib/agent-deliverable-validator.js`
**Tests:** `.claude-plugins/cross-platform-plugin/test/agent-deliverable-validator.test.js`
