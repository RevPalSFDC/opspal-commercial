 ...
 *
 * Basic Usage:
 *   node generate-aspire-proposal.js --transcript <file>              # New presentation
 *   node generate-aspire-proposal.js --transcript <file> --id <id>    # Update existing
 *
 * Template-Based Selection:
 *   node generate-aspire-proposal.js --transcript <file> --slides 10  # Target 10 slides
 *   node generate-aspire-proposal.js --transcript <file> --preview-selection
 *
 * Enhanced Usage (LLM-powered):
 *   node generate-aspire-proposal.js --transcript <file> --enhance    # With semantic analysis
 *   node generate-aspire-proposal.js --transcript <file> --enhance --persona executive
 *   node generate-aspire-proposal.js --transcript <file> --enhance --auto-apply
 *
 * Options:
...
const DEFAULT_TRANSCRIPT = '/home/chris/Downloads/transcript (1).csv';
...
Basic Usage:
  ...
  node generate-aspire-proposal.js --transcript <file> --id <presentationId>

Template-Based Selection:
  node generate-aspire-proposal.js --transcript <file> --slides 10
  node generate-aspire-proposal.js --transcript <file> --preview-selection
...
Examples:
  ...
  node generate-aspire-proposal.js --transcript call.csv

  # Preview which slides will be selected
  node generate-aspire-proposal.js --transcript call.csv --preview-selection

  # Generate with specific slide count
  node generate-aspire-proposal.js --transcript call.csv --slides 12

  # Enhanced with persona targeting
  node generate-aspire-proposal.js --transcript call.csv --enhance --persona executive

  # Auto-apply all safe enhancements
  node generate-aspire-proposal.js --transcript call.csv --enhance --auto-apply
`);
    process.exit(0);
  }
...
async function main() {
  ...
  if (options.existingId) {
    ...
    console.log(`   💡 Update with: node generate-aspire-proposal.js --id ${presentation.presentationId}`);
