 ...
 *
 * Uses wedgewood RevPal sandbox for Salesforce operations
 */
...
Audit custom fields on Account and Contact objects in wedgewood RevPal sandbox.
...
async function testProgressUpdate(taskId) {
  ...
  const update = formatter.formatProgress({
    ...
    completed: [
      'Connected to wedgewood sandbox',
