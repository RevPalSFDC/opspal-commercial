...
class ProjectInitializer {
  ...
  mergeClaudeMdTemplates(sfdcTemplate, hsTemplate) {
    ...
    merged += `@import .claude-plugins/salesforce-plugin/.claude-plugin/USAGE.md\n\n`;
    ...
    merged += `@import .claude-plugins/hubspot-plugin/USAGE.md\n\n`;
    ...
    merged += `---\n\n**Last Updated**: {DATE}\n`;
    merged += `**Generated by**: salesforce-plugin v3.5.0 + hubspot-plugin v1.1.0\n`;
