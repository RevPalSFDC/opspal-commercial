...
class ProcedureCQuickUndelete {
    ...
    async checkRecycleBinWindow() {
        ...
        const query = `SELECT Id, Name, IsDeleted, LastModifiedDate, MasterRecordId FROM Account WHERE IsDeleted = true AND MasterRecordId = '${this.survivorId}' ALL ROWS`;
...
Examples:
  ...
  node procedure-c-quick-undelete.js bluerabbit2021-revpal 001xx000ABC --dry-run
