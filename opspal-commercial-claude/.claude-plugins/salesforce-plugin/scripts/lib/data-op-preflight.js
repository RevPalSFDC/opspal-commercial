 ...
 * const validator = new PreflightValidator('rentable-production');
...
Examples:
  node data-op-preflight.js update Contact updates.csv rentable-production
  node data-op-preflight.js insert Account new-accounts.csv rentable-production
        `);
        process.exit(0);
    }
