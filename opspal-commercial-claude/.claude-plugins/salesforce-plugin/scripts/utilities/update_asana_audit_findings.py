...
"""
Update Asana tasks with field audit findings for Rentable projects
"""
...
def update_tasks():
    ...
    # Task IDs from the Rentable Foundations Project
    tasks_to_update = [
        {
...
**Expected Outcome:** 50% reduction in data entry errors and 30% improvement in reporting accuracy."""
    ...
    if success_count > 0:
        ...
        print("📍 Check the Rentable Foundations Project to see the updates")
