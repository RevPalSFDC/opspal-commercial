...
**File**: `../../cross-platform-plugin/scripts/lib/capability-assessment-protocol.js`
...
node ../../cross-platform-plugin/scripts/lib/capability-assessment-protocol.js <org> assess \
...
```javascript
const CapabilityAssessmentProtocol = require('../../cross-platform-plugin/scripts/lib/capability-assessment-protocol.js');
