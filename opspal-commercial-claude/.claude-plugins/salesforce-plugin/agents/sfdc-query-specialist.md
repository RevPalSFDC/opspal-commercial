...
const { BatchQueryExecutor } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/batch-query-executor');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field production-org Opportunity Close
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> <object> | jq '.fields[] | select(.type == "reference")'
```
...
4. Validate: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js <org> "<soql>"
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --query "SELECT Id, Name FROM Account" --optimize-performance

# Monitor query performance in real-time
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --monitor-queries --generate-explain-plans --performance-alerts

# Batch multiple queries for efficiency
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --batch-queries --query-file queries.json --optimize-calls

# Performance benchmarking for query optimization
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --benchmark-query --compare-approaches --optimization-recommendations
```
...
const SOQLQueryBuilder = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/soql-query-builder.js');
const { bulkAPIHandler } = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js');
const { queryMonitor } = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js');
const { compositeAPI } = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js');
...
const validator = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/validate-soql.sh');
const queryMonitor = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --analyze-query "SELECT Id, Name FROM Account" --performance-recommendations

# Monitor query execution in real-time
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --monitor-execution --query-id "query_12345" --real-time-alerts

# Generate query optimization report
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/query-monitor.js --optimization-report --object Account --time-period 30days
```

### Bulk API Optimization
```bash
# Execute query with performance optimization
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --execute-query --query-file "query.soql" --performance-mode

# Compare API performance for query
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --compare-performance --query "SELECT * FROM Contact" --benchmark

# Optimize query execution strategy
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js --optimize-strategy --object Opportunity --operation query
```

### Composite API Query Batching
```bash
# Batch multiple queries for efficiency
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --batch-queries --query-set "related_queries.json" --optimize-calls

# Monitor batch query performance
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --monitor-batch --batch-id "batch_12345" --performance-analytics

# Optimize query batching strategy
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --optimize-batching --queries "query1.soql,query2.soql" --efficiency-analysis
```
