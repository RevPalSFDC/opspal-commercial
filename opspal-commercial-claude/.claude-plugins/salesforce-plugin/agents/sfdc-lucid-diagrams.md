...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type diagram_generation --format json)`
...
const LucidDocumentFactory = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/lucid-document-factory');
const LucidTenantManager = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/lucid-tenant-manager');
const LucidSalesforceConnector = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/lucid-sf-connector');
