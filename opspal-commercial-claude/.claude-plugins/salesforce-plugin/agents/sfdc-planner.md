...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org <org-alias> --format summary
```
...
2. For Lead conversions: Run diagnostic
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/lead-conversion-diagnostics.js <org> <lead-id>
   ```
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/planner-optimizer.js <org-alias> [options]
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/planner-optimizer.js my-org ./output
```
...
3. **Validate Against Template**
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-architecture-validator.js --file [flow] --check-all
   ```
