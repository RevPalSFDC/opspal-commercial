...
```javascript
const { ParallelDeploymentPipeline } = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/parallel-deployment-pipeline');
...
5. Generate deployment report:
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/generate-deployment-report.js
```
...
2. Analyze results:
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/analyze-validation-results.js results.json

3. Generate report with recommendations:
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/generate-health-report.js results.json
```
...
for flow in ./flows/*.xml; do
  node -e "
    const calc = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-complexity-calculator');
