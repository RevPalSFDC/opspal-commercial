...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type revops_coordination --format json)`
...
HEAD=1 ORG=production node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-system-overview.js

# Automated scraping (headless using saved session)
ORG=production node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-system-overview.js
ORG=production node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-dashboard-performance.js
ORG=production node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-report-usage.js
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-system-overview.js
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-dashboard-performance.js
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-report-usage.js
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/scrape-sf-field-usage.js
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/archive-impact-visualizer.js \
...
const SalesBenchmarkEngine = require('cross-platform-plugin/scripts/lib/sales-benchmark-engine');
...
node cross-platform-plugin/scripts/lib/sales-benchmark-engine.js efficiency list

# Get benchmark for specific metric
node cross-platform-plugin/scripts/lib/sales-benchmark-engine.js efficiency benchmark magic_number

# Compare org metrics to benchmarks
node cross-platform-plugin/scripts/lib/sales-benchmark-engine.js efficiency compare \
    --magic-number 0.85 \
    --burn-multiple 1.2 \
    --rule-of-40 48 \
    --stage seriesB
...
const template = require('cross-platform-plugin/templates/reports/revops/investor-metrics.json');
```
...
# Archive execution
.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/bulk-archive-reports.sh
