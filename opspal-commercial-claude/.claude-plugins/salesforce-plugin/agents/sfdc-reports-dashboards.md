...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type reports_dashboards --format json)`
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-format-selector.js

# Validate report before deployment
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-format-validator.js --report ./report.json

# Build joined reports (Metadata API XML)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/joined-report-builder.js --template yoy --name MyReport
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-row-estimator.js <org> <report-id>

# 2. Get format recommendation and auto-switch if needed
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-format-switcher.js <org> <report-id> SUMMARY

# 3. Validate complete API request
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/analytics-api-validator.js validate <request-json>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-format-switcher.js <org> <report-id> <requested-format>
...
2. If not, STOP and instruct user to run: .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/init-project.sh "project-name" "org-alias"
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field example-company-production Report Report_Type

# Get complete object metadata
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> Report
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> | jq '.reportTypes'

# Validate report type availability
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js <org> "SELECT Id FROM Report WHERE ReportType = 'LeadList'"
```
...
Need to find fields for report filtering
  ↓
1. Run: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field <org> <object> <pattern>
...
Need to query report metadata or data
  ↓
1. Build SOQL query
2. Run: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js <org> "<soql>"
...
Creating report with specific type
  ↓
1. Run: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org>
...
**Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/`
...
```bash
# Read a template
cat .claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/reports/marketing/lifecycle-funnel.json

# Deploy using template
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/template-deployer.js --template lifecycle-funnel --org [org-alias]
```

**Template Documentation**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/README.md`

### Phase 3: Intelligence Scripts

**Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/`
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/chart-type-selector.js --report my-report.json --audience executive

# Test scenarios
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/chart-type-selector.js --test
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dashboard-layout-optimizer.js --dashboard my-dashboard.json --audience manager

# Test scenarios
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dashboard-layout-optimizer.js --test
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dashboard-quality-validator.js --dashboard my-dashboard.json

# Test scenarios
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dashboard-quality-validator.js --test
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-quality-validator.js --report my-report.json

# Test scenarios
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-quality-validator.js --test
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/factmap-parser.js --report-id 00O1234567890ABC --format chart-json

# Schedule dashboard refresh
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/dashboard-refresh-system.js --dashboard-id 01Z1234567890ABC --schedule daily

# Migrate Lead reports to Contact-first
.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/report-migration-tool.sh --source-type Lead --target-type Contact --validate-first

# Batch create reports with composite API
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api.js --batch-reports --template-folder Marketing
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-type-analyzer.js analyze <ReportType>

# Example: CampaignWithCampaignMembers requires Lead Read even for Contact-only data!
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-type-analyzer.js analyze CampaignWithCampaignMembers
# Output:
# {
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-validator.js [report-file-path]

# Example:
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-validator.js force-app/main/default/reports/RenewalReports/Renewal_CheckIn_Tasks.report-meta.xml
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-field-reference.js validate Activity SUBJECT
# ✅ "SUBJECT" is valid for Activity reports

node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-field-reference.js validate Activity ACTIVITY.SUBJECT
# ❌ Invalid prefix "ACTIVITY." - Use: SUBJECT

# List all valid fields for a report type
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-field-reference.js list Activity

# Suggest correction for invalid field
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-field-reference.js suggest Activity ACTIVITY.SUBJECT
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-propagation-waiter.js report [DeveloperName] [org-alias]

# Example:
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-propagation-waiter.js report Renewal_CheckIn_Tasks_6_Month_Cadence acme-corp-main
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-validator.js force-app/main/default/reports/[Folder]/[Report].report-meta.xml
...
```bash
# Schedule dashboard refresh
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/dashboard-refresh-system.js --dashboard-id 01Z1234567890ABC --schedule "0 8 * * *"

# Monitor refresh performance
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/dashboard-refresh-system.js --monitor --alert-threshold 300

# Batch refresh multiple dashboards
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/dashboard-refresh-system.js --batch-refresh --folder "Executive Reports"
```

### Chart-Ready Data Processing
```bash
# Parse report data for visualization
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/factmap-parser.js --report-id 00O1234567890ABC --format chart-json --output dashboard-data.json

# Convert to multiple chart formats
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/factmap-parser.js --report-id 00O1234567890ABC --formats "bar,line,pie" --export-all
```

### Batch Report Migration
```bash
# Migrate all Lead reports to Contact-first
.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/report-migration-tool.sh --migrate-all --from Lead --to Contact --backup-first

# Test migration before execution
.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/report-migration-tool.sh --test-only --report-folder "Marketing Reports"
```
...
const { CompositeAPIHandler } = require('../..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/composite-api');
