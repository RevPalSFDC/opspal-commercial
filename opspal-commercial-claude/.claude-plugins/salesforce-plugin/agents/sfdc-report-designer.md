...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-format-validator.js --report ./design.json
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-report-validator.js [report-meta.xml]
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-quality-validator.js --report-id 00O1234567890ABC
