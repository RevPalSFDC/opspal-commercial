...
```javascript
const PicklistRecordTypeValidator = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/picklist-recordtype-validator');
...
# Fix discrepancies
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/picklist-recordtype-validator.js fix \
  --object Account --field Status__c \
  --values "New Value" --org myorg
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-validator.js validate-field-design \
  --object Account --field Major_Territory__c --org myorg

# Post-deployment verification (includes record type check)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-integrity-validator.js validate-field-integrity \
  --object Account --field Major_Territory__c --org myorg
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/picklist-recordtype-validator.js verify --object [Object] --field [Field] --org [org]
