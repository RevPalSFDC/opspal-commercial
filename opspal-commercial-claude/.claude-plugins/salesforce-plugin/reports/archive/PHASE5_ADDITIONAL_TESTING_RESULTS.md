...
**Command:**
```bash
node bulk-merge-executor.js --org rentable-sandbox --decisions test/rentable-test-decisions.json --batch-size 1 --max-pairs 1 --auto-approve
```
...
**Org**: rentable-sandbox (10,922 total accounts)
