# Test Reports Created in Peregrine Sandbox

**Date**: 2025-01-17
**Org**: PEREGRINE_SANDBOX (cacevedo@gorevpal.peregrine.staging)
...
- **URL**: https://peregrinemain--staging.sandbox.my.salesforce.com/lightning/r/Report/00Odx000001XfOnEAK/view
- **Format**: SUMMARY
- **Features Tested**:
...
- **URL**: https://peregrinemain--staging.sandbox.my.salesforce.com/lightning/r/Report/00Odx000001XfQPEA0/view
- **Format**: SUMMARY
- **Features Tested**:
...
- **URL**: https://peregrinemain--staging.sandbox.my.salesforce.com/lightning/r/Report/00Odx000001XfTdEAK/view
- **Format**: SUMMARY
- **Features Tested**:
...
- **URL**: https://peregrinemain--staging.sandbox.my.salesforce.com/lightning/r/Report/00Odx000001XfVFEA0/view
- **Format**: SUMMARY
- **Features Tested**:
...
- **URL**: https://peregrinemain--staging.sandbox.my.salesforce.com/lightning/r/Dashboard/01Zdx000002XKQYEA4/view
- **Folder**: Peregrine Dashboards
...
```
.claude-plugins/salesforce-plugin/templates/reports/test-suite/
