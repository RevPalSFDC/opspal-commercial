...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-metadata-operations.js deployFlowSafe MyFlow myorg \
...
1. **Introspect**:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-write-operations.js introspect <object> <org>
   ```

2. **Use Safe Creation**:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-write-operations.js createRecordSafe <object> <org> \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-metadata-operations.js deployFlowSafe <flow-name> <path> <org> \
  --smoke-test '{...}'
```
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-dependency-enforcer.js validate <manifest> <org> \
  --context context.json
```
