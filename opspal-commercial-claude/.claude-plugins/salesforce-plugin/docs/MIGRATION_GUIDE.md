...
```bash
# In another terminal
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/check-progress.js --watch process_dataset.js
```
...
```bash
# Run the script
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/query_accounts.js production

# In another terminal, monitor progress
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/check-progress.js --watch query_accounts.js
```
...
grep -r "OFFSET" .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/*.js

# Find scripts with SOQL queries
grep -r "sf data query" .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/*.js
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/your_script.js sandbox

# Monitor in another terminal
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/check-progress.js --watch your_script.js

# Verify lock prevents concurrent execution
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/your_script.js sandbox  # Should fail with "already running"

# Check lock status
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/process-lock-manager.js list
```
...
2. **Force release (if process died):**
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/process-lock-manager.js release query_accounts.js
   ```

3. **Clean up all stale locks:**
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/process-lock-manager.js cleanup
   ```
...
3. **Check for errors:**
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/my_script.js --verbose
   ```
...
### Documentation
- Pagination Library: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/PAGINATION_AND_VALIDATION.md`
- Process Management: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/PROCESS_MANAGEMENT.md`

### Tools
- Monitor Progress: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/check-progress.js --help`
- Manage Locks: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/process-lock-manager.js --help`
- List Progress: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/progress-file-writer.js list`
