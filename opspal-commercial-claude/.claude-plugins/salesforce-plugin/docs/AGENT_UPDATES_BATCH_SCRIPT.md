...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/post-deployment-state-verifier.js <org> Dashboard <dashboard-name>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/post-deployment-state-verifier.js <org> FlexiPage <page-name>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/post-deployment-state-verifier.js <org> PermissionSet <perm-set-name>
```
...
```bash
git add .claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-*.md
