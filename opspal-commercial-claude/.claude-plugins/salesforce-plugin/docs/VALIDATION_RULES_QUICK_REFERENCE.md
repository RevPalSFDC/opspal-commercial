...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-batch-manager.js create --config batch-config.json

# Validate all validation rules
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-batch-manager.js validate --rules ./force-app/main/default/objects/*/validationRules/

# Deploy validation rules
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-batch-manager.js deploy --org dev-org --rules ./force-app/main/default/objects/*/validationRules/

# Test validation rules
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-batch-manager.js test --org dev-org --rules ./force-app/main/default/objects/*/validationRules/
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-complexity-calculator.js calculate --file Account_Amount_Validation.validationRule-meta.xml

# Calculate complexity for all rules on an object
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-complexity-calculator.js calculate-object Account --org dev-org

# Get recommendations based on complexity
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-complexity-calculator.js recommend --file MyRule.validationRule-meta.xml
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-creator.js from-template \
...
# Create from scratch
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-creator.js create \
