...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --sarif > results.sarif

# Output for GitHub Code Scanning
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --output sarif
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml

# Use custom config file
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --config org-specific-rules.yml

# Show config summary
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator-config.js .flow-validator.yml --summary
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-auto-fixer.js MyFlow.flow-meta.xml --dry-run --verbose

# Apply fixes
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --auto-fix

# Verbose with auto-fix
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --auto-fix --verbose
```
      ...
      - name: Validate Flows
        run: |
          for flow in force-app/main/default/flows/*.flow-meta.xml; do
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js "$flow" --output sarif >> results.sarif
          done
        ...
        stage('Validate Flows') {
            steps {
                script {
                    ...
                    flows.each { flow ->
                        sh "node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js ${flow.path} --config .flow-validator.yml"
                    }
                }
            }
        }
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js sandbox-flow.xml --config .flow-validator.yml
```
...
```bash
# Dry run first
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js prod-flow.xml --config .flow-validator.yml --verbose

# Apply fixes if needed
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js prod-flow.xml --auto-fix
```
...
# Verbose mode
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --verbose

# JSON output
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --output json
```

### SARIF Output
```bash
# SARIF format
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --sarif

# Save to file
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --output sarif > results.sarif
```

### Configuration
```bash
# Use custom config
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --config custom-rules.yml

# Validate config file
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator-config.js .flow-validator.yml --validate

# Show config summary
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator-config.js .flow-validator.yml --summary

# Check specific rule
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator-config.js .flow-validator.yml --check-rule UnusedVariable
```
...
# Use explicit path
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.flow-meta.xml --config /full/path/to/.flow-validator.yml
```
