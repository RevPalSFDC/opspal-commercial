...
**Check observations**:
```bash
ls instances/rentable-sandbox/observations/
...
📝 Runbook: instances/rentable-sandbox/RUNBOOK.md
...
**Example output**:
```
📊 Comparing runbooks for: rentable-sandbox
   From: v1.0.0
   To:   current
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-reflection-bridge.js \
  --org rentable-sandbox \
  --limit 50 \
  --output instances/rentable-sandbox/reflection-sections.json
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-synthesizer.js \
  --org rentable-sandbox \
  --reflection-sections instances/rentable-sandbox/reflection-sections.json \
  --output instances/rentable-sandbox/synthesis.json
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-renderer.js \
  --org rentable-sandbox \
  --reflection-sections instances/rentable-sandbox/synthesis.json \
  --output instances/rentable-sandbox/RUNBOOK.md
```
...
```bash
bash .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/generate-enhanced-runbook.sh rentable-sandbox
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-versioner.js \
  --org rentable-sandbox
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-versioner.js --org rentable-sandbox

# Force specific bump
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-versioner.js --org rentable-sandbox --bump minor

# Manual version
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-versioner.js --org rentable-sandbox --version 2.0.0
```
...
```bash
# Current vs previous
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-differ.js --org rentable-sandbox

# Specific versions
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-differ.js \
  --org rentable-sandbox \
  --from v1.0.0 \
  --to v1.2.0

# Summary only
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-differ.js --org rentable-sandbox --format summary
```
...
```bash
# Full context (JSON)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org rentable-sandbox

# Condensed summary
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org rentable-sandbox --format summary
...
const context = extractRunbookContext('rentable-sandbox', {
...
2. Run synthesizer with debug:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-synthesizer.js --org {org} --output /tmp/test.json
   ```
...
# List all versions
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-versioner.js --org {org} --action list

# Compare any two versions
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-differ.js --org {org} --from v1.0.0 --to v1.5.0
```
