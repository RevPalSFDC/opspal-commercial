...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/production-readiness-check.js
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/production-readiness-check.js --mode preprod
```
...
- [ ] Run preprod readiness check: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/production-readiness-check.js --mode preprod`
- [ ] Confirm staging org alias is authenticated (e.g., `SF_ORG_ALIAS=peregrine-staging`)
...
cp -r .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config backups/pre-governance-deployment/config-$(date +%Y%m%d) || true
...
cp .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/agent-permission-matrix.json \
   .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/agent-permission-matrix.production.json

# Verify format
node -e "console.log(JSON.stringify(require('./.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/agent-permission-matrix.production.json'), null, 2))"

# Review registered agents
echo "Registered agents:"
node -e "const matrix = require('./.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/agent-permission-matrix.json'); Object.keys(matrix.agents).forEach(agent => console.log('  -', agent))"
```
...
```bash
# Test risk scorer
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-risk-scorer.js test

# Verify risk calculation
node -e "
const RiskScorer = require('./.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-risk-scorer');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/human-in-the-loop-controller.js test-interactive
...
```bash
# Test audit logger
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js test

# Verify log rotation
node -e "
const logger = require('./.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger');
...
chmod +x .claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/universal-agent-governance.sh

# Test hook (dry run)
AGENT_GOVERNANCE_DRY_RUN=true \
  .claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/universal-agent-governance.sh \
  '{"agent":"sfdc-metadata-manager","operation":"DEPLOY_FIELD","environment":"production"}'

# Link hook to Claude Code hooks directory
ln -sf $(pwd)/.claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/universal-agent-governance.sh \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/test/governance/verify-phase-1.js
...
cp .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor.js \
   /usr/local/lib/salesforce-plugin/

# Deploy configuration
cp .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/api-usage-config.json \
   .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/api-usage-config.production.json

# Deploy monitoring hook
chmod +x .claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/post-sf-command.sh
ln -sf $(pwd)/.claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/post-sf-command.sh \
       .claude/hooks/post-sf-command.sh

# Initialize usage tracking database
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor.js init production
...
cp .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/change-ticket-manager.js \
   /usr/local/lib/salesforce-plugin/

# Deploy configuration
cp .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/change-management-config.json \
   .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/change-management-config.production.json
...
node -e "
const DataClassification = require('./.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/data-classification-framework');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/test/governance/verify-phase-2.js
...
ls -la .claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-architecture-auditor.md

# Test architecture health scoring
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/architecture-health-scorer.js production
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/schema-health-scorer.js production Account
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/test/governance/verify-phase-3.js
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/test/governance/e2e-governance-test.js
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/test/governance/benchmark-overhead.js
...
# 1. State discovery
node -e "
const governance = require('./.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-governance');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor.js monitor production &

# Start approval queue monitor
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/approval-queue-monitor.js production &
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/governance-dashboard-generator.js production
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js purge --dry-run

# Purge logs older than 90 days
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js purge --days 90
```
...
cp -r backups/pre-governance-deployment/config-$(date +%Y%m%d)/* \
      .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/
...
node -e "
const config = require('./.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/change-management-config.json');
config.jira.enabled = false;
require('fs').writeFileSync(
  '.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/change-management-config.json',
...
# Check config
cat .claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/change-management-config.json | jq '.jira'
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor.js track production data query
```
...
Location: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/agent-permission-matrix.json`
...
Location: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/api-usage-config.json`
...
Location: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/change-management-config.json`
