...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/object-existence-validator.js [org-alias] [object-name] --discover

# Check for Apex invocations
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-activation-validator.js [org-alias] [flow-directory]
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-formula-validator.js [flow-file] --auto-fix
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/object-existence-validator.js [org] Quote --discover
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/object-field-resolver.js [org] Quote OwnerId
...
1. **Run formula validator**:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-formula-validator.js [flow-file] [org]
   ```

2. **Check object existence**:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/object-existence-validator.js [org] [referenced-objects]
   ```
...
4. **Check for Apex invocations**:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-activation-validator.js [org] [flow-directory]
   ```
