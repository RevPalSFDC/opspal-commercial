...
**Process**:
- Archive old reports: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/test-report-manager.js archive ./reports`
- Validate mode: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/qa-workflow-validator.js validate-mode execute [org] ./reports`
