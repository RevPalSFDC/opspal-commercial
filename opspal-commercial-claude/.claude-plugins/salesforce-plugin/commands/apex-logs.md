...
```bash
# List recent logs
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/debug-log-manager.js logs myorg --limit 5

# Get log body
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/debug-log-manager.js body myorg 07Lxx000000XXXX

# Check storage usage
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/debug-log-manager.js storage myorg
```
