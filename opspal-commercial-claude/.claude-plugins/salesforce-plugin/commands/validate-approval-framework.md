...
2. Run approval framework validation: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/approval-framework-validator.js <org-alias>`
