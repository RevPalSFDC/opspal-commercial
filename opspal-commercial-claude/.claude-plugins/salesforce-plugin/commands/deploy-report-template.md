...
ls -1 .claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/reports/*/*.json
```
...
📊 Report Details:
   ...
   URL: https://peregrine.my.salesforce.com/lightning/r/Report/{id}/view
