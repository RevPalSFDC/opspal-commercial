...
- Cross-platform data sync (use cross-platform-plugin)
...
### Works With
- **hubspot-core-plugin**: Data sync between Salesforce and HubSpot via cross-platform-plugin
- **cross-platform-plugin**: Unified operations spanning Salesforce and other platforms
...
- **v3.0.0**: Migrated to plugin architecture. All agents now in `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/`. Update `@import` references in CLAUDE.md.
