...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-xml-validator.js <flow.xml> --fix
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-dependency-analyzer.js <org> <object> <field>
```
