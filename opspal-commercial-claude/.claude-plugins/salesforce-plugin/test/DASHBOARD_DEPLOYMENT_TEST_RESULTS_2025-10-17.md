...
|-----|------|----------------------------|
| Peregrine Sandbox | Sandbox | Yes - 1 LoggedInUser dashboard |
| Wedgewood Revpal Sandbox | Sandbox | Yes - 1 LoggedInUser dashboard (after first) |
| Rentable Sandbox | Sandbox | Yes - 1 LoggedInUser dashboard |
...
### Test 1: Peregrine Sandbox

**Command**:
```bash
ORG=PEREGRINE_SANDBOX node scripts/lib/report-template-deployer.js \
  --org PEREGRINE_SANDBOX \
...
- ✅ **Report Created**: ID `00Odx000001XjnOEAS`
  - URL: https://peregrinemain--staging.sandbox.my.salesforce.com/lightning/r/Report/00Odx000001XjnOEAS/view
...
### Test 2: Wedgewood Revpal Sandbox

**Command**:
```bash
ORG=bluerabbit2021-revpal node scripts/lib/report-template-deployer.js \
...
- ✅ **Report Created**: ID `00OVG000001bwZ72AI`
  - URL: https://bluerabbit2021--revpal.sandbox.my.salesforce.com/lightning/r/Report/00OVG000001bwZ72AI/view
  - Field Resolution: 83% (5/6 fields)
  - Quality Score: A- (88/100)
...
### Test 3: Rentable Sandbox

**Command**:
```bash
ORG=rentable-sandbox node scripts/lib/report-template-deployer.js \
...
- ✅ **Report Created**: ID `00OTI000002FQyj2AG`
  - URL: https://rentable--revpalsb.sandbox.my.salesforce.com/lightning/r/Report/00OTI000002FQyj2AG/view
  - Field Resolution: 83% (5/6 fields)
  - Quality Score: A- (88/100)
- ✅ **Folder Created**: `OpsPal_Dashboards`
- ❌ **Dashboard Failed**: LoggedInUser dashboard limit reached
...
**Logs preserved**:
- `/tmp/peregrine-pipeline-test.log`
- `/tmp/wedgewood-revpal-pipeline-test.log`
- `/tmp/rentable-pipeline-test.log`

**Generated dashboards** (where successful):
- Wedgewood Revpal: Pipeline Overview Dashboard (5 components, 3-column layout)
...
### Test 4: Wedgewood Revpal - Full Suite Deployment

**Pre-Test Cleanup**:
```bash
# Deleted 2 existing LoggedInUser dashboards
sf data delete record --sobject Dashboard --record-id 01ZUw000001J1pRMAS --target-org bluerabbit2021-revpal
sf data delete record --sobject Dashboard --record-id 01ZUw000000uTgrMAE --target-org bluerabbit2021-revpal
```
...
- ✅ **Report Created**: ID `00OVG000001bx0X2AQ`
  - URL: https://bluerabbit2021--revpal.sandbox.my.salesforce.com/lightning/r/Report/00OVG000001bx0X2AQ/view
  - Field Resolution: 83% (5/6 fields)
  - Quality Score: A- (88/100)
- ✅ **Dashboard Created**: `Pipeline_Overview_Dashboard`
  - All 5 components deployed successfully
...
- ✅ **Report Created**: ID `00OVG000001bx292AA`
  - URL: https://bluerabbit2021--revpal.sandbox.my.salesforce.com/lightning/r/Report/00OVG000001bx292AA/view
...
**Org Quota Confirmed**:
```bash
sf data query --query "SELECT Id, Title, Type FROM Dashboard WHERE Type = 'LoggedInUser'" --target-org bluerabbit2021-revpal
```

**Result**: 1 dashboard found - Pipeline Overview Dashboard (01ZVG0000017ZGb2AM)

**Quota Limit**: Wedgewood Revpal sandbox allows **exactly 1 LoggedInUser dashboard** (extremely restrictive)
