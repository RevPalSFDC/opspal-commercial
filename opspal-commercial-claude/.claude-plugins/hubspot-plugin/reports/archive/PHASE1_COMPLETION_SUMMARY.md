...
**Location**: `.claude-plugins/hubspot-plugin/agents/hubspot-seo-site-crawler.md`
...
**Location**: `.claude-plugins/hubspot-plugin/scripts/lib/seo-sitemap-crawler.js`
...
**Location**: `.claude-plugins/hubspot-plugin/scripts/lib/seo-batch-analyzer.js`
...
**Location**: `.claude-plugins/hubspot-plugin/scripts/lib/seo-broken-link-detector.js`
...
**Location**: `.claude-plugins/hubspot-plugin/scripts/lib/seo-technical-health-scorer.js`
...
**Location**: `.claude-plugins/hubspot-plugin/commands/seo-broken-links.md`
