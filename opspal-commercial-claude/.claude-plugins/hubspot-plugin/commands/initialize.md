...
```bash
node .claude-plugins/salesforce-plugin/scripts/lib/initialize-project.js
```

### Initialize Specific Directory

```bash
node .claude-plugins/salesforce-plugin/scripts/lib/initialize-project.js --project-dir=/path/to/project
```

### Force Overwrite Existing Files

```bash
node .claude-plugins/salesforce-plugin/scripts/lib/initialize-project.js --force
```
...
- Authentication files (`.sfdx/`, `.sf/`, `.hubspot/`)
