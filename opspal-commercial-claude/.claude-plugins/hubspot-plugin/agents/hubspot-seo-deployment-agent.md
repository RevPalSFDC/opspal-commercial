...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-content-optimizer.js https://gorevpal.com \
  --generate-all \
  --format json \
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-geo-validator.js https://gorevpal.com --check-robots
...
- **Content Optimizer:** `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/agents/hubspot-content-automation-agent.md`
