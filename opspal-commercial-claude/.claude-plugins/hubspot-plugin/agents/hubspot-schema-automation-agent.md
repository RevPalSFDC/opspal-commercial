...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-schema-generator.js https://example.com
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-schema-generator.js crawl-results.json \
  --format json \
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-schema-generator.js [URL]
```
...
**Action:**
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-schema-generator.js https://gorevpal.com \
  --types Organization,WebSite \
  --format json \
...
**Action:**
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-schema-generator.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-content-optimizer.js https://example.com \
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-geo-validator.js https://example.com
...
```bash
# Wrong
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-schema-generator.js https://www.example.com
...
- **Phase 3.1 GEO Validator:** `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-geo-validator.js`
- **Content Optimizer:** `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-content-optimizer.js`
- **HubSpot Deployer:** `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/seo-hubspot-deployer.js`
