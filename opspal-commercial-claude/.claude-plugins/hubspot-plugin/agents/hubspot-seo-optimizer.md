...
const DiagramGenerator = require('../../../cross-platform-plugin/scripts/lib/mermaid-generator');
...
```javascript
const AsanaTaskManager = require('../../../cross-platform-plugin/scripts/lib/asana-task-reader');
...
- **Asana Integration**: @import ../../../cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md
