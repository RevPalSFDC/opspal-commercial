...
## Plugin Role Clarifications (Phase 0)
- The official "8" are domain-facing installable plugins.
- developer-tools-plugin is Core (DevX and validation).
- data-hygiene-plugin is Core with thin, domain-specific adapters in domains.
- ai-consult-plugin remains Domain and must consume Core interfaces.
...
**Objectives**
- Extract Core modules from cross-platform, data-hygiene (core portions), and developer-tools.
- Keep ai-consult as a Domain plugin that consumes Core orchestration and governance.
...
1. **Module extraction**
   ...
   - Reflection & Learning
   - Quality & Validation (includes Core data hygiene)
