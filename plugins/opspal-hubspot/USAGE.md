...
```bash
# Full site audit
node scripts/seo/seo-site-auditor.js https://example.com
...
node scripts/lib/geo-location-enricher.js --object contacts --batch 100
```
...
node scripts/lib/seo-content-optimizer.js https://example.com/page
```
