...
./scripts/switch-portal.sh add

# Or manual mode
node scripts/lib/add-portal-config.js \
  --name "production" \
  --portal-id "12345678" \
...
node scripts/lib/create-project.js \
  --portal "production" \
...
node scripts/lib/portal-quirks-detector.js generate-docs production

# Initialize metadata cache (5-10 min)
node scripts/lib/hubspot-metadata-cache.js init production

# View portal info
./scripts/switch-portal.sh info production
```
...
- `node scripts/lib/portal-quirks-detector.js generate-docs production`
- `node scripts/lib/hubspot-metadata-cache.js init production`
- `node scripts/lib/portal-context-manager.js load production`

**Project Creation:**
- `node scripts/lib/create-project.js --help`
...
- Re-run `./scripts/switch-portal.sh add`
...
| Command | Purpose |
|---------|---------|
| `./scripts/switch-portal.sh add` | Add new portal |
| `node scripts/lib/create-project.js --help` | Create project |
| `/hs <name>` | Switch to portal |
| `node scripts/lib/portal-quirks-detector.js generate-docs <portal>` | Run discovery |
