...
argument-hint: "--type landing-pages"
...
const seoResults = await Task.invoke('opspal-hubspot:hubspot-seo-optimizer', {
...
const pdfHelper = require('../../../opspal-core/scripts/lib/pdf-generation-helper');
...
- PDF generation via `opspal-core/scripts/lib/pdf-generation-helper.js`
