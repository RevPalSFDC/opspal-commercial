...
const SEOKeywordResearcher = require('../scripts/lib/seo-keyword-researcher');
const SEOContentOptimizer = require('../scripts/lib/seo-content-optimizer');
const SEOSERPAnalyzer = require('../scripts/lib/seo-serp-analyzer');
const SEOTechnicalAuditor = require('../scripts/lib/seo-technical-auditor');
const SEOTopicClusterGenerator = require('../scripts/lib/seo-topic-cluster-generator');
...
| **Create Asana tasks** | `asana-task-manager` (opspal-core) | Task management for SEO campaigns |
...
if (seoAnalysis.score >= 70) {
  await Task.invoke('opspal-hubspot:hubspot-cms-content-manager', JSON.stringify({
...
await Task.invoke('opspal-hubspot:hubspot-analytics-reporter', JSON.stringify({
...
const DiagramGenerator = require('../../../opspal-core/scripts/lib/mermaid-generator');
...
- **Asana Integration**: @import ../../../opspal-core/docs/ASANA_AGENT_PLAYBOOK.md
