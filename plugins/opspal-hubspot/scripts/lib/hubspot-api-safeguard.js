...
const API_LIMITS = {
  ...
  // Rate limits by tier
  rateLimit: {
    starter: { requests: 100, window: 10000 },   // 100 requests per 10 sec
    professional: { requests: 150, window: 10000 },
    enterprise: { requests: 200, window: 10000 },
    free: { requests: 100, window: 10000 }
  },
