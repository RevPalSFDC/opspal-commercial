...
Task(subagent_type='opspal-salesforce:sfdc-report-designer', prompt=`
...
Task(subagent_type='opspal-hubspot:hubspot-reporting-builder', prompt=`
...
|--------|---------|----------|
| `revops-kpi-knowledge-base.js` | KPI definitions, formulas, benchmarks | `opspal-core/scripts/lib/` |
| `methodology-generator.js` | Transparency appendix generation | `opspal-core/scripts/lib/` |
| `excel-template-processor.js` | Excel workbook generation | `opspal-core/scripts/lib/` |
| `sales-benchmark-engine.js` | Industry benchmark comparisons | `opspal-core/scripts/lib/` |
| `bluf-summary-generator.js` | Executive summary generation | `opspal-core/scripts/lib/` |
| `pdf-generation-helper.js` | PDF report generation | `opspal-core/scripts/lib/` |
| `google-drive-manager.js` | Google Sheets integration | `opspal-core/scripts/lib/` |
| `streaming-csv-exporter.js` | Large dataset CSV export | `salesforce-plugin/scripts/lib/` |
| `sales-funnel-metrics-collector.js` | Cross-platform funnel data | `opspal-core/scripts/lib/` |
| `trend-analysis-engine.js` | Trend detection, moving averages, anomalies (v1.4.0) | `opspal-core/scripts/lib/` |
| `kpi-forecaster.js` | KPI forecasting with multiple methods (v1.4.0) | `opspal-core/scripts/lib/` |
| `kpi-alert-monitor.js` | Threshold monitoring and alerting (v1.4.0) | `opspal-core/scripts/lib/` |
| `cohort-analysis-engine.js` | Cohort creation and retention analysis (v1.4.0) | `opspal-core/scripts/lib/` |
| `report-explorer.js` | Interactive drill-down and exploration (v1.4.0) | `opspal-core/scripts/lib/` |
| `report-version-manager.js` | Version tracking and comparison (v1.4.0) | `opspal-core/scripts/lib/` |
...
| Script | Purpose | Location |
|--------|---------|----------|
| `trend-analysis-engine.js` | Trend detection, moving averages, seasonality, anomalies | `opspal-core/scripts/lib/` |
| `kpi-forecaster.js` | Forecasting with multiple methods | `opspal-core/scripts/lib/` |
| `kpi-alert-monitor.js` | Threshold monitoring and alerting | `opspal-core/scripts/lib/` |
| `cohort-analysis-engine.js` | Cohort creation and analysis | `opspal-core/scripts/lib/` |
| `report-explorer.js` | Interactive drill-down and exploration | `opspal-core/scripts/lib/` |
| `report-version-manager.js` | Version tracking and comparison | `opspal-core/scripts/lib/` |
