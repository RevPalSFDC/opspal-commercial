...
argument-hint: "--type <type> --org <org> --file <path> [--title <title>] [--bluf] [--profile <simple|cover-toc>]"
...
Generate professional PDF reports using the centralized ReportService. By default reports include RevPal branding, cover pages, and table of contents. Use `--profile` to switch to the simple branded preset.
...
# With custom title
/generate-report --type cpq-assessment --org eta-corp --file ./analysis.md --title "CPQ Configuration Assessment"

# Include BLUF+4 executive summary
/generate-report --type automation-audit --org acme --file ./audit.md --bluf

# Simple branded output (no cover/TOC)
/generate-report --type revops-audit --org acme --file ./report.md --profile simple
...
| `--profile` | Preset profile (`simple`, `cover-toc`) | No |
