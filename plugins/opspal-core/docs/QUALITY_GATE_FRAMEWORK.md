...
node .claude-plugins/opspal-core/scripts/lib/quality-gate-validator.js \
  report_generation \
...
bash .claude-plugins/opspal-core/hooks/post-task-verification.sh <<EOF
{
  "taskType": "deployment",
  "deliverable": {
    "status": "success",
...
bash $CLAUDE_PLUGIN_ROOT/opspal-core/hooks/post-task-verification.sh <<EOF
{
  "taskType": "deployment",
...
Edit `.claude-plugins/opspal-core/config/quality-gate-rules.json`:
...
```
.claude-plugins/opspal-core/scripts/lib/quality-gate-validator.js
```
...
```
.claude-plugins/opspal-core/config/quality-gate-rules.json
```
