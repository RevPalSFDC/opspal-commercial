...
🔔 Plugin Updates Available:
   • opspal-salesforce: 3.42.0 → 3.45.0
   • opspal-hubspot: 3.0.2 → 3.1.0
...
node .claude-plugins/opspal-core/scripts/lib/plugin-version-checker.js --format=json

# Text output (human-readable)
node .claude-plugins/opspal-core/scripts/lib/plugin-version-checker.js --format=text

# Force refresh cache
node .claude-plugins/opspal-core/scripts/lib/plugin-version-checker.js --force-refresh
```
...
```bash
# Basic tests
bash .claude-plugins/opspal-core/scripts/lib/test-version-checker.sh

# Verbose output
bash .claude-plugins/opspal-core/scripts/lib/test-version-checker.sh --verbose
```
...
2. Check GitHub API manually:
   ...
   curl -H "Accept: application/vnd.github.v3+json" \
     "https://api.github.com/repos/RevPalSFDC/opspal-plugin-internal-marketplace/contents/.claude-plugins/opspal-salesforce/.claude-plugin/plugin.json" \
