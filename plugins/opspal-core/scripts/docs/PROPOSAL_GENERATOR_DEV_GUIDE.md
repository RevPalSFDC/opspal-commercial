...
The zeta-corp Proposal Generator creates personalized Google Slides proposals from discovery call transcripts. It uses **template-based slide selection** combined with **LLM-powered content generation**.
...
| File | Purpose |
|------|---------|
| `generate-zeta-corp-proposal.js` | Main entry point, orchestrates the pipeline |
...
# Specify slide count
node generate-zeta-corp-proposal.js --transcript <file> --slides 12

# Update existing presentation
node generate-zeta-corp-proposal.js --transcript <file> --id <presentation-id>
