...
const hasLoadReport = typeof ReportExplorer.prototype.loadReport === 'function';
...
describe('ReportExplorer', () => {
    ...
    describe('loadReport()', () => {
        const loadReportTest = hasLoadReport ? test : test.skip;

        loadReportTest('should load report data by ID', async () => {
