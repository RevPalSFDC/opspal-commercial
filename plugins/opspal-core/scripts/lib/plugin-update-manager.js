...
class PluginUpdateManager {
  ...
  async checkHookRegistration() {
    ...
    const workspacePluginsDir = path.join(projectRoot, 'plugins');
    const workspaceClaudePluginsDir = path.join(projectRoot, '.claude-plugins');
    const mergerOptions = {
      projectSettingsPath: path.join(projectRoot, '.claude', 'settings.json'),
      pluginsDir: fs.existsSync(workspacePluginsDir)
        ? workspacePluginsDir
        : (fs.existsSync(workspaceClaudePluginsDir)
          ? workspaceClaudePluginsDir
