...
File Path: ./reports/eta-corp/report.json
...
const result = await validator.validate({
  taskDescription: 'Generate CPQ assessment for eta-corp',
...
**Main Script:** `.claude-plugins/opspal-core/scripts/lib/agent-deliverable-validator.js`
**Tests:** `.claude-plugins/opspal-core/test/agent-deliverable-validator.test.js`
