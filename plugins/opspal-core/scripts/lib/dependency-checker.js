...
class DependencyChecker {
  ...
  checkAll() {
    ...
    this.checkEnvVar('ASANA_ACCESS_TOKEN', 'Asana Personal Access Token', {
      required: false,
      setupUrl: '.claude-plugins/opspal-core/docs/ASANA_PER_USER_AUTHENTICATION.md'
    });

    this.checkEnvVar('GOOGLE_APPLICATION_CREDENTIALS', 'Google Drive OAuth Credentials Path', {
      required: false,
      setupUrl: '.claude-plugins/opspal-core/docs/GOOGLE_DRIVE_PER_USER_AUTHENTICATION.md'
    });
