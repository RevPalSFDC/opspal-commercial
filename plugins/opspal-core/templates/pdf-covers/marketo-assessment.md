...
<div class="cover-report-type">Marketo Assessment</div>
...
<% } else { %>
<p class="cover-subtitle">Comprehensive analysis of programs, campaigns, and marketing automation</p>
<% } %>
...
<p><strong>Instance:</strong> <%= instance || instanceId %></p>
<% } %>
...
<p><strong>Modules Analyzed:</strong> <%= modules.join(', ') %></p>
<% } %>
