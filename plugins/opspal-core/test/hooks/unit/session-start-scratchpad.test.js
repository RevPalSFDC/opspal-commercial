...
/**
 * Unit Tests for session-start-scratchpad.sh
 *
...
const HOOK_PATH = path.join(PROJECT_ROOT, 'plugins/opspal-core/hooks/session-start-scratchpad.sh');
...
async function runAllTests() {
  console.log('\n[Tests] session-start-scratchpad.sh Tests\n');
