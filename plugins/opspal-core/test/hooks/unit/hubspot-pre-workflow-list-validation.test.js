...
/**
 * Unit Tests for HubSpot pre-workflow-list-validation.sh
 *
...
const HOOK_PATH = path.join(
  PROJECT_ROOT,
  'plugins/opspal-hubspot/hooks/pre-workflow-list-validation.sh'
);
...
async function runAllTests() {
  console.log('\n[Tests] HubSpot pre-workflow-list-validation.sh Tests\n');
