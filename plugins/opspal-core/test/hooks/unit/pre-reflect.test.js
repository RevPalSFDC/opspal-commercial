...
const HOOK_PATH = path.join(PROJECT_ROOT, 'plugins/opspal-core/hooks/reflection/pre-reflect.sh');
...
async function runAllTests() {
  ...
  results.push(await runTest('Skips when running in test mode', async () => {
