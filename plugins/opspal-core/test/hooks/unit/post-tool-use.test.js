...
/**
 * Unit Tests for post-tool-use.sh
 *
...
const HOOK_PATH = path.join(PROJECT_ROOT, 'plugins/opspal-core/hooks/post-tool-use.sh');

function createTester() {
  return new HookTester('plugins/opspal-core/hooks/post-tool-use.sh', {
    timeout: 10000,
