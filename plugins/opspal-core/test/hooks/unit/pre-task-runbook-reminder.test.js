...
async function runAllTests() {
  ...
  results.push(await runTest('Passes through when reminder disabled', async () => {
    const input = '{"subagent_type":"sfdc-object-auditor"}';
    ...
    assert.deepStrictEqual(result.output, { subagent_type: 'sfdc-object-auditor' }, 'Should echo input');
  }));
