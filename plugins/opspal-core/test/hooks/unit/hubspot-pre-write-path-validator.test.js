...
/**
 * Unit Tests for HubSpot pre-write-path-validator.sh
 *
...
async function runAllTests() {
  console.log('\n[Tests] HubSpot pre-write-path-validator.sh Tests\n');
  ...
  results.push(await runTest('Skips when no file path provided', async () => {
