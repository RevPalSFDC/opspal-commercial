...
/**
 * Unit Tests for pre-tool-validator.sh
 *
...
const HOOK_PATH = path.join(PROJECT_ROOT, 'plugins/opspal-core/hooks/validation/pre-tool-validator.sh');

function createTester() {
  return new HookTester('plugins/opspal-core/hooks/validation/pre-tool-validator.sh', {
    timeout: 10000,
...
async function runAllTests() {
  console.log('\n[Tests] pre-tool-validator.sh Tests\n');
