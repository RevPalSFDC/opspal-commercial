...
/**
 * Unit Tests for session-end-scratchpad.sh
 *
...
const HOOK_PATH = path.join(PROJECT_ROOT, 'plugins/opspal-core/hooks/session-end-scratchpad.sh');
...
async function runAllTests() {
  console.log('\n[Tests] session-end-scratchpad.sh Tests\n');
