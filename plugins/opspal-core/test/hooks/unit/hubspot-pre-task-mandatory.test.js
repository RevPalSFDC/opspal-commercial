...
/**
 * Unit Tests for HubSpot pre-task-mandatory.sh
 *
...
async function runAllTests() {
  console.log('\n[Tests] HubSpot pre-task-mandatory.sh Tests\n');
  ...
  results.push(await runTest('Skips when task input is empty', async () => {
