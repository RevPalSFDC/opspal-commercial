...
async function runAllTests() {
    ...
    if (passed === total) {
        ...
        return { passed, total, success: false };
    }
}
...
// Jest wrapper
describe('UserExpectationTracker', () => {
    it('should pass majority of validation tests', async () => {
        const originalLog = console.log;
        console.log = () => {}; // Suppress logs during Jest run
    ...
    }, 30000); // 30 second timeout for all subtests
});
