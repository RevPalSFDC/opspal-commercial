...
> ⚠️ **EXPERIMENTAL**: This plugin is in experimental status. APIs and functionality may change without notice.
...
node .claude-plugins/opspal-monday/scripts/lib/monday-file-extractor.js --item <id>
```
