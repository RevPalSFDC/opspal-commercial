...
argument-hint: "[--item <id>|--update <id>|--board <id>] [--include-updates] [--output <path>]"
allowed-tools:
  - Read
  - Write
  - Bash
...
- `node .claude-plugins/opspal-monday/scripts/lib/monday-api-client.js test` - Test API connection
- `node .claude-plugins/opspal-monday/scripts/lib/monday-file-extractor.js --help` - CLI help
