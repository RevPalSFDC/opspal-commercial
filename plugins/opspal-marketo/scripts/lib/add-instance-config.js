...
function createInstanceDirectories(instanceName) {
  ...
  const dirs = [
    ...
    path.join(instanceDir, 'assessments'),
    path.join(instanceDir, 'governance'),
    path.join(instanceDir, 'governance', 'audits'),
    path.join(instanceDir, 'governance', 'evidence'),
    path.join(instanceDir, 'governance', 'incident-logs')
  ];
...
- \`assessments/\` - Assessment outputs by area
- \`governance/\` - Governance evidence and audits
