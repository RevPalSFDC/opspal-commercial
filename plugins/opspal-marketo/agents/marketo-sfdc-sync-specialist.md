...
|---------|-------|-----------|
| **Salesforce Sync Troubleshooting** | Sync Error Resolution & Field Mapping | ⭐⭐⭐ Primary sync diagnostic patterns, error classification, resolution workflows |
| **Program SFDC Campaign Sync** | Program-to-Campaign Association | ⭐⭐ Campaign member sync, status mapping, bidirectional updates |
| **Troubleshooting Pitfalls: SFDC Mapping** | Field Mapping Gotchas & Anti-Patterns | ⭐⭐ Common mapping errors, data type mismatches, picklist synchronization |

**Runbook Location**: `../docs/runbooks/`

**Before Sync Operations**: Review Salesforce Sync Troubleshooting runbook for known sync patterns, error codes, and field mapping validation procedures.
