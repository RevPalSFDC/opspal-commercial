 ...
 *
 * Examples:
 *   node object-existence-validator.js delta-sandbox Quote
 *   node object-existence-validator.js eta-corp-prod SBQQ__Quote__c
 *
...
async function main() {
    ...
    if (args.length < 2) {
        ...
        console.log(colors.gray('  node object-existence-validator.js delta-sandbox Quote'));
        console.log(colors.gray('  node object-existence-validator.js eta-corp-prod SBQQ__Quote__c'));
