 ...
 * Generalizes the proven intelligent-backup-builder.js pattern from delta-corp reflection.
 *
 ...
 *
 * **Proven Solution (delta-corp Reflection d448b6bf):**
...
class MetadataBackupPlanner {
   ...
   * This replicates the delta-corp success pattern
   * @private
   */
...
if (require.main === module) {
  ...
  if (args.length < 2) {
    ...
    console.log('  node metadata-backup-planner.js delta-production Account');
    console.log('  node metadata-backup-planner.js delta-production Account intelligent backup-plan.json\n');
    process.exit(1);
  }
