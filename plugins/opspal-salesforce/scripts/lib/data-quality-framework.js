 ...
 *
 * // Detect duplicates
 * const framework = new DataQualityFramework('delta-production');
...
Examples:
  node data-quality-framework.js Contact delta-production
  node data-quality-framework.js Contact delta-production --methods=email
  node data-quality-framework.js Account delta-production --verbose
        `);
        process.exit(0);
    }
