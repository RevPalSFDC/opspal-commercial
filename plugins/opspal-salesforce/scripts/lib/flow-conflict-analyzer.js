 ...
 *   node flow-conflict-analyzer.js beta-corp-uat Contact
 *   node flow-conflict-analyzer.js beta-production  # Scans all objects
 *
 * Output:
...
Examples:
  node flow-conflict-analyzer.js beta-corp-uat Contact
  node flow-conflict-analyzer.js beta-production
