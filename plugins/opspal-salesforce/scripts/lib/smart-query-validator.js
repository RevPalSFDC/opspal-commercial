 ...
 *   node smart-query-validator.js beta-production "SELECT Id, FirstName FROM Contact"
 *
 * Or use as a library:
...
Examples:
  node smart-query-validator.js beta-production "SELECT Id, FirstName FROM Contact"
  node smart-query-validator.js beta-production "SELECT Id, MasterLabel FROM Flow"
  node smart-query-validator.js beta-production "SELECT Id, Registred__c FROM Contact" --verbose
