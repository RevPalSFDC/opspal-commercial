...
if (require.main === module) {
  ...
  if (!orgAlias) {
    ...
    console.error('  node automation-audit-history.js gamma-corp list');
    console.error('  node automation-audit-history.js gamma-corp latest');
    console.error('  node automation-audit-history.js gamma-corp compare 1759962799345 latest');
    console.error('  node automation-audit-history.js gamma-corp trends');
    process.exit(1);
  }
