...
if (require.main === module) {
  ...
  if (args.length < 3) {
    ...
    console.log('  node validate-backups-robust.js delta-production Account ./backup/account.csv');
    console.log('  node validate-backups-robust.js delta-production Account ./backup/account.csv --expected-count 29123');
    console.log('  node validate-backups-robust.js delta-production Account ./backup/account.csv --required-fields "Id,Name,BillingAddress"\n');
    process.exit(1);
  }
