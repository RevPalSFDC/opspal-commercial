 ...
 *
 * Examples:
 *   node user-id-resolver.js delta-sandbox john@example.com
 *   node user-id-resolver.js beta-corp-uat admin@company.com --cache
 *
...
async function main() {
    ...
    if (args.length < 2) {
        ...
        console.log(colors.gray('\nExamples:'));
        console.log(colors.gray('  node user-id-resolver.js delta-sandbox john@example.com'));
        console.log(colors.gray('  node user-id-resolver.js beta-corp-uat admin@company.com --cache'));
