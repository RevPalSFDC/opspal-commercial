 ...
 * Examples:
 *   # Verify from file
 *   node scripts/lib/verify-contact-identities.js delta-production contacts-to-verify.json
 *
 *   # Inline verification
 *   node scripts/lib/verify-contact-identities.js delta-production --inline '[{"contactId":"003...", "expectedName":"John Smith", "expectedEmail":"john@example.com"}]'
 *
 * Input Format (JSON):
 *   [
 *     {
...
Examples:
  ...
  node verify-contact-identities.js delta-production contacts.json

  # Inline verification
  node verify-contact-identities.js delta-production --inline '[{"contactId":"003...","expectedName":"John Smith"}]'

  # Lenient mode (email mismatches as warnings)
  node verify-contact-identities.js delta-production contacts.json --lenient

  # Save report
  node verify-contact-identities.js delta-production contacts.json --output report.json
