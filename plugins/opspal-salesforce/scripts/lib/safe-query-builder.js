 ...
 * const records = await query.execute('delta-production');
 *
...
Examples:
  # Simple query
  node safe-query-builder.js Contact "Id,Name,Email" delta-production

  # With conditions
  node safe-query-builder.js Contact "Id,Name,Email" delta-production "Email IS NOT NULL"

  # Count records
  node safe-query-builder.js Contact "COUNT(Id)" delta-production "Clean_Status__c = 'Review'"
        `);
        process.exit(0);
    }
