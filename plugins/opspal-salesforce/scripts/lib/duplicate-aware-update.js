 ...
 *   node scripts/lib/duplicate-aware-update.js delta-production 0032A00002az0UPQAY ebedel@hayesgibson.com
 *
 *   # Auto-merge if duplicate found
 *   node scripts/lib/duplicate-aware-update.js delta-production 0032A00002az0UPQAY ebedel@hayesgibson.com --auto-merge
 *
 *   # Batch mode (via JSON file)
 *   node scripts/lib/duplicate-aware-update.js delta-production --batch updates.json
 */
...
Examples:
  ...
  node duplicate-aware-update.js delta-production 0032A00002az0UPQAY ebedel@hayesgibson.com

  # Dry run (preview only)
  node duplicate-aware-update.js delta-production 0032A00002az0UPQAY ebedel@hayesgibson.com --dry-run

  # Batch update
  node duplicate-aware-update.js delta-production --batch email-updates.json
    `);
    process.exit(0);
  }
