...
if (require.main === module) {
    (async () => {
        ...
        if (args.length < 3) {
            ...
            console.log('  bulk-operation-validator.js acme-production ownership-transfer 389 \\');
            console.log('    --source-user 005xxx --target-user 005yyy --backup-file /path/to/backup.json');
            console.log('');
            console.log('  bulk-operation-validator.js "acme-corp production" bulk-update 150');
            process.exit(1);
        }
