...
EXAMPLES:
  ...
  node scripts/lib/queryability-checker.js --org delta-sandbox --manifest deployment-manifest.json

  # Test single field
  node scripts/lib/queryability-checker.js --org delta-sandbox --object Account --field Custom_Field__c
