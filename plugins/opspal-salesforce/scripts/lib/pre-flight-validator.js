...
if (require.main === module) {
  ...
  if (args.length < 2) {
    ...
    console.log('  node pre-flight-validator.js delta-production Account');
    console.log('  node pre-flight-validator.js delta-production Account --mode intelligent');
    console.log('  node pre-flight-validator.js delta-production Account --fields "Id,Name,BillingAddress"');
    console.log('  node pre-flight-validator.js delta-production Account --where "CreatedDate > LAST_N_DAYS:30"\n');
    process.exit(1);
  }
