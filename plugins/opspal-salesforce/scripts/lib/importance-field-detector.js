 ...
 *
 * Usage:
 *   node importance-field-detector.js Account delta-production
 *   node importance-field-detector.js Account delta-production --verbose
 *   node importance-field-detector.js Account delta-production --output-format json
 *
 * Output:
