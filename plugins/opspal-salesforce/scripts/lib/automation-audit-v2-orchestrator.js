...
class AutomationAuditV2Orchestrator {
  ...
  async generateFieldWriteMapReport() {
    ...
    try {
      ...
      report += `---\n\n`;
      report += `**Generated by**: OpsPal by RevPal v3.28.0\n`;
  ...
  async generateRecursionRiskReport() {
    ...
    try {
      ...
      report += `---\n\n`;
      report += `**Generated by**: OpsPal by RevPal v3.29.0\n`;
      report += `**Timestamp**: ${new Date().toISOString()}\n`;
  ...
  generateMasterSummary() {
    ...
    summary += `---\n\n`;
    summary += `**Generated by**: OpsPal by RevPal v2.0\n`;
...
if (require.main === module) {
  ...
  if (args.length < 2) {
    ...
    console.error('Example: node automation-audit-v2-orchestrator.js gamma-corp ./audit-output');
    console.error('');
