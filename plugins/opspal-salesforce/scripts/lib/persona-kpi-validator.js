  ...
  sections.forEach(section => {
    ...
    rawComponents.forEach(comp => {
      ...
      components.push({
        ...
        // Bridge fields for actionability scoring (maps XML fields to scorer expectations)
        hasTarget: !!(comp.indicatorBreakpoint1 || comp.indicatorHighColor || comp.indicatorLowColor || comp.gaugeMax),
        drillDown: comp.drillEnabled === 'true' || comp.drillEnabled === true,
        description: comp.footer || comp.componentChartTheme || ''
      });
    });
  });
