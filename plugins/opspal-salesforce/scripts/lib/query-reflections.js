...
// Load .env from project root (supports hook invocation where cwd may differ)
try {
  const dotenv = require('dotenv');
  const envPaths = [
    path.join(process.cwd(), '.env'),
    path.join(__dirname, '../../../../.env'),   // .claude-plugins/opspal-salesforce/scripts/lib/ → root
    path.join(__dirname, '../../../.env'),       // plugins/opspal-salesforce/scripts/lib/ → root
  ];
