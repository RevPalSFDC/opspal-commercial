...
if (require.main === module) {
  ...
  if (args.length === 0) {
    ...
    console.log('\nExamples:');
    console.log('  node metadata-propagation-waiter.js report Renewal_CheckIn_Tasks acme-production');
    console.log('  node metadata-propagation-waiter.js object Custom_Object__c');
    console.log('  node metadata-propagation-waiter.js flow Account_Handler acme-production');
