...
EXAMPLES:
  ...
  node scripts/lib/permission-set-generator.js --manifest deployment-manifest.json --exclude-required --org delta-sandbox

  # Generate for single object
  node scripts/lib/permission-set-generator.js --object Approval_Rule_Config__c --org delta-sandbox --exclude-required
