...
node scripts/lib/instance-agnostic-metadata-analyzer.js Opportunity

# Analyze custom object with deliverables
node scripts/lib/instance-agnostic-metadata-analyzer.js CustomObject__c --deliverables
```
