...
**Automatic Detection**:
```javascript
const TriggerComplexityCalculator = require('./scripts/lib/trigger-complexity-calculator');
...
### Context Files
Located in `.claude-plugins/opspal-salesforce/contexts/apex-development/`
