...
Agent: "Scanning permission sets in <org>...
        ...
        Running: node scripts/lib/permission-set-discovery.js --org <org> --output instances/<org>/permission-assessment/discovery-<date>.json
...
Agent: "Analyzing CPQ permission sets...
        ...
        Running: node scripts/lib/permission-set-analyzer.js --org <org> --initiative CPQ --output instances/<org>/permission-assessment/analysis-CPQ-<date>.json
...
Agent: "Creating migration plan for CPQ...
        ...
        Running: node scripts/lib/permission-set-migration-planner.js --org <org> --initiative CPQ --output instances/<org>/permission-assessment/migration-plan-CPQ-<date>.json
