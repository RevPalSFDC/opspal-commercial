...
**Load context:** `CONTEXT=$(node scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type ui_customization --format json)`
...
./scripts/assign-layout-to-profiles.sh "Renewal Layout" "Opportunity" "Renewal" myorg

# Check current assignments
node scripts/lib/profile-layout-assigner.js get-assignments Opportunity
```
