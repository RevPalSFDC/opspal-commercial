...
auto_resolve_orchestration_error_with_validation() {
    ...
    case "$error_type" in
        "VALIDATION_FAILURE")
            ...
            node scripts/lib/validation-recovery.js resolve \
        ...
        "AGENT_VALIDATION_ERROR")
            ...
            node scripts/lib/agent-validator.js recover \
        ...
        "ORCHESTRATION_VALIDATION_DRIFT")
            ...
            node scripts/lib/validation-drift-corrector.js correct \
        ...
        "COMPOSITE_VALIDATION_FAILURE")
            ...
            node scripts/lib/composite-validation-recovery.js resolve \
        ...
        *)
            ...
            node scripts/lib/error-recovery.js --preserve-validation \
...
monitor_orchestration_validation_health() {
    ...
    while orchestration_active "$operation_id"; do
        ...
        validation_health=$(node scripts/monitoring/validation-monitor.js \
        ...
        agent_validation_status=$(node scripts/monitoring/agent-validation-monitor.js \
