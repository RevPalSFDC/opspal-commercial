...
node scripts/lib/object-existence-validator.js <org-alias> <object-name>

# For common objects, discover which variant exists
node scripts/lib/object-existence-validator.js <org-alias> Quote --discover
```
...
node scripts/lib/flow-formula-validator.js <flow-file> <org-alias> --auto-fix
```
...
node scripts/lib/user-id-resolver.js <org-alias> <email>
