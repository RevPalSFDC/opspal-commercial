...
argument-hint: "gamma-corp --latest"
---
...
/flow-test Account_Validation_Flow gamma-corp --type record-triggered --object Account --operation insert --data '{"Name":"Test"}'
/flow-logs Account_Validation_Flow gamma-corp --latest  # Automatically gets log from test execution
```
