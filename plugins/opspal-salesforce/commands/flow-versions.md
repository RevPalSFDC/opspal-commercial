...
argument-hint: "<flow-developer-name> --org <org-alias>"
---
...
```bash
node scripts/lib/flow-version-manager.js <command> <flow-name> <org-alias> [options]
```
...
```bash
# List all versions
node scripts/lib/flow-version-manager.js listVersions Account_Update_Handler acme-production --verbose

# Activate version 5
node scripts/lib/flow-version-manager.js activateVersion Account_Update_Handler 5 acme-production

# Compare versions
node scripts/lib/flow-version-manager.js compareVersions Account_Update_Handler 3 5 acme-production
```
