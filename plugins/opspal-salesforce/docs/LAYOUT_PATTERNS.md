...
Located in: `instances/acme-production/deployment-test/force-app/main/default/flexipages/`
...
3. **Regenerate using template engine:**
   ```bash
   node scripts/lib/layout-template-engine.js my-org Contact sales-rep --output-dir ./generated
   ```
