...
node scripts/lib/trigger-batch-manager.js create --config batch-config.json

# Validate all triggers
node scripts/lib/trigger-batch-manager.js validate --triggers ./force-app/main/default/triggers

# Deploy triggers
node scripts/lib/trigger-batch-manager.js deploy --org dev-org --triggers ./force-app/main/default/triggers

# Test triggers with coverage report
node scripts/lib/trigger-batch-manager.js test --org dev-org --triggers ./force-app/main/default/triggers
```
...
node scripts/lib/trigger-complexity-calculator.js calculate --file AccountTrigger.trigger

# Get recommendations
node scripts/lib/trigger-complexity-calculator.js recommend --file AccountTrigger.trigger
```
...
node scripts/lib/trigger-handler-generator.js generate \
  --name AccountTrigger \
  --object Account \
