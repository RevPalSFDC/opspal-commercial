...
node .claude-plugins/developer-tools-plugin/scripts/lib/response-validation-orchestrator.js \
  validate \
...
Edit `.claude-plugins/developer-tools-plugin/.claude-plugin/settings.json`:
...
```bash
node .claude-plugins/developer-tools-plugin/scripts/lib/response-sanity-checker.js \
  update-profile \
...
```
Response: "Found 15,000 accounts in delta-production"
...
```bash
node .claude-plugins/developer-tools-plugin/scripts/lib/smart-detection.js \
  summary \
  --response response.txt \
...
### Documentation
- Agent: `.claude-plugins/developer-tools-plugin/agents/response-validator.md`
- Tests: `.claude-plugins/developer-tools-plugin/scripts/lib/__tests__/response-validation.test.js`
- Examples: `.claude-plugins/developer-tools-plugin/scripts/lib/__tests__/fixtures/`
