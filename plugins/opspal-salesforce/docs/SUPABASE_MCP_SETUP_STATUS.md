...
1. **✅ .mcp.json Configuration**
   - Type: HTTP transport
   - URL: `https://mcp.supabase.com/mcp?project_ref=REDACTED_SUPABASE_PROJECT_REF&features=database,docs`
...
open https://supabase.com/dashboard/project/REDACTED_SUPABASE_PROJECT_REF/sql/new
...
# Run migration
supabase db push --project-ref REDACTED_SUPABASE_PROJECT_REF \
...
3. **Paste & Run**: [Open SQL Editor](https://supabase.com/dashboard/project/REDACTED_SUPABASE_PROJECT_REF/sql/new)
