...
// 2. Execute rollback
await Bash({
  command: `node scripts/lib/dedup-rollback-system.js \
...
node scripts/lib/dedup-rollback-system.js --execution-log execution-logs/exec_2025-10-16T12-00-00-000Z.json
```
