...
**Location:** `.claude-plugins/opspal-salesforce/scripts/lib/salesforce-pagination.js`
...
**Location:** `.claude-plugins/opspal-salesforce/scripts/lib/validate-analysis-freshness.js`
...
**Location:** `.claude-plugins/opspal-salesforce/hooks/pre-batch-validation.sh`
