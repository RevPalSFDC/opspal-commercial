...
**Run**: `node scripts/examples/structured-report-example.js`
...
**Run**: `node scripts/examples/structured-audit-example.js`
...
```bash
# Test formatter demo
node scripts/lib/structured-content-formatter.js

# Test deployment example
node scripts/examples/structured-report-example.js

# Test audit example
node scripts/examples/structured-audit-example.js
```
