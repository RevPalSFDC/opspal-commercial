...
node scripts/lib/data-quality-monitor.js check-population --object Account --field Industry

# Validate integration health
node scripts/lib/integration-health-checker.js --source gong

# Run pattern validation
node scripts/qa/pattern-validator.js --old-pattern "OLD" --new-pattern "NEW" --dataset records.csv
```
