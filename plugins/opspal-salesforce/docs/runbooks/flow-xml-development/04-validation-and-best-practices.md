...
- **Validation Pipeline**: `.claude-plugins/opspal-salesforce/scripts/lib/flow-validator.js`
- **Best Practices Guide**: `.claude-plugins/opspal-salesforce/docs/FLOW_DESIGN_BEST_PRACTICES.md`
