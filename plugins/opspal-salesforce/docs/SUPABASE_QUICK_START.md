...
Click this link: [Open SQL Editor](https://supabase.com/dashboard/project/REDACTED_SUPABASE_PROJECT_REF/sql/new)
...
### Create Asana Task
```bash
node scripts/lib/create-reflection-task.js <reflection-id>
```
...
# Search
node scripts/lib/query-reflections.js search "automation"

# Your org
node scripts/lib/query-reflections.js myOrg gamma-corp
```
