...
**Test Results** (delta-corp Sandbox - 10,922 accounts):
```
...
**Test Results** (epsilon-corp Sandbox - 12 accounts):
```
...
**Expected Output** (delta-corp Sandbox - 10,922 accounts):
```
📦 Step 1: Extracting active records (FIELDS(ALL))...
...
### Test Environment 1: delta-corp Sandbox (Large Org)
...
### Test Environment 2: epsilon-corp Sandbox (Small Org)
- **Size**: 12 accounts
