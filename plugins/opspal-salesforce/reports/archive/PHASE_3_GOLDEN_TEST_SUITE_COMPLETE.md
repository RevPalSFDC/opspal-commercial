...
**File**: `.claude-plugins/opspal-salesforce/test/golden-test-suite.js`
...
**File**: `.claude-plugins/opspal-salesforce/test/test-utils.js`
...
**File**: `.claude-plugins/opspal-salesforce/test/test-data-generator.js`
...
**File**: `.claude-plugins/opspal-salesforce/test/fixtures/golden-fixtures.js`
...
**File**: `.claude-plugins/opspal-salesforce/test/run-tests.sh`
...
Plugin directory: .claude-plugins/opspal-salesforce
...
**File**: `.claude-plugins/opspal-salesforce/test/regression-detector.js`
