...
**File**: `.claude-plugins/opspal-salesforce/scripts/lib/smart-query-validator.js`
...
**File**: `.claude-plugins/opspal-salesforce/scripts/lib/sf-command-interceptor.js`
...
**File**: `.claude-plugins/opspal-salesforce/docs/LLM_COMMON_MISTAKES.md`
...
**File**: `.claude-plugins/opspal-salesforce/docs/ERROR_PREVENTION_SYSTEM.md`
...
**File**: `.claude-plugins/opspal-salesforce/agents/sfdc-security-admin.md`
...
1. `.claude-plugins/opspal-salesforce/scripts/lib/smart-query-validator.js` - Validation logic
2. `.claude-plugins/opspal-salesforce/scripts/lib/sf-command-interceptor.js` - Command interception

### Documentation Created (1 file)
1. `.claude-plugins/opspal-salesforce/docs/LLM_COMMON_MISTAKES.md` - Complete guide (NEW)

### Documentation Updated (1 file)
1. `.claude-plugins/opspal-salesforce/docs/ERROR_PREVENTION_SYSTEM.md` - Added Rule 8

### Agent Instructions Updated (2 files)
1. `.claude-plugins/opspal-salesforce/agents/sfdc-metadata-analyzer.md` - Added warnings
2. `.claude-plugins/opspal-salesforce/agents/sfdc-security-admin.md` - Added warnings

### Summary Report (1 file)
1. `.claude-plugins/opspal-salesforce/RECORDTYPEVISIBILITY_FIX_COMPLETE.md` - This file (NEW)
