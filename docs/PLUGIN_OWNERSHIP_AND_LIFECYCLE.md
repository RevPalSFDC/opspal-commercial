...
| `opspal-marketo` | 2.6.20 | `active` | `revpal-marketing-ops` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.84.12 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
