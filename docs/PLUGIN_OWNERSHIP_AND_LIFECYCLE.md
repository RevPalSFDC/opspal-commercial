...
| `opspal-core` | 2.54.21 | active | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-marketo` | 2.6.36 | active | `revpal-marketing-ops` | `stable` | `2026-02-15` | _unset_ | _unset_ |
