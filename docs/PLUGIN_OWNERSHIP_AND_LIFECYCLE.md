...
| `opspal-core` | 2.50.11 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.87.0 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
