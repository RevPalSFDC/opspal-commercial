...
| `opspal-core` | 2.42.32 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-hubspot` | 3.9.9 | `active` | `revpal-hubspot` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.84.20 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
