...
| `opspal-core` | 2.44.2 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.85.6 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
