...
|--------|---------|--------|-------|-----------|---------------|------------------|-------------|
| `opspal-ai-consult` | 1.4.10 | `active` | `revpal-ai` | `stable` | `2026-02-15` | _unset_ | _unset_ |
| `opspal-core` | 2.44.1 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-hubspot` | 3.9.13 | `active` | `revpal-hubspot` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.85.5 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
