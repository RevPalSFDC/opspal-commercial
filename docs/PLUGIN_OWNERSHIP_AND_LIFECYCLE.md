...
| `opspal-core` | 2.48.1 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-marketo` | 2.6.28 | `active` | `revpal-marketing-ops` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.86.17 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
