...
| `opspal-core` | 2.42.23 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-hubspot` | 3.9.7 | `active` | `revpal-hubspot` | `stable` | `2026-02-15` | _unset_ | _unset_ |
| `opspal-marketo` | 2.6.21 | `active` | `revpal-marketing-ops` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.84.13 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
