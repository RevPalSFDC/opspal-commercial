...
| `opspal-hubspot` | 3.9.11 | `active` | `revpal-hubspot` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.84.24 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
