...
| `opspal-core` | 2.50.12 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.87.1 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
