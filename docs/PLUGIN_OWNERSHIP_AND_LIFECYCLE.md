...
| `opspal-core` | 2.54.20 | active | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.87.7 | active | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
