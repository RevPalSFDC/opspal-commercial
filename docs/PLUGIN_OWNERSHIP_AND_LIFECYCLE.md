...
| `opspal-core` | 2.54.23 | active | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-hubspot` | 3.9.28 | active | `revpal-hubspot` | `stable` | `2026-02-15` | _unset_ | _unset_ |
