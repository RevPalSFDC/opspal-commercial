...
| `opspal-core` | 2.55.1 | active | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-hubspot` | 3.9.30 | active | `revpal-hubspot` | `stable` | `2026-02-15` | _unset_ | _unset_ |
| `opspal-marketo` | 2.6.39 | active | `revpal-marketing-ops` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.87.10 | active | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
