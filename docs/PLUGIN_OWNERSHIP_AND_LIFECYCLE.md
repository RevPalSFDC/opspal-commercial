...
| `opspal-core` | 2.42.26 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.84.15 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
