...
| `opspal-core` | 2.54.10 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
| `opspal-gtm-planning` | 2.3.8 | `active` | `revpal-gtm` | `stable` | `2026-02-15` | _unset_ | _unset_ |
| `opspal-hubspot` | 3.9.23 | `active` | `revpal-hubspot` | `stable` | `2026-02-15` | _unset_ | _unset_ |
| `opspal-marketo` | 2.6.32 | `active` | `revpal-marketing-ops` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.87.4 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
