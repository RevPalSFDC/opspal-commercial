...
| `opspal-core` | 2.45.0 | `active` | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.86.0 | `active` | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
