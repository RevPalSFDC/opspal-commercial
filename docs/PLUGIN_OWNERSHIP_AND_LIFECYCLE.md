...
| `opspal-attio` | 2.0.2 | active | _unset_ | _unset_ | _unset_ | _unset_ | _unset_ |
| `opspal-core` | 2.55.28 | active | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.87.23 | active | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
