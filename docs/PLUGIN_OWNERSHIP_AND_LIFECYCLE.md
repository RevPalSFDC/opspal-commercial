...
| `opspal-core` | 2.55.18 | active | `revpal-platform` | `stable` | `2026-02-15` | _unset_ | _unset_ |
...
| `opspal-salesforce` | 3.87.18 | active | `revpal-salesforce` | `stable` | `2026-02-15` | _unset_ | _unset_ |
