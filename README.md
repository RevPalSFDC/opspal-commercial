...
| `opspal-core` | 2.42.4 | active | 79 | 111 | 74 |
| `opspal-data-hygiene` | 1.2.0 | deprecated | 2 | 1 | 1 |
| `opspal-gtm-planning` | 2.3.0 | active | 13 | 16 | 4 |
| `opspal-hubspot` | 3.9.0 | active | 59 | 33 | 13 |
| `opspal-marketo` | 2.6.16 | active | 30 | 30 | 19 |
| `opspal-mcp-client` | 1.1.0 | active | 3 | 3 | 3 |
| `opspal-monday` | 1.4.5 | experimental | 6 | 1 | 0 |
| `opspal-okrs` | 3.0.3 | active | 14 | 14 | 3 |
| `opspal-salesforce` | 3.84.0 | active | 94 | 59 | 40 |
