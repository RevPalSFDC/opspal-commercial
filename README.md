...
Commercial Claude Code marketplace for RevOps delivery across Salesforce, HubSpot, Marketo, GTM planning, and executive reporting. This repo currently ships 10 plugins with 302 agents, 273 commands, and 174 hooks.
...
| `opspal-core` | 2.47.2 | active | 79 | 113 | 82 |
...
| `opspal-salesforce` | 3.86.13 | active | 94 | 59 | 42 |
