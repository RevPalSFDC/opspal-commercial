...
Commercial Claude Code marketplace for RevOps delivery across Salesforce, HubSpot, Marketo, GTM planning, and executive reporting. This repo currently ships 9 plugins with 300 agents, 271 commands, and 179 hooks.
...
| `opspal-core` | 2.50.5 | active | 80 | 114 | 88 |
...
| `opspal-salesforce` | 3.86.22 | active | 94 | 59 | 42 |
