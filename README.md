...
Commercial Claude Code marketplace for RevOps delivery across Salesforce, HubSpot, Marketo, GTM planning, and executive reporting. This repo currently ships 10 plugins with 302 agents, 273 commands, and 165 hooks.
...
|--------|---------|--------|--------|----------|-------|
| `opspal-ai-consult` | 1.4.10 | active | 2 | 3 | 1 |
| `opspal-core` | 2.43.4 | active | 79 | 113 | 79 |
| `opspal-data-hygiene` | 1.2.2 | deprecated | 2 | 1 | 1 |
| `opspal-gtm-planning` | 2.3.4 | active | 13 | 16 | 4 |
| `opspal-hubspot` | 3.9.13 | active | 59 | 33 | 13 |
| `opspal-marketo` | 2.6.23 | active | 30 | 30 | 19 |
| `opspal-mcp-client` | 1.1.2 | active | 3 | 3 | 3 |
| `opspal-monday` | 1.4.6 | experimental | 6 | 1 | 0 |
| `opspal-okrs` | 3.0.7 | active | 14 | 14 | 3 |
| `opspal-salesforce` | 3.85.5 | active | 94 | 59 | 42 |
