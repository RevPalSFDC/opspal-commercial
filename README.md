...
| `opspal-core` | 2.55.5 | active | 80 | 126 | 94 |
...
| [`opspal-core`](plugins/opspal-core) | 2.55.5 | active | 80 | 126 | OpsPal Core - Cross-platform pipeline orchestration with parallel execution, environment preflight & self-h... |
