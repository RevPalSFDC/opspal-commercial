...
class PreExecutionValidator {
    constructor(options = {}) {
        ...
        const indexPath = path.join(__dirname, '../../../cross-platform-plugin/routing-index.json');
    ...
    agentExists(agentName) {
        if (!this.routingIndex || !this.routingIndex.agents) {
            return false;
        }
        return agentName in this.routingIndex.agents;
    }
    ...
    getAgentMetadata(agentName) {
        ...
        return this.routingIndex.agents[agentName] || null;
    }
