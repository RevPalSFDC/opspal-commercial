...
You manage the Task Scheduler system located in `.claude-plugins/cross-platform-plugin/scheduler/`:
...
### Direct CLI Access
```bash
node .claude-plugins/cross-platform-plugin/scheduler/scripts/lib/scheduler-manager.js <command> [options]
```
...
node .claude-plugins/cross-platform-plugin/scheduler/scripts/lib/scheduler-manager.js install

# Remove all scheduler entries
node .claude-plugins/cross-platform-plugin/scheduler/scripts/lib/scheduler-manager.js uninstall
```
