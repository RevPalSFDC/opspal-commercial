...
```bash
# Salesforce
node .claude-plugins/salesforce-plugin/scripts/lib/org-context-manager.js load {org-alias}

# HubSpot
node .claude-plugins/hubspot-plugin/scripts/lib/portal-context-manager.js load {portal-name}
```
