...
Edit the agent file `.claude-plugins/hubspot-plugin/agents/hubspot-workflow-orchestrator.md`:
...
⚠️ Agent 'sfdc-custom-validator' defined in multiple locations
  Location 1: .claude-plugins/salesforce-plugin/agents/
...
node .claude-plugins/salesforce-plugin/scripts/lib/query-reflections.js \
...
# Check script exists
ls -la .claude-plugins/cross-platform-plugin/scripts/lib/plugin-health-checker.js
