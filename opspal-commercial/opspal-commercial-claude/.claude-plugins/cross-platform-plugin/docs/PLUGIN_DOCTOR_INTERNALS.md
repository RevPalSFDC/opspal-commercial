...
```javascript
{
  ...
  "discovered": [
    {
      ...
      "path": ".claude-plugins/cross-platform-plugin/agents/plugin-doctor.md",
      "fields": {
        "name": "plugin-doctor",
  ...
  "failed": [
    {
      "path": ".claude-plugins/hubspot-plugin/agents/custom.md",
      "filename": "custom.md",
  ...
  "duplicates": [
    {
      ...
      "locations": [
        {
          "path": ".claude-plugins/salesforce-plugin/agents/sfdc-custom-validator.md",
