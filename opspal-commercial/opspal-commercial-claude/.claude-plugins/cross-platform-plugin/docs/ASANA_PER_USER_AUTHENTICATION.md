...
# Test the token
node .claude-plugins/cross-platform-plugin/scripts/lib/asana-auth-helper.js test

# Get your user info
node .claude-plugins/cross-platform-plugin/scripts/lib/asana-auth-helper.js whoami
```
...
```bash
node .claude-plugins/cross-platform-plugin/scripts/lib/asana-auth-helper.js check
```
...
```bash
node .claude-plugins/cross-platform-plugin/scripts/lib/asana-auth-helper.js setup
```
