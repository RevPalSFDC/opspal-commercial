...
### Scripts (`.claude-plugins/hubspot-plugin/scripts/lib/`)
...
### Agent (`.claude-plugins/hubspot-plugin/agents/`)
- `hubspot-seo-content-optimizer.md`

### Commands (`.claude-plugins/hubspot-plugin/commands/`)
- `seo-audit.md` (enhanced)
- `optimize-content.md` (new)

### Documentation (`.claude-plugins/hubspot-plugin/`)
