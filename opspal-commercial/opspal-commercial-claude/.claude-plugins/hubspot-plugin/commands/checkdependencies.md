...
```bash
node .claude-plugins/salesforce-plugin/scripts/lib/check-dependencies.js
```
...
```bash
node .claude-plugins/salesforce-plugin/scripts/lib/check-dependencies.js --install
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/check-dependencies.js
```
