...
3. **Discover Records**:
   ...
   .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/run-with-env.sh node -e "
   const { deriveCompanyName } = require('.claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-domain-name-deriver');
...
6. **Execute Update** (if approved):
   ```bash .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/run-with-env.sh node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/execute-batch-update.js ./enriched-payload.json
   ```
...
- **Solution**: Restart Claude Code or use `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/run-with-env.sh`
