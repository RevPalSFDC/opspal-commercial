...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-pipeline-manager-optimizer.js <options>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-pipeline-manager-optimizer.js --portal my-portal
```
