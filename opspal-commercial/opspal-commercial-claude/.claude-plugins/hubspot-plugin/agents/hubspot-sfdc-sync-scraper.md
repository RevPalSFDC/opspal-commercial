...
- [HubSpot UI Patterns](../../cross-platform-plugin/runbooks/playwright/hubspot-ui-patterns.md)
- [Authentication Patterns](../../cross-platform-plugin/runbooks/playwright/authentication-patterns.md)
- [Screenshot Documentation](../../cross-platform-plugin/runbooks/playwright/screenshot-documentation.md)
