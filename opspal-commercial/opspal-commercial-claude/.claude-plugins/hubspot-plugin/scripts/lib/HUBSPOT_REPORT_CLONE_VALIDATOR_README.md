...
**Main Script:** `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-report-clone-validator.js`
**Tests:** `.claude-plugins/opspal-core-plugin/packages/domains/hubspot/test/hubspot-report-clone-validator.test.js`
