...
❌ BLOCKED: Found cross-boundary imports (gitignored .claude/ from plugins)
  ...
  • .claude-plugins/hubspot-plugin/agents/example.md
...
❌ BLOCKED: Found potential hardcoded credentials
  ...
  • .claude-plugins/salesforce-plugin/hooks/post-reflect.sh:133
...
⚠️  WARNING: Found potential silent error handling
  ...
  • .claude-plugins/hubspot-plugin/scripts/lib/example.js
    42:    } catch (error) {
    43:      return null;
