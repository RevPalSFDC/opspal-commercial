...
tools: Bash, Read, Write, TodoWrite, mcp_salesforce_data_query
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/gtm-account-universe.js \
  --org <org-alias> \
...
```bash
# Option 1: Geographic
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/territory-balancer.js geo \
...
# Option 2: Vertical
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/territory-balancer.js vertical \
  --input territories/account_universe.csv \
  --verticals "Technology,FinServ,Healthcare,Manufacturing,Retail" \
  --output territories/carve_option_2_vertical.csv

# Option 3: Named + Pool
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/territory-balancer.js named-pool \
  --input territories/account_universe.csv \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/territory-fairness.js \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/territory-conflict-sim.js \
