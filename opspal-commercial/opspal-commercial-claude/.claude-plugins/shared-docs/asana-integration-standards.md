...
**Primary Documentation**: `.claude-plugins/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md` (comprehensive guide)
...
**Location**: `.claude-plugins/cross-platform-plugin/templates/asana-updates/`
...
- **Main Playbook**: `.claude-plugins/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md` - Complete integration guidelines
- **Update Templates**: `.claude-plugins/cross-platform-plugin/templates/asana-updates/*.md` - Template details and examples
- **Task Manager Agent**: `.claude-plugins/cross-platform-plugin/agents/asana-task-manager.md` - Reference implementation
