...
- **Bulk API Handler**: `.claude-plugins/salesforce-plugin/scripts/lib/bulk-api-handler.js`
- **HubSpot Client**: `.claude-plugins/hubspot-plugin/scripts/lib/hubspot-client-v3.js`
- **Library Reference**: `.claude-plugins/salesforce-plugin/agents/shared/library-reference.yaml`
