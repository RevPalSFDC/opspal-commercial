...
{
  "hooks": {
    "predeploy": ".claude-plugins/salesforce-plugin/hooks/pre-deploy-flow-validation.sh"
  }
}
```
...
.claude-plugins/salesforce-plugin/hooks/pre-deploy-flow-validation.sh
```
...
**Integration in Code:**
```javascript
const HubSpotReportCloneValidator = require('.claude-plugins/hubspot-plugin/scripts/lib/hubspot-report-clone-validator');
...
```javascript
const { validateBeforeCompletion } = require('.claude-plugins/cross-platform-plugin/scripts/lib/agent-completion-validator');
...
**Implementation:**
See `.claude-plugins/cross-platform-plugin/scripts/lib/agent-completion-validator.js`
```
...
```javascript
const UserExpectationTracker = require('.claude-plugins/cross-platform-plugin/scripts/lib/user-expectation-tracker');
...
**Standalone Usage:**
```javascript
const FlowFieldReferenceValidator = require('.claude-plugins/salesforce-plugin/scripts/lib/flow-field-reference-validator');
...
```javascript
// In test file
const BusinessProcessCoverageTracker = require('.claude-plugins/cross-platform-plugin/scripts/lib/business-process-coverage-tracker');
...
- name: Generate Coverage Report
  run: |
    node .claude-plugins/cross-platform-plugin/scripts/lib/business-process-coverage-tracker.js heatmap
    node .claude-plugins/cross-platform-plugin/scripts/lib/business-process-coverage-tracker.js gaps
```
  ...
  validate-and-deploy:
    ...
    steps:
      ...
      - name: Update Coverage
        run: |
          node .claude-plugins/cross-platform-plugin/scripts/lib/business-process-coverage-tracker.js summary
```
...
SF_DEPLOY_DIR=. .claude-plugins/salesforce-plugin/hooks/pre-deploy-flow-validation.sh
```
...
node .claude-plugins/cross-platform-plugin/scripts/lib/agent-completion-validator.js /tmp/test-validation.json
...
node .claude-plugins/cross-platform-plugin/scripts/lib/business-process-coverage-tracker.js init
node .claude-plugins/cross-platform-plugin/scripts/lib/business-process-coverage-tracker.js summary
```
...
ls -la .claude-plugins/salesforce-plugin/scripts/lib/flow-decision-logic-analyzer.js
