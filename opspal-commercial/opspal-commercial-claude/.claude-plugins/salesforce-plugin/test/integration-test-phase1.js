 ...
 * on bluerabbit/wedgewood Revpal sandbox and rentable sandbox
 *
 * Test Workflow:
 ...
 *
 * Test Orgs:
 * - bluerabbit-revpal (bluerabbit/wedgewood Revpal sandbox)
 * - rentable-production (rentable sandbox)
 *
 * Usage:
...
const TEST_ORGS = {
    'bluerabbit2021-revpal': {
        alias: 'bluerabbit2021-revpal',
        name: 'BlueRabbit/Wedgewood Revpal Sandbox',
        expectedRecords: 5000,
        testConcurrency: 5
    },
    'rentable-sandbox': {
        alias: 'rentable-sandbox',
        name: 'Rentable Sandbox',
...
Test Orgs:
  bluerabbit2021-revpal  BlueRabbit/Wedgewood Revpal Sandbox
...
Examples:
  node integration-test-phase1.js bluerabbit2021-revpal
  node integration-test-phase1.js rentable-sandbox
  node integration-test-phase1.js --all
        `);
        process.exit(0);
    }
