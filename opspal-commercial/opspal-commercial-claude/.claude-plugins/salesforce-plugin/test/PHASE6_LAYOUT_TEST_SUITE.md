...
node scripts/lib/layout-template-engine.js \
  ...
  --output instances/peregrine-sandbox/phase6-tests/marketing
```
...
node scripts/lib/layout-template-engine.js \
  ...
  --org PEREGRINE_SANDBOX \
  --output instances/peregrine-sandbox/phase6-tests/customer-success
```
...
node scripts/lib/layout-template-engine.js \
  ...
  --persona sales-rep \
  --org PEREGRINE_SANDBOX \
  --output instances/peregrine-sandbox/phase6-tests/sales-rep
```
