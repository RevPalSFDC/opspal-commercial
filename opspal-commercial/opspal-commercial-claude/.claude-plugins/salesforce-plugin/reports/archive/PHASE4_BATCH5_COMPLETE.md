...
- `.claude-plugins/salesforce-plugin/agents/sfdc-data-operations.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-integration-specialist.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-apex-developer.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-security-admin.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-deployment-manager.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-automation-builder.md`

### Batch 5 Files (8 agents)
- `.claude-plugins/salesforce-plugin/agents/sfdc-cpq-specialist.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-lightning-developer.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-ui-customizer.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-einstein-admin.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-service-cloud-admin.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-compliance-officer.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-data-generator.md`
- `.claude-plugins/salesforce-plugin/agents/sfdc-csv-enrichment.md`

### Documentation
- `.claude-plugins/salesforce-plugin/PHASE4_BATCH4_COMPLETE.md`
- `.claude-plugins/salesforce-plugin/PHASE4_BATCH5_COMPLETE.md`
