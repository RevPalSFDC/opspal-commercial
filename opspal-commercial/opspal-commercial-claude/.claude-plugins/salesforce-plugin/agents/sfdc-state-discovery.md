...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js init <org>  # One-time, takes 5-10 min
```
...
const { BatchFieldMetadata } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/batch-field-metadata');
