...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor.js status <org-alias>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor.js report <org-alias> --save
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor.js check <org-alias> <operation-size>
```
...
```javascript
const APIUsageMonitor = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/api-usage-monitor');
