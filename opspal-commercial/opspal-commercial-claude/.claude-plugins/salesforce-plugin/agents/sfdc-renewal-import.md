...
.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/init-project.sh "renewal-import-$(date +%Y-%m-%d)" $SF_TARGET_ORG --type renewal-import
...
```javascript
const { OperationLinker } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/operation-linker');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/operation-linker.js discover $SF_TARGET_ORG renewal-import
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/idempotent-bulk-operation.js status renewal-import-2025-10-03-a3f4
...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type renewal_import --format json)`
