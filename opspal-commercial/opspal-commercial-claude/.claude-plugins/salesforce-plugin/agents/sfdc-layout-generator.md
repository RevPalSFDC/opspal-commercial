...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-persona-detector.js {org} {user-id} --verbose
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-rule-engine.js {org} {object} {persona} --verbose
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-template-engine.js {org} {object} {persona} \
  --verbose \
