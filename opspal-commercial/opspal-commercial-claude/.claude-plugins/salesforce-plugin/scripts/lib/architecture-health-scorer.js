...
Examples:
  ...
  node architecture-health-scorer.js calculate wedgewood-revpal-sandbox
  ...
  # Analyze coupling
  node architecture-health-scorer.js analyze-coupling wedgewood-revpal-sandbox
`);
        process.exit(0);
    }

    const scorer = new ArchitectureHealthScorer(args[1] || 'wedgewood-revpal-sandbox', { verbose: true });
