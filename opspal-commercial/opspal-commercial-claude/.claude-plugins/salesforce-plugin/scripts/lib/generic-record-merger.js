...
class GenericRecordMerger {
  ...
  /**
   * Check for circular hierarchy relationships
   * Prevents scenarios like Contact A reports to Contact B, then merging A into B
   */
