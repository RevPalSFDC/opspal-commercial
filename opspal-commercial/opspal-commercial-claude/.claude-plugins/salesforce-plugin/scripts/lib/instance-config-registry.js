 ...
 *   const config = new InstanceConfig('wedgewood-production');
 *
...
if (require.main === module) {
    (async () => {
        ...
        if (args.length < 2) {
            ...
            console.log('  instance-config-registry.js wedgewood-production get fieldMappings.funnelStage');
            console.log('  instance-config-registry.js wedgewood-production set fieldMappings.funnelStage Demand_Funnel_Stage__c');
            console.log('  instance-config-registry.js peregrine-main add-alias "peregrine production"');
            console.log('  instance-config-registry.js peregrine-main set-env-type production');
            console.log('  instance-config-registry.js wedgewood-production add-blocking-rule Vet_License_Required Contact "Requires vet license state"');
            console.log('  instance-config-registry.js wedgewood-production summary');
            process.exit(1);
        }
