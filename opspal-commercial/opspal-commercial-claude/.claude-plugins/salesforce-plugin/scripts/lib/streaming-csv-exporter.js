...
if (require.main === module) {
  ...
  if (args.length < 4) {
    ...
    console.log('  node streaming-csv-exporter.js rentable-production Account "Id,Name,BillingAddress" ./backup/account.csv');
    console.log('  node streaming-csv-exporter.js rentable-production Account "Id,Name" ./backup/account.csv 5000\n');
    console.log('Resume:');
