 ...
 * Examples:
 *   # Full discovery
 *   node scripts/lib/multi-object-ownership-discovery.js rentable-production
 *
 *   # JSON output
 *   node scripts/lib/multi-object-ownership-discovery.js rentable-production --json
 *
 *   # Include custom objects
 *   node scripts/lib/multi-object-ownership-discovery.js rentable-production --include-custom
 */
...
Examples:
  ...
  node multi-object-ownership-discovery.js rentable-production

  # Include custom objects
  node multi-object-ownership-discovery.js rentable-production --include-custom

  # JSON output
  node multi-object-ownership-discovery.js rentable-production --json

  # Save to file
  node multi-object-ownership-discovery.js rentable-production --save results.json
    `);
    process.exit(1);
  }
