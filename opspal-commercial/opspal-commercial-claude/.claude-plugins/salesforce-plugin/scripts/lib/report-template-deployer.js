 ...
 *
 * Usage:
 *   const deployer = await ReportTemplateDeployer.create('peregrine-main');
...
class ReportTemplateDeployer {
    ...
    async deployFromTemplate(templatePathOrName, options = {}) {
        ...
        const template = await this.loadTemplate(templatePathOrName);
...
Examples:
  node report-template-deployer.js --template team-performance --org peregrine-main --dry-run
