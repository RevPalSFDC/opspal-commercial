 ...
 *
 * Example:
 *   node scripts/lib/post-field-deployment-validator.js rentable-sandbox Approval_Request__c Approver__c
 *
 * Exit codes:
...
if (require.main === module) {
    ...
    if (args.length < 3) {
        ...
        console.error('\nExample:');
        console.error('  node post-field-deployment-validator.js rentable-sandbox Approval_Request__c Approver__c');
        process.exit(1);
    }
