 ...
 *
 * Examples:
 *   node flow-formula-validator.js flows/Quote_Approval.flow-meta.xml rentable-sandbox
 *   node flow-formula-validator.js flows/Quote_Approval.flow-meta.xml rentable-sandbox --auto-fix
 *
...
async function main() {
    ...
    if (args.length < 1) {
        ...
        console.log(colors.gray('  node flow-formula-validator.js flows/Quote_Approval.flow-meta.xml rentable-sandbox'));
        console.log(colors.gray('  node flow-formula-validator.js flows/Quote_Approval.flow-meta.xml rentable-sandbox --auto-fix'));
        process.exit(1);
    }
