 ...
 *   node scripts/lib/email-pattern-validator.js rentable-production
 *
 *   # Export emails only (for custom analysis)
 *   node scripts/lib/email-pattern-validator.js rentable-production --export-only
 *
 *   # Use custom pattern
 *   node scripts/lib/email-pattern-validator.js rentable-production --pattern "\.com[a-z]+"
 */
...
Examples:
  # Full validation
  node email-pattern-validator.js rentable-production

  # Export only
  node email-pattern-validator.js rentable-production --export-only

  # Custom pattern
  node email-pattern-validator.js rentable-production --pattern "\\.com[a-z]+"
    `);
    process.exit(0);
  }
