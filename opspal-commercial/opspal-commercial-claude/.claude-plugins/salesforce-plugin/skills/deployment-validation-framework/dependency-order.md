...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-dependency-analyzer.js \
...
for phase in "${phases[@]}"; do
  ...
  # Verify phase
  node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/verify-deployment-phase.js "$phase" <org>
...
```javascript
const { ManifestSplitter } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/manifest-splitter');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/verify-manifest-split.js \
  package-phase1.xml \
  package-phase2.xml \
  package-phase3.xml
```
