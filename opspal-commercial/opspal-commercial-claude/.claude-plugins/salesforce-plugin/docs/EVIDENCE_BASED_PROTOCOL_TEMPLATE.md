...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/post-deployment-state-verifier.js <org-alias> <component-type> <component-name>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/post-deployment-state-verifier.js myorg Dashboard Sales_Dashboard
