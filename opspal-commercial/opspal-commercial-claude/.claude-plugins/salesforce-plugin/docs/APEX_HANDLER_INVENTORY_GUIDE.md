...
- **Automation Audit Guide**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/AUTOMATION_AUDIT_GUIDE.md` (if exists)
- **Agent Documentation**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-automation-auditor.md`
- **Orchestrator Script**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/automation-audit-v2-orchestrator.js`
- **Detection Script**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/apex-handler-detector.js`
- **Analysis Script**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/handler-static-analyzer.js`
