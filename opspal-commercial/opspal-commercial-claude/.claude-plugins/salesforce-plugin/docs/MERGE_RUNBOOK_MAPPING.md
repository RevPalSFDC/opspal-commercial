...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-pre-merge-validator.js production Account

# Merge validation (NEW - v2.0.0)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-pre-merge-validator.js production Contact \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dedup-rollback-system.js --execution-log execution_log.json
