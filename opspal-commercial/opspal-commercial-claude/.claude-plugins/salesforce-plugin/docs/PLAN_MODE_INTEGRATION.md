...
1. Complexity scorer not working
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/auto-agent-router.js route "Deploy 15 objects"
...
1. Complexity threshold too low
   ...
   grep "0.7" .claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/user-prompt-hybrid.sh
   ```

2. Complexity scorer over-estimating
   ```bash
   # Test with simple task
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/auto-agent-router.js route "Update one field"
