...
```javascript
const { BusinessProcessCoverageTracker } = require('../../../cross-platform-plugin/scripts/lib/business-process-coverage-tracker');
...
```javascript
const { UserExpectationTracker } = require('../../../cross-platform-plugin/scripts/lib/user-expectation-tracker');
...
```javascript
const QualityGateValidator = require('../../../cross-platform-plugin/scripts/lib/quality-gate-validator');
...
```javascript
const { asanaTaskReader } = require('../../../cross-platform-plugin/scripts/lib/asana-task-reader');
...
```javascript
const formatter = require('../../../cross-platform-plugin/scripts/lib/asana-update-formatter');
const commentMgr = require('../../../cross-platform-plugin/scripts/lib/asana-comment-manager');
...
- Asana: `../cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md`
