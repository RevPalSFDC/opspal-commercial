...
`.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-progress-helper.sh`
...
progress_run_with_file "Analyzing" /tmp/progress.txt \
    node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/analyzer.js --progress /tmp/progress.txt
```
...
bash .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-progress-helper.sh
```
...
#!/bin/bash
source .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-progress-helper.sh
...
echo '{"user_message": "Deploy to production"}' | \
    bash .claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/auto-router-adapter.sh
```
...
- **Hook System Guide**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/HOOK_SYSTEM_GUIDE.md`
