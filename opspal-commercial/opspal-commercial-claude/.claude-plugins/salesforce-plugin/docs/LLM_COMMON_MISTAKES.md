...
**Existing Implementation**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-retrieval-framework.js:528-542`
...
**Existing Implementation**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-retrieval-framework.js:510-523`
...
```javascript
// .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js
...
```javascript
// .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sf-command-interceptor.js
