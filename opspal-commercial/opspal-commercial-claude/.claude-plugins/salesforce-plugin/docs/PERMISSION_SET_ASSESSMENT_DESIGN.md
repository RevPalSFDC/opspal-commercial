...
```json
{
  ...
  "migrationSteps": [
    ...
    },
    {
      ...
      "command": "node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-cli.js --input cpq-lite-migration.json --org myOrg",
...
**Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/commands/assess-permissions.md`
