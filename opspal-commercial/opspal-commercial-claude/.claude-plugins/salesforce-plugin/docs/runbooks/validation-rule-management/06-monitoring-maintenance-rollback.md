...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-monitoring.js \
  --org production \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-cleanup-tracker.js \
  --org production \
  --rule Require_Close_Date_When_Won \
  --period weekly
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-trend-analyzer.js \
  --org production \
  --rule Require_Close_Date_When_Won \
  --period 2023-2025
...
# Health score calculation
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-health-scorer.js \
