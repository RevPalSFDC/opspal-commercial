...
- Validate freshness: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/test-report-manager.js validate [report]`
- Compare with previous: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/test-report-manager.js compare [old] [new]`
