...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/territory/territory-bulk-assignment.js $ORG [type] $CSV --dry-run
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/territory/territory-bulk-assignment.js $ORG [type] $CSV
```
