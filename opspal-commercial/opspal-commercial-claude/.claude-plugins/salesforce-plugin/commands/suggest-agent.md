...
2. Run task pattern analysis: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/task-pattern-detector.js "<user task description>"`
