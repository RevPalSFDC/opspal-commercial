...
```bash
# Start new segment
/salesforce-plugin:trigger-segment-start cascade-update

# Generate code
/create-trigger --object Account --template cascade-update

# Complete segment
/salesforce-plugin:trigger-segment-complete
```
...
- `/salesforce-plugin:trigger-segment-start` - Start segmented trigger development
- `/salesforce-plugin:trigger-segment-complete` - Complete trigger segment
- `/salesforce-plugin:flow-diagnose` - Alternative to triggers (declarative)
- `/salesforce-plugin:validate-lwc` - If creating LWC with trigger

## Additional Resources

- **Templates**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/triggers/`
- **Examples**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/trigger-examples/`
