...
📊 Comparing runbooks...
   Current:  instances/rentable-sandbox/RUNBOOK.md (2025-10-20)
   Previous: instances/rentable-sandbox/RUNBOOK-backup.md (2025-10-15)
...
Current runbook: instances/rentable-sandbox/RUNBOOK.md

💡 To enable diffing:
   1. The next time you run /generate-runbook, a backup will be created
   2. Or manually copy current runbook as baseline:
      cp instances/rentable-sandbox/RUNBOOK.md \
         instances/rentable-sandbox/RUNBOOK-baseline.md
...
📊 Comparing runbooks...
   Current:  instances/rentable-sandbox/RUNBOOK.md (2025-10-20 10:30)
   Previous: instances/rentable-sandbox/RUNBOOK.md (2025-10-20 09:15)
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-differ.js --org {org}
...
# Summary only
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-differ.js --org {org} --format summary
```
