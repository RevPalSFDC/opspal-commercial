...
ENV_CONFIG_VALIDATOR="${SCRIPT_DIR}/../../cross-platform-plugin/scripts/lib/env-config-validator.js"
...
PRE_OP_ORCHESTRATOR="${SCRIPT_DIR}/../../cross-platform-plugin/scripts/lib/pre-operation-validation-orchestrator.js"
