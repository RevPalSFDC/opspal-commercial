...
|------|---------|-----------|---------|
| `user-prompt-hybrid.sh` | Salesforce-specific routing and complexity scoring | subagent-utilization-booster.sh (cross-platform-plugin) | ✅ ACTIVE |
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/install-claude-hooks.js
```

Optional flags:

```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/install-claude-hooks.js --include-tool-hooks
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/install-claude-hooks.js --force
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/install-claude-hooks.js --dry-run
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/install-claude-hooks.js --settings /path/to/settings.json
```
...
```bash
# Real-time status
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-monitor.js dashboard

# Historical analysis
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-monitor.js analyze

# Manual reset
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-monitor.js reset

# Check for alerts (CI/CD)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-monitor.js alert
```
...
**Solutions:**
1. Check hook performance: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-monitor.js analyze`
...
4. Manual reset once fixed: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-monitor.js reset`
...
A: Check dashboard: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/hook-monitor.js dashboard`. If you see state changes and metrics, it's working.
