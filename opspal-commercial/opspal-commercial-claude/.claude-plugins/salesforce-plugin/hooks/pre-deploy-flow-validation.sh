...
VALIDATOR_SCRIPT=".claude-plugins/salesforce-plugin/scripts/lib/flow-decision-logic-analyzer.js"
...
FIELD_REF_VALIDATOR=".claude-plugins/salesforce-plugin/scripts/lib/flow-field-reference-validator.js"
