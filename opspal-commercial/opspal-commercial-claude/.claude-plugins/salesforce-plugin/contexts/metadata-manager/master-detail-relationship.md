...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-propagation-waiter.js master-detail \
  Child__c \
  Children \
  myorg
...
**Programmatic Usage**:
```javascript
const MetadataPropagationWaiter = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-propagation-waiter');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-validator.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-propagation-waiter.js permission-set \
  BDU_Checkin_Access \
  myorg
```
...
- **Tool**: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-propagation-waiter.js master-detail`
...
- **Tool**: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-validator.js --file <path>`
