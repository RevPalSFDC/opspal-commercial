...
Or via GraphQL:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-api-client.js create-item \
  --board 12345 \
  --name "New Task" \
  --group topics \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-api-client.js list-subitems \
  --item <parent_item_id>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js create-items \
  --board 12345 \
  --file items.json
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js update-items \
  --board 12345 \
  --file updates.json
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js delete-items \
