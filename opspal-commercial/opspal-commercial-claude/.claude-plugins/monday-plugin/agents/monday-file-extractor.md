...
**For single item:**
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-file-extractor.js \
  --item <id> \
...
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-asset-lookup-builder.js \
