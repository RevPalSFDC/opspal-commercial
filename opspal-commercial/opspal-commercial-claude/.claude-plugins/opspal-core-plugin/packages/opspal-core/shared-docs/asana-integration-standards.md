...
**Primary Documentation**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md` (comprehensive guide)
...
**Location**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/templates/asana-updates/`
...
- **Update Templates**: Uses templates from cross-platform-plugin/templates/asana-updates/
...
- **Main Playbook**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md` - Complete integration guidelines
- **Update Templates**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/templates/asana-updates/*.md` - Template details and examples
- **Task Manager Agent**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/agents/asana-task-manager.md` - Reference implementation
