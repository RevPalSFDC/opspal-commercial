...
function resolveSalesforceLibPath() {
  const candidates = [
    path.resolve(__dirname, '../../../../..', 'domains', 'salesforce', 'scripts', 'lib'),
    path.resolve(__dirname, '../../../../../..', 'salesforce-plugin', 'scripts', 'lib'),
    path.resolve(process.cwd(), '.claude-plugins', 'opspal-core-plugin', 'packages', 'domains', 'salesforce', 'scripts', 'lib'),
    path.resolve(process.cwd(), '.claude-plugins', 'salesforce-plugin', 'scripts', 'lib')
  ];
...
function loadValidators() {
  const salesforcePluginPath = resolveSalesforceLibPath();
