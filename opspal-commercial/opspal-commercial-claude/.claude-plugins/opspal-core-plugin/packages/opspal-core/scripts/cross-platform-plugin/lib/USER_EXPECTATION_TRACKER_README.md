...
**Main Script:** `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/user-expectation-tracker.js`
**Tests:** `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/test/user-expectation-tracker.test.js`
