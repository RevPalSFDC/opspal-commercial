...
describe('TaskRouter', () => {
    ...
    describe('constructor', () => {
        it('should initialize with default options', () => {
            ...
            expect(router.agentIndex).toBeNull();
        });
    ...
    describe('findMatchingAgents', () => {
        ...
        it('should find sfdc-cpq-assessor for CPQ tasks', () => {
            ...
            const cpqMatch = matches.find(m => m.agent === 'sfdc-cpq-assessor');
        ...
        it('should find sfdc-conflict-resolver for conflict tasks', () => {
            ...
            const conflictMatch = matches.find(m => m.agent === 'sfdc-conflict-resolver');
    ...
    describe('agent coverage', () => {
        ...
        const testCases = [
            { task: 'merge duplicate accounts', expected: 'salesforce-plugin:sfdc-merge-orchestrator' },
            { task: 'analyze revops process', expected: 'salesforce-plugin:sfdc-revops-auditor' },
            { task: 'create report dashboard', expected: 'salesforce-plugin:sfdc-reports-dashboards' },
            { task: 'create flowchart diagram', expected: 'cross-platform-plugin:diagram-generator' },
            { task: 'hubspot workflow automation', expected: 'hubspot-plugin:hubspot-workflow-builder' },
