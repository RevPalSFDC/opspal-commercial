...
**Schemas** (`.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/solutions/schemas/`):
- `environment-schema.json` - Environment profile JSON schema

**Environments Directory** (`.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/solutions/environments/`):
