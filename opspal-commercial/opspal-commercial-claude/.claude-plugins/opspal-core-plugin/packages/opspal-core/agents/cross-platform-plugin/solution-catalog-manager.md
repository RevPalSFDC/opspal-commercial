...
**Catalog Manager** (`.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/solution-template-system/catalog/`):
...
### Plugin Level (Local)
```
.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/solutions/
