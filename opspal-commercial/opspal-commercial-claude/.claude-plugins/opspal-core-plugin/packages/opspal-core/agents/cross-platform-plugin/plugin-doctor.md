...
✓ cross-platform-plugin (v1.11.0) - 6 agents loaded
...
1. Agent Discovery Failure (5 occurrences)
   ...
   Location: .claude-plugins/opspal-core-plugin/packages/domains/hubspot/agents/hubspot-workflow-orchestrator.md:1-5
...
1. hubspot-workflow-orchestrator
   Location: .claude-plugins/opspal-core-plugin/packages/domains/hubspot/agents/hubspot-workflow-orchestrator.md
   Issue: Missing required field 'name' in YAML frontmatter
   Fix: Add 'name: hubspot-workflow-orchestrator' to frontmatter

2. sfdc-custom-validator (DUPLICATE NAME)
   Location 1: .claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-custom-validator.md
...
```json
{
  ...
  "recommended_actions": [
    ...
    },
    {
      ...
      "command": "jq 'del(.agents)' .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/.claude-plugin/plugin.json > tmp.json && mv tmp.json plugin.json",
...
`.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/`
...
- **User Guide**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/docs/PLUGIN_DOCTOR_GUIDE.md`
- **Developer Guide**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/docs/PLUGIN_DOCTOR_INTERNALS.md`
- **Reflection System**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/commands/reflect.md`
