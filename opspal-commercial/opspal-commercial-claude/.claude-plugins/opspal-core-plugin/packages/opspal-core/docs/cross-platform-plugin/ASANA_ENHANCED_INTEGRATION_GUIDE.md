...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-user-manager.js fetch-users
...
# Edit .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/config/asana-user-mapping.json

# Step 3: Validate configuration
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-user-manager.js validate
...
1. **Initialize configuration**:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-user-manager.js setup
   ```
...
4. **Test project creation**:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-project-creator.js detect
   node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-project-creator.js teams
   ```
...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-follower-manager.js test foundation data

# Test comment manager (requires task GID)
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-comment-manager.js templates
```
