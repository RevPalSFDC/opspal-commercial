...
**File**: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/asana-connection-manager.sh`
...
./claude-plugins/cross-platform-plugin/scripts/lib/asana-connection-manager.sh \
  update \
  "2/1206945125479946/1211748909548947:4ea720672c43ff4f79742d90a61f5afa" \
  "REDACTED_WORKSPACE_ID"

# 2. Validate connection
./claude-plugins/cross-platform-plugin/scripts/lib/asana-connection-manager.sh validate

# 3. Install protection infrastructure
./claude-plugins/cross-platform-plugin/scripts/lib/asana-connection-manager.sh protect
```
...
./claude-plugins/cross-platform-plugin/scripts/lib/asana-connection-manager.sh status

# If broken, attempt recovery
./claude-plugins/cross-platform-plugin/scripts/lib/asana-connection-manager.sh fix

# View audit log if issues
./claude-plugins/cross-platform-plugin/scripts/lib/asana-connection-manager.sh audit
```
...
./claude-plugins/cross-platform-plugin/scripts/lib/asana-connection-manager.sh audit | grep UPDATE_TOKEN
