...
### 2. File System Check
- Hook file exists: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/hooks/user-prompt-router.sh`
- Hook is executable
...
```bash
# Run setup script
.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/setup-auto-routing.sh
```
...
**Solution**:
```bash
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/routing-index-builder.js
```
...
```bash
.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/routing-health-check.sh
```
