...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/deduplication/run-dedup.js \
  --object Account \
  --mode detect \
  --org production \
...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/deduplication/export-clusters.js \
