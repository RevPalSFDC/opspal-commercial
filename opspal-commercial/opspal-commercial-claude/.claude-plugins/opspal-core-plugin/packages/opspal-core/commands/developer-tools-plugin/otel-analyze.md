...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/lib/otel-metrics-analyzer.js
...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/lib/otel-metrics-analyzer.js /path/to/metrics.json
```
...
```bash
# Daily at 9 AM
0 9 * * * cd /path/to/opspal-internal-plugins && node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/lib/otel-reflection-integrator.js >> .otel/cron.log 2>&1
```
...
**Permission errors**:
```bash
chmod +x .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/lib/otel-metrics-analyzer.js
chmod +x .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/lib/otel-reflection-integrator.js
```
