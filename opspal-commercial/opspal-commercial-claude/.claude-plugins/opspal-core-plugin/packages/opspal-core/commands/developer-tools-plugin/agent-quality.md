...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/analyze-agent-quality.js \
  .claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-metadata-manager.md
```
...
node .claude-plugins/opspal-core-plugin/packages/opspal-core/developer-tools-plugin/scripts/analyze-agent-quality.js --all
```
