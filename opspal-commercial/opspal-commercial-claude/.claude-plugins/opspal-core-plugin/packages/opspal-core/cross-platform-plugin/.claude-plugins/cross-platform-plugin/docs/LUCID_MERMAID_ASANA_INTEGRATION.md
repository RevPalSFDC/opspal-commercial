...
Located in `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/mermaid-lucid/`:
...
**Location:** `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/agents/diagram-to-lucid-asana-orchestrator.md`
...
**Location:** `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/commands/diagram-to-asana.md`
...
**Source Code:**
- Libraries: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/scripts/lib/mermaid-lucid/`
- Orchestrator: `.claude-plugins/opspal-core-plugin/packages/opspal-core/cross-platform-plugin/agents/diagram-to-lucid-asana-orchestrator.md`
