...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/gtm-motion-classifier.js analyze \
  --org <org-alias> \
  --lookback 24 \
...
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/gtm-motion-planner.js plan \
...
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/gtm-credit-validator.js \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/gtm-planning/scripts/lib/gtm-playbook-generator.js \
