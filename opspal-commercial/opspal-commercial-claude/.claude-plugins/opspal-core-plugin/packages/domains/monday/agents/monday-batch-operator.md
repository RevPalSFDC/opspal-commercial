...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js validate \
  --file data.csv \
  --board 12345
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js preview \
  --file data.csv \
  --board 12345 \
  --limit 5
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js import \
  --file data.csv \
  --board 12345 \
  --group new_group \
  --batch-size 50 \
...
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js update \
  --board 12345 \
  --filter "group=topics" \
  --set "status=Done"
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js update-file \
  --board 12345 \
  --file updates.json
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js export \
  --board 12345 \
  --format csv \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js copy \
  --source-board 12345 \
  --target-board 67890 \
  --filter "status=Done" \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js move \
  --source-board 12345 \
  --target-board 67890 \
...
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js sync \
  --source-board 12345 \
  --target-board 67890 \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js archive \
  --board 12345 \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js delete \
  --items "123,456,789" \
  --confirm
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/monday/scripts/lib/monday-batch-manager.js resume \
