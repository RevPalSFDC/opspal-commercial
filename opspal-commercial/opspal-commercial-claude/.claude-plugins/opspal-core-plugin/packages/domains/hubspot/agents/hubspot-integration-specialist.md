...
const BatchAssociationsV4 = require('..claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/batch-associations-v4');
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-integration-specialist-optimizer.js <options>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/hubspot/scripts/lib/hubspot-integration-specialist-optimizer.js --portal my-portal
```
