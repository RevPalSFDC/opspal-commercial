...
- Trigger campaign design and activation
- Batch campaign scheduling and execution
- Complex automation flow design
...
- Create trigger campaigns with proper activation
