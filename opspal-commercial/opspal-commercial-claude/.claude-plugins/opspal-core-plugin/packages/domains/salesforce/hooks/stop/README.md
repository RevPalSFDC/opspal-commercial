    ...
    "Stop": [
      {
        ...
        "hooks": [
          {
            "type": "prompt-based",
            "configPath": "${CLAUDE_PLUGIN_ROOT}/.claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/stop/quality-analysis-trigger.json"
          },
          {
            "type": "prompt-based",
            "configPath": "${CLAUDE_PLUGIN_ROOT}/.claude-plugins/opspal-core-plugin/packages/domains/salesforce/hooks/stop/release-coordination-trigger.json"
          }
        ]
      }
    ]
