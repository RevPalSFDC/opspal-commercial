...
**Need help?**
  • Review: \`.claude-plugins/opspal-core-plugin/packages/domains/salesforce/SAFETY_GUARDRAILS_COMPLETE.md\`
  • Check agent tiers: \`.claude-plugins/opspal-core-plugin/packages/domains/salesforce/config/agent-permission-matrix.json\`",
    "options": [
      {
