...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-dependency-analyzer.js <orgAlias> <objectName> <fieldName>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-xml-validator.js <flow-file.xml>
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-xml-validator.js <flow-file.xml> --fix  # Auto-fix common errors
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/csv-parser-safe.js <file.csv> --schema schema.json --strict
```
...
|-----------|-------------|---------|
| Dependency Analyzer | Before field deletion | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-dependency-analyzer.js <org> <object> <field>` |
| Flow Validator | Before Flow deployment | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-xml-validator.js <flow.xml>` |
| CSV Parser | Before data import | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/csv-parser-safe.js <file.csv>` |
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js <org-alias> <assignment-rule-xml>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js <org> <rule.xml>

# Step 2: Conflict detection
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-overlap-detector.js <org> <rule.xml>

# Step 3: Assignee validation
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignee-validator.js <org> <rule.xml>

# Step 4: Access validation
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignee-access-validator.js <org> <rule.xml>
...
```bash
$ node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js production lead-assignment-rule.xml
...
if [ -d "force-app/main/default/assignmentRules" ]; then
    ...
    for rule_file in force-app/main/default/assignmentRules/*.assignmentRules-meta.xml; do
        node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js "$TARGET_ORG" "$rule_file"
...
| Validator | When to Use | Command |
|-----------|-------------|---------|
| Assignment Rule Validator | Before Assignment Rule deployment | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js <org> <rule.xml>` |
| Overlap Detector | Detect rule conflicts | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-overlap-detector.js <org> <rule.xml>` |
| Assignee Validator | Validate User/Queue/Role | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignee-validator.js <org> <rule.xml>` |
| Access Validator | Check assignee permissions | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignee-access-validator.js <org> <rule.xml>` |
...
- **Skill Document**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/skills/assignment-rules-framework/SKILL.md`
- **Conflict Rules**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/skills/assignment-rules-framework/conflict-detection-rules.md`
- **Templates**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/skills/assignment-rules-framework/template-library.json`
- **CLI Reference**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/skills/assignment-rules-framework/cli-command-reference.md`
...
if (validation.flows && validation.flows.length > 0) {
    const FlowBestPracticesValidator = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-best-practices-validator');
...
if ! node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-dependency-enforcer.js validate package.xml myorg \
    --context deployment-context.json \
    --verbose; then
...
- **CLI Help**: `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-dependency-enforcer.js --help`
...
if grep -q "<types><name>CustomField</name>" package.xml; then
    ...
    if ! detect_fls_bundling package.xml; then
        ...
        echo "   Use: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/fls-aware-field-deployer.js"
...
route_field_deployment() {
    ...
    if contains_custom_fields "$manifest"; then
        ...
        extract_field_metadata "$manifest" | \
          node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/fls-aware-field-deployer.js --from-manifest --org "$org"
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> | jq '.objects, .fields'
...
Before any deployment
  ↓
1. Run: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js init <target-org>
...
2. Validate: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js <org> "<soql>"
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/deploy-validator.sh --comprehensive-check \
  --manifest [package.xml] \
  --target-org [org-alias] \
  --capture-baseline

# STEP 2: Validate deployment readiness
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/preflight-validator.js validate deployment \
  --manifest [package.xml] \
  --org [org-alias] \
  --check-dependencies \
  --verify-coverage
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/deploy-tracker.js capture-validation-id \
  --org [org-alias] \
...
1. **Deployment Planning with Auto-Validation**
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/deployment-planner.js create-plan \
     --manifest [package.xml] \
...
3. **Sandbox Strategy with Auto-Management**
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sandbox-manager.js lifecycle-management \
...
validate_deployment() {
    ...
    if ! node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/preflight-validator.js validate deployment \
        --manifest "$manifest" \
        --org "$target_org" \
    ...
    if ! node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dependency-analyzer.js analyze \
        --manifest "$manifest" \
    ...
    if ! node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/conflict-detector.js scan \
        --manifest "$manifest" \
        --target-org "$target_org" \
...
deploy_with_monitoring() {
    ...
    # Start monitoring
    node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/deployment-monitor.js start \
        --org "$target_org" \
        --manifest "$manifest" &
    local monitor_pid=$!
...
auto_resolve_deployment_error() {
    ...
    case "$error_type" in
        "MISSING_DEPENDENCIES")
            ...
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dependency-resolver.js resolve \
                --manifest "$manifest" \
                --target-org "$target_org" \
                --auto-add
            ;;
        ...
        "COMPONENT_CONFLICTS")
            ...
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/conflict-resolver.js resolve \
                --manifest "$manifest" \
                --target-org "$target_org" \
                --strategy merge
            ;;
        "VALIDATION_RULE_FAILURES")
            ...
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-handler.js resolve \
                --manifest "$manifest" \
                --target-org "$target_org" \
                --temporary-disable
            ;;
...
assess_deployment_risk() {
    ...
    local risk_score
    risk_score=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/risk-assessor.js calculate \
        --manifest "$manifest" \
        --target-org "$target_org" \
        --historical-data \
        --complexity-analysis \
...
**Reference**: `../../../opspal-core/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md`
...
Use **milestone-update template** from `../../../opspal-core/cross-platform-plugin/templates/asana-updates/milestone-update.md`
...
- **Playbook**: `../../../opspal-core/cross-platform-plugin/docs/ASANA_AGENT_PLAYBOOK.md`
- **Templates**: `../../../opspal-core/cross-platform-plugin/templates/asana-updates/*.md`
