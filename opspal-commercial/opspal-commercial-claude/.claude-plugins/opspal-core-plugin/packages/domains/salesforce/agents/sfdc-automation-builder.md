...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/automation-feasibility-analyzer.js <orgAlias> \
...
```javascript
const { AutomationFeasibilityAnalyzer } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/automation-feasibility-analyzer');
...
**File**: `../../../opspal-core/cross-platform-plugin/scripts/lib/capability-assessment-protocol.js`
...
node ../../../opspal-core/cross-platform-plugin/scripts/lib/capability-assessment-protocol.js <org> assess \
...
```javascript
const CapabilityAssessmentProtocol = require('../../../opspal-core/cross-platform-plugin/scripts/lib/capability-assessment-protocol.js');
...
```javascript
const FlowBatchManager = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-batch-manager');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js MyFlow.xml --best-practices --verbose
```
...
/flow-diagnose Account_Validation_Flow neonone --type coverage \
  --object Account \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-version-manager.js getActiveVersion <flow-name> <org>

# 3. Validate API version compatibility (NEW - v3.41.0)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-api-version-validator.js validate <flow-path>

# 4. Validate field references (NEW - v3.41.0)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-field-reference-validator.js validate <flow-path> <org>

# 5. Validate design against best practices
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-best-practices-validator.js <flow-path> --verbose
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-metadata-operations.js deployFlowSafe Quote_Status_Update \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-metadata-operations.js deployFlowSafe MyFlow ./path myorg
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field sample-org-production Opportunity Stage

# Get complete object metadata for flow design
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> Opportunity
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> | jq '.flows'

# Validate field availability for flow criteria
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js <org> "SELECT Id FROM Flow WHERE TriggerType = 'RecordAfterSave'"
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js --analyze --object [Object] --type [TriggerType]

# STEP 2: Check consolidation opportunities
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/utilities/flow-audit.js --object [Object] --consolidation-check

# STEP 3: Validate against best practices
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js --check-patterns --complexity-threshold 7

# STEP 4: Pre-deployment validation (if creating)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/preflight-validator.js validate flow --metadata-file [flow-file]
```
...
```bash
CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type automation_build --format json)
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-architecture-validator.js \
  --object [Object] \
...
### 1. **Flow Design Principles - MANDATORY CONSOLIDATION WITH AUTO-VALIDATION**
   ...
   **CRITICAL**: Follow the "One Flow Per Object Per Trigger Type" rule with automated enforcement
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js --pre-check \
     --object [Object] \
     --trigger-type [TriggerType] \
...
3. **Debugging and Testing with Auto-Recovery**
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/error-recovery.js --flow-debug \
     --flow-name [FlowName] \
     --capture-context
   ```
...
1. **AUTOMATED PRE-CHECK**:
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js --comprehensive-check \
     --object [Object] \
     --trigger-type [TriggerType] \
     --auto-fix --verbose
   ```
...
3. **Enhanced Flow Logic with Auto-Patterns**:
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-pattern-generator.js \
...
4. **Continuous Validation During Development**:
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js --watch --file [flow-file] \
     --auto-suggest-fixes
   ```
...
5. **Pre-Deployment Validation**:
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/deploy-validator.sh --flow [flow-name] \
...
6. **Post-Deployment Monitoring**:
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/flow-health-monitor.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/error-recovery.js --pattern flow-deployment-error \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/error-recovery.js --auto-diagnose \
  --flow-name [FlowName] \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/predictive-flow-monitor.js \
  --monitor-all-flows \
  --predict-failures \
  --auto-alert
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-documenter.js \
  --flow [FlowName] \
  --generate-diagrams \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/deploy-orchestrator.js \
  --flow [FlowName] \
  --env sandbox \
  --validate-first \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/automation-health-dashboard.js \
