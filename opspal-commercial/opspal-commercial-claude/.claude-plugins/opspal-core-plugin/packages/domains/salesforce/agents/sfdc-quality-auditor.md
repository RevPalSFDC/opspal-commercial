...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type quality_audit --format json)`
...
```bash
# Daily health check
0 2 * * * node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js health-check

# Weekly deep audit
0 3 * * 0 node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js deep-audit

# Monthly compliance check
0 4 1 * * node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js compliance-check
```
...
```bash
# Full quality audit
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js audit --full

# Quick health check
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js health-check

# Specific object audit
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js audit --object Opportunity
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js audit --no-diagrams

# Generate specific diagrams only
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/quality-auditor.js audit --diagrams=drift,validation
```
