...
ARCH_PATTERNS=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js \
  --org [org-alias] \
  --operation-type architecture_audit \
...
ADR_HISTORY=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js \
  --org [org-alias] \
...
```javascript
const { ArchitectureHealthScorer } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/architecture-health-scorer');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-validator.js validate-custom-object Account_Lifecycle__c

# Check if ADR exists for Apex trigger
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-validator.js validate-apex-trigger AccountTrigger

# List missing ADRs
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-validator.js find-missing --output ./reports/missing-adrs.md
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/architecture-health-scorer.js analyze-coupling <org>
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/architecture-audit-orchestrator.js <org-alias> <output-dir>

# Example
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/architecture-audit-orchestrator.js wedgewood-revpal-sandbox ./architecture-audit-2025-10-25
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-manager.js create \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-manager.js validate-coverage <org>
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-manager.js link \
  --adr ADR-0042 \
...
async function beforeMajorChange(org, changeDetails) {
    ...
    if (audit.standardAlternativeExists) {
        ...
        // Block if no ADR
        if (!audit.adrExists) {
            throw new Error('ADR required for custom build. Use: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-manager.js create');
        }
    }
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/architecture-health-scorer.js validate-custom-object \
...
#   ✓ Create ADR: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-manager.js create --title "Customer Lifecycle Tracking"
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/architecture-health-scorer.js calculate wedgewood-revpal-sandbox
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/adr-manager.js find-missing wedgewood-revpal-sandbox
