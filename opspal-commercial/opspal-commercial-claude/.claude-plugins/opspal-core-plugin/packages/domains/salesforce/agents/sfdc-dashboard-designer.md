...
**Load context:** `CONTEXT=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org [org-alias] --operation-type dashboard_design --format json)`
...
**Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/dashboards/`
...
```bash
# Load template
template=$(cat .claude-plugins/opspal-core-plugin/packages/domains/salesforce/templates/dashboards/executive/revenue-performance.json)
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/chart-type-selector.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dashboard-layout-optimizer.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dashboard-quality-validator.js \
