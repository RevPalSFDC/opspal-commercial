...
node -e "
const ValidationRuleSegmentManager = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-segment-manager');
(async () => {
...
```javascript
const ValidationRuleSegmentTemplates = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validation-rule-segment-templates');
