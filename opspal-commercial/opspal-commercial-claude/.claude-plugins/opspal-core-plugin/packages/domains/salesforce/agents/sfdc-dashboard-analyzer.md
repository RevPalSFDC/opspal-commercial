...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dashboard-quality-validator.js --dashboard [dashboard-metadata.json]
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/report-quality-validator.js --report [report-metadata.json]
...
```bash
# Analyze a dashboard
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/sfdc-dashboard-analyzer.js \
