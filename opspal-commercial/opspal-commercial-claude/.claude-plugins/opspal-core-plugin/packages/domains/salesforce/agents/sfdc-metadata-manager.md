...
```javascript
const MetadataDependencyAnalyzer = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-dependency-analyzer');
...
|------------------|---------|-------------|
| **Single Field** | `node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-dependency-analyzer.js --org <org> --object <obj> --field <field>` | Before deleting any field |
...
```javascript
const FlowXMLValidator = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-xml-validator');
const MetadataDependencyAnalyzer = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-dependency-analyzer');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> <object> | jq '.validationRules'
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> <object> <field>
...
1. **Creating Centralized Permission Sets** (not just FLS):
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-cli.js --input cpq-permissions.json --org myOrg
   ```

2. **Discovering Fragmented Permission Sets**:
   ```bash
   # Scan org for fragmented permission sets across initiatives
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-discovery.js --org myOrg
...
3. **Consolidating Multiple Permission Sets**:
   ...
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-analyzer.js --org myOrg --initiative CPQ
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-migration-planner.js --org myOrg --initiative CPQ
   ```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-generator.js \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/queryability-checker.js \
  --org [org-alias] \
  --manifest deployment-manifest.json
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-validator.js validate-design \
  --metadata-type [type] \
  --object-name [object] \
  --field-name [field] \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-conflict-detector.js scan \
  --metadata-file [metadata-file] \
  --target-org [org-alias] \
  --auto-resolve

# STEP 3: Validate metadata integrity and consistency
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-integrity-validator.js validate \
  --metadata-package [package.xml] \
  --comprehensive-check \
  --org [org-alias]

# STEP 4: Pre-flight deployment validation
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/preflight-validator.js validate metadata \
...
const DependencyAnalyzer = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/sfdc-dependency-analyzer');
const analyzer = new DependencyAnalyzer(org);
const dependencies = await analyzer.analyzeCompleteDependencies(object);

// Step 2: Check for conflicts
const ConflictDetector = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/conflict-detector');
...
const OperationDependencyGraph = require('..claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/operation-dependency-graph');
...
generate_validated_metadata_package() {
    ...
    node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validated-package-generator.js generate \
        --object "${object_name}" \
        --field "${field_name}" \
    ...
    node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-package-validator.js validate \
...
monitor_metadata_health() {
    ...
    while true; do
        ...
        metadata_health=$(node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/monitoring/metadata-health-monitor.js \
...
auto_resolve_metadata_error_with_validation() {
    ...
    case "$error_type" in
        "METADATA_VALIDATION_FAILURE")
            ...
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/metadata-validation-recovery.js resolve \
        ...
        "FIELD_ACCESSIBILITY_ERROR")
            ...
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/field-accessibility-recovery.js resolve \
        ...
        "METADATA_CACHE_INCONSISTENCY")
            ...
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/cache-consistency-recovery.js resolve \
                --metadata-context "$metadata_context" \
                --validation-context "$validation_context" \
                --auto-realign
            ;;
        "PERMISSION_PROPAGATION_FAILURE")
            ...
            node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-propagation-recovery.js resolve \
                --metadata-context "$metadata_context" \
