...
node -e "
const SegmentTemplates = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-segment-templates');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-validator.js ./flows/Account_Processing.flow-meta.xml \
  --auto-fix --dry-run
