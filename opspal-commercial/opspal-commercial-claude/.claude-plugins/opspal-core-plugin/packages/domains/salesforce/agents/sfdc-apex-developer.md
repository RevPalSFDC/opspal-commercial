...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js myorg "SELECT Id, CustomField__c FROM Account"
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js find-field production-org Account Status

# Get complete object metadata for Apex class design
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/org-metadata-cache.js query <org> Account
```
...
3. Validate SOQL: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/smart-query-validator.js <org> "<soql>"
