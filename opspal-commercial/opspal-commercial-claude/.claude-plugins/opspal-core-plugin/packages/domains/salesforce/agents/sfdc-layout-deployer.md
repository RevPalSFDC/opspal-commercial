...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> validate <source-path>

# Dry-run deployment
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> deploy <source-path> --dry-run

# Full deployment
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> deploy <source-path>
...
# Create backup
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> backup Account

# Rollback
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> rollback <backup-path>

# Verify deployment
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> verify Account
...
4. **Verify Rollback**
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> verify <object-name>
   ```
...
3. Use sfdc-layout-deployer to:
   a. Validate: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> validate ./output
   b. Backup: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> backup <object>
   c. Deploy: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> deploy ./output
   d. Verify: node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/layout-deployer.js <org> verify <object>
```
