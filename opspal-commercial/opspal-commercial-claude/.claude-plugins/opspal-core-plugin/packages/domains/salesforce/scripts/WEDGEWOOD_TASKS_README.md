...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/create-sample-org-tasks.js
```

### Option 2: Using Bash Wrapper
```bash
cd ${PROJECT_ROOT:-/path/to/project}/legacy/SFDC
bash .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/run-sample-org-tasks.sh
```
...
- `${PROJECT_ROOT:-/path/to/project}/legacy/SFDC/scripts/WEDGEWOOD_TASKS_README.md` - This documentation
