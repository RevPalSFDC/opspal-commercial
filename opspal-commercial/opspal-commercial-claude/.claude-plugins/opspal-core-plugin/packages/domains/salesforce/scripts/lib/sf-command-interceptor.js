            ...
            if (NON_EXISTENT_OBJECTS[objectName]) {
                ...
                result.errors.push({
                    ...
                    guidance: [
                        ...
                        `   ${objInfo.example}`,
                        ``,
                        `📚 Documentation: .claude-plugins/opspal-core-plugin/packages/domains/salesforce/${objInfo.docs}`
                    ]
                });
            }
        }
        ...
        result.errors.forEach(error => {
            switch (error.type) {
                case 'INVALID_FIELD':
                    ...
                    guidance.push(`   📖 Docs: .claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/SALESFORCE_TOOLING_API_FLOW_OBJECTS.md`);
                ...
                case 'MALFORMED_QUERY':
                    ...
                    guidance.push(`   📖 Docs: .claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/SOQL_BEST_PRACTICES.md`);
                    break;
