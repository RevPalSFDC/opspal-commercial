 ...
 *   node scripts/lib/flow-activation-validator.js rentable-sandbox force-app/main/default/flows
 *
 * Exit codes:
...
if (require.main === module) {
    ...
    if (args.length < 2) {
        ...
        console.error('Example: node flow-activation-validator.js rentable-sandbox force-app/main/default/flows');
        process.exit(2);
    }
