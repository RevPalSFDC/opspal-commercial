...
if (require.main === module) {
    (async () => {
        ...
        if (args.length < 2) {
            ...
            console.log('  standard-queries.js wedgewood-production converted-leads-today');
            console.log('  standard-queries.js wedgewood-production active-validation-rules Contact');
            process.exit(1);
        }
