...
DOCUMENTATION:
  User Guide:      .claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/PERMISSION_SET_USER_GUIDE.md
  Developer Guide: .claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/PERMISSION_SET_DEVELOPER_GUIDE.md
  Migration Guide: .claude-plugins/opspal-core-plugin/packages/domains/salesforce/docs/PERMISSION_SET_MIGRATION_GUIDE.md
