...
**File**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-sales-operations.md`
...
**File**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-automation-auditor.md`
...
**File**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/agents/sfdc-deployment-manager.md`
...
**Skill Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/skills/assignment-rules-framework/`
...
**Script Location**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/`
