 ...
 *
 * Examples:
 *   node scripts/lib/post-deployment-state-verifier.js rentable-sandbox Profile Admin
 *   node scripts/lib/post-deployment-state-verifier.js rentable-sandbox CustomTab Approval_Rule__c force-app/main/default/tabs/Approval_Rule__c.tab-meta.xml
 *   node scripts/lib/post-deployment-state-verifier.js rentable-sandbox PermissionSet Advanced_Approvals_Tab_Access
 *
 * Exit Codes:
...
Examples:
  node post-deployment-state-verifier.js rentable-sandbox Profile Admin
  node post-deployment-state-verifier.js rentable-sandbox CustomTab Approval_Rule__c
  node post-deployment-state-verifier.js rentable-sandbox PermissionSet Advanced_Approvals_Tab_Access force-app/main/default/permissionsets/Advanced_Approvals_Tab_Access.permissionset-meta.xml
    `);
    process.exit(2);
  }
