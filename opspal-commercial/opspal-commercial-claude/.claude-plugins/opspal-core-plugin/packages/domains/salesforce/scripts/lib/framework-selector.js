 ...
 *   node scripts/lib/framework-selector.js last-used hivemq --type revops
 *   node scripts/lib/framework-selector.js lock sfdc-revops-auditor@2.0 --project ./path/
 *   node scripts/lib/framework-selector.js recommend hivemq --type cpq
 *
...
function main() {
  ...
  if (args.length === 0) {
    ...
    console.error('  node framework-selector.js last-used hivemq --type revops');
    console.error('  node framework-selector.js lock sfdc-revops-auditor@2.0 --project ./assessment/');
    console.error('  node framework-selector.js recommend hivemq --type cpq');
    process.exit(1);
  }
