...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/territory/territory-pre-validator.js $ORG create \
  --model-id=$MODEL_ID \
  --parent-id=$PARENT_ID \
  --type-id=$TYPE_ID \
...
If CSV provided:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/territory/territory-bulk-assignment.js $ORG user $CSV --dry-run
```
...
If CSV provided:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/territory/territory-bulk-assignment.js $ORG account $CSV --dry-run
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/territory/territory-safe-delete.js $ORG territory $TERRITORY_ID --dry-run
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/territory/territory-model-lifecycle.js $ORG validate $MODEL_ID
```
