...
/flow-segment-start ./flows/Account_Processing.flow-meta.xml Input_Validation --org neonone

# Explicit type with template guidance
/flow-segment-start ./flows/Account_Processing.flow-meta.xml Validation --type validation --template-guidance --org neonone
```
