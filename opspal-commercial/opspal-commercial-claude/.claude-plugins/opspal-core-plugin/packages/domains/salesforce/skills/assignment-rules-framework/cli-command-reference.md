...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-parser.js \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignee-validator.js validate-user \
  --user-id "005..." \
  --org <org-alias>
```
...
**Validate queue:**
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignee-validator.js validate-queue \
  --queue-id "00G..." \
  --org <org-alias>
```
...
**Validate role:**
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignee-validator.js validate-role \
  --role-id "00E..." \
  --org <org-alias>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-overlap-detector.js detect-circular \
  --rule-file rule-design.json \
  --queues queues.json \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-overlap-detector.js report \
  --rule-file rule-design.json \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/criteria-evaluator.js \
  Lead.assignmentRules-meta.xml \
  sample-leads.json
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js validate-entry \
  --rule-file rule-design.json \
  --entry 1 \
  --org <org-alias>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignee-access-validator.js check-user-access \
  --user-id "005..." \
  --object Lead \
  --org <org-alias>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignee-access-validator.js check-queue-access \
  --queue-id "00G..." \
  --object Lead \
  --org <org-alias>
```
...
**Deactivate rule:**
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js deactivate \
  --rule-name "Lead_Assignment_Healthcare_CA" \
  --object Lead \
  --org <org-alias>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js backup \
  --object Lead \
  --org <org-alias> \
...
**Restore from backup:**
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js restore \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js apply-template \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js delete \
  --rule-id "01Q..." \
  --org <org-alias>
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-overlap-detector.js analyze \
  --rule-file rule-design.json \
  --complexity
```
...
# 4. Validate design
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validators/assignment-rule-validator.js validate --rule-file rule-design.json --org <org>
...
# 9. Activate
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/assignment-rule-deployer.js activate --rule-name "..." --object Lead --org prod-alias
```
