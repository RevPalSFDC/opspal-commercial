...
```bash
# Run validation
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/data-quality-checkpoint.js check result.json
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/time-series-pattern-detector.js detect time-series.json
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/soql-pattern-validator.js validate "<soql>"
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/time-series-pattern-detector.js detect data.json
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/dual-system-analyzer.js compare system-a.json system-b.json
```
