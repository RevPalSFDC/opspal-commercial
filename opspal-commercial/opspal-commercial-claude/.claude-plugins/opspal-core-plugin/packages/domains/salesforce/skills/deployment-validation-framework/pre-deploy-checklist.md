...
for flow in force-app/main/default/flows/*.flow-meta.xml; do
  node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-xml-validator.js "$flow"
done

# Auto-fix common errors
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-xml-validator.js <flow-file.xml> --fix
```
...
for flow in force-app/main/default/flows/*.flow-meta.xml; do
    node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/flow-best-practices-validator.js "$flow"
    if [ $? -ne 0 ]; then
