...
```bash
$ time node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org rentable-sandbox
...
```bash
$ node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/runbook-context-extractor.js --org new-org
{
  "exists": false,
  "metadata": {},
  "knownExceptions": [],
