...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-cli.js [OPTIONS]
```
...
```bash
# Step 1: Discovery
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-discovery.js \
  --org myOrg \
  --output instances/myOrg/permission-assessment/discovery.json

# Step 2: Analysis (focus on specific initiative)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-analyzer.js \
  --org myOrg \
  --initiative "CPQ" \
  --output instances/myOrg/permission-assessment/analysis-cpq.json

# Step 3: Planning
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-migration-planner.js \
  --org myOrg \
  --initiative "CPQ" \
  --output instances/myOrg/permission-assessment/migration-plan-cpq.json

# Step 4: Generate Reports
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-report-generator.js all \
  discovery.json \
  analysis-cpq.json \
...
```bash
# Discovery report
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-report-generator.js discovery \
  discovery.json \
  DISCOVERY_REPORT.md

# Analysis report
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-report-generator.js analysis \
  analysis-cpq.json \
  CPQ_ANALYSIS.md

# Migration plan report
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-report-generator.js migration \
  migration-plan-cpq.json \
...
# Verify
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/validate-permission-migration.js --rollback
```
...
2. Analyze manually:
   ```bash
   node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-analyzer.js --org myOrg --initiative "Exact Name"
   ```
