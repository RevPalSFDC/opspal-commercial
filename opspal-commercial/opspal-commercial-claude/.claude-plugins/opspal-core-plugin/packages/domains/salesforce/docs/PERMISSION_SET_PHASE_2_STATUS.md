...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-discovery.js --org myOrg --initiative CPQ

# Save detailed report
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-discovery.js --org myOrg --output discovery-report.json
```
