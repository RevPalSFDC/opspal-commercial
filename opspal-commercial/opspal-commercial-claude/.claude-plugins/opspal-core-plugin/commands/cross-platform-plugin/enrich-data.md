...
node .claude-plugins/cross-platform-plugin/scripts/lib/enrichment/run-enrichment.js \
  --object Account \
...
node .claude-plugins/cross-platform-plugin/scripts/lib/enrichment/status.js
```
