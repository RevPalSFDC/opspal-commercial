...
✓ Copied to: .claude-plugins/cross-platform-plugin/solutions/installed/lead-management/
...
Target: .claude-plugins/cross-platform-plugin/solutions/installed/lead-management
...
```
.claude-plugins/cross-platform-plugin/solutions/installed/<solution-name>/
```
