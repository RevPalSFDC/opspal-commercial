...
function printUsage() {
  ...
  console.log('  # Synthesize runbook content for rentable-sandbox');
  console.log('  node runbook-synthesizer.js --org rentable-sandbox');
  console.log('');
  console.log('  # With reflection data and save output');
  console.log('  node runbook-synthesizer.js --org peregrine-main \\');
  console.log('    --reflection-sections instances/peregrine-main/reflection-sections.json \\');
  console.log('    --output instances/peregrine-main/synthesis.json');
}
