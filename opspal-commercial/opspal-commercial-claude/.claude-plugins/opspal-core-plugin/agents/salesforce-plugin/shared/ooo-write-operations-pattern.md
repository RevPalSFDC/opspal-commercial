...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-write-operations.js introspect Account myorg
...
- **Implementation**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/ooo-write-operations.js`
- **Bulk API Handler**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/bulk-api-handler.js`
- **Safe Query Builder**: `.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/safe-query-builder.js`
