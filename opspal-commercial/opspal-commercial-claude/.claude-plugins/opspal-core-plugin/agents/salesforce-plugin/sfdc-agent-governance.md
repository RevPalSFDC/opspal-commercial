...
```javascript
const { AgentRiskScorer } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-risk-scorer');
const { HumanInTheLoopController } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/human-in-the-loop-controller');
const { AgentActionAuditLogger } = require('.claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger');
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/human-in-the-loop-controller.js request approval-request.json

# Check approval status
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/human-in-the-loop-controller.js check AR-2025-10-25-001
...
```bash
# Log an action
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js log action.json
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js report gdpr --start-date 2025-01-01
```
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js report gdpr \
...
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js report sox \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/permission-set-rollback.js production AgentAccess Account.CustomField__c

# 3. Log rollback action
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-action-audit-logger.js log rollback-action.json
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-governance.js check-permissions sfdc-security-admin

# List all agents by tier
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-governance.js list-by-tier 4

# Validate agent configuration
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-governance.js validate-agent sfdc-metadata-manager
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-governance.js activity-summary \
  --agent sfdc-data-operations \
  --period last-30-days

# Identify high-risk patterns
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-governance.js risk-patterns \
  --threshold 60 \
  --period last-7-days

# Generate agent behavior report
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/agent-governance.js behavior-report \
  --agent sfdc-security-admin \
...
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/human-in-the-loop-controller.js check <request-id>

# List all pending
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/human-in-the-loop-controller.js list

# Force timeout if needed (rare)
node .claude-plugins/opspal-core-plugin/packages/domains/salesforce/scripts/lib/human-in-the-loop-controller.js timeout <request-id>
```
