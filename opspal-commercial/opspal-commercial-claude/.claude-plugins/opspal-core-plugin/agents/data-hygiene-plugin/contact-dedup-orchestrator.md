...
**Command**:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-snapshot.js <config>
```
...
**Command**:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-clustering.js <snapshot-file> \
  --min-confidence 70 \
  --max-cluster-size 10
```
...
**Command**:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-canonical-selector.js \
  <bundles-file> [config]
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-executor.js \
...
**Command**:
```bash
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-guardrails.js <config>
```
...
```bash
# Check ledger status
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-ledger.js summary <prefix>
...
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-rollback.js list

# Restore from snapshot
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-dedup-rollback.js restore <snapshot-id>
```
...
node .claude-plugins/opspal-core-plugin/packages/domains/data-hygiene/scripts/lib/contact-company-validator.js <config>
```
