...
```bash
# Check prerequisites
node .claude-plugins/opspal-core-plugin/packages/domains/ai-consult/scripts/lib/gemini-cli-invoker.js --check
```
...
```bash
# Simple prompt
node .claude-plugins/opspal-core-plugin/packages/domains/ai-consult/scripts/lib/gemini-cli-invoker.js --prompt "Your question here"

# With file context
node .claude-plugins/opspal-core-plugin/packages/domains/ai-consult/scripts/lib/gemini-cli-invoker.js \
...
```javascript
// From another agent
await Task.invoke('gemini-consult', {
...
node .claude-plugins/opspal-core-plugin/packages/domains/ai-consult/scripts/lib/consultation-trigger.js \
...
To consult Gemini:
  Task(subagent_type='gemini-consult', prompt='<your question>')
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
