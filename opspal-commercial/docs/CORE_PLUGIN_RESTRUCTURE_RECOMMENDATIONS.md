...
- **Shared library duplicates**: `data-access-error.js` exists (verbatim) in:
  - `.claude-plugins/opspal-core/scripts/lib/data-access-error.js`
  - `.claude-plugins/opspal-hubspot/scripts/lib/data-access-error.js`
  - `.claude-plugins/opspal-salesforce/scripts/lib/data-access-error.js`
- **Shared workflow utilities duplicated** (not exhaustive):
  - reflection/query/init/dependency-check patterns present across `.claude-plugins/opspal-hubspot/scripts/lib/*` and `.claude-plugins/opspal-salesforce/scripts/lib/*`
...
There is an installable HubSpot plugin under `.claude-plugins/opspal-hubspot`, and also a top-level `/home/chris/Desktop/RevPal/Agents/opspal-internal-plugins/opspal-hubspot` directory. That increases confusion about the canonical source-of-truth.
...
- `.claude-plugins/` (generated installable bundles)
  ...
  - `.claude-plugins/opspal-marketo/`
  - `.claude-plugins/opspal-monday/`
  - `.claude-plugins/opspal-data-hygiene/`
  - `.claude-plugins/opspal-gtm-planning/`
  - `.claude-plugins/opspal-ai-consult/`
  - `.claude-plugins/opspal-core/` (or renamed later)
...
### 6.7 Cross-Platform utilities (`opspal-core`)
