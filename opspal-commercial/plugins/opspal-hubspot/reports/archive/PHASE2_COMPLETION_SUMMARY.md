...
**Location**: `.claude-plugins/opspal-hubspot/scripts/lib/seo-serp-analyzer.js`
...
**Location**: `.claude-plugins/opspal-hubspot/scripts/lib/seo-keyword-researcher.js`
...
**Location**: `.claude-plugins/opspal-hubspot/agents/hubspot-seo-competitor-analyzer.md`
...
**Location**: `.claude-plugins/opspal-hubspot/scripts/lib/seo-content-gap-analyzer.js`
...
**Location**: `.claude-plugins/opspal-hubspot/commands/seo-audit.md`
...
**Location**: `.claude-plugins/opspal-hubspot/commands/analyze-competitor.md`
