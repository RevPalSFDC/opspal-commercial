...
/**
 * Unit Tests for HubSpot pre-task-agent-validator.sh
 *
...
const HOOK_PATH = path.join(
  PROJECT_ROOT,
  'plugins/opspal-hubspot/hooks/pre-task-agent-validator.sh'
);
...
async function runAllTests() {
  console.log('\n[Tests] HubSpot pre-task-agent-validator.sh Tests\n');
  ...
  results.push(await runTest('Skips when no task description provided', async () => {
