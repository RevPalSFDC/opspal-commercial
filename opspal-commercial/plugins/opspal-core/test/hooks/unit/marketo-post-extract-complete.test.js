...
/**
 * Unit Tests for Marketo post-extract-complete.sh
 *
...
const HOOK_PATH = path.join(
  PROJECT_ROOT,
  'plugins/opspal-marketo/hooks/post-extract-complete.sh'
);
...
async function runAllTests() {
  console.log('\n[Tests] Marketo post-extract-complete.sh Tests\n');
  ...
  results.push(await runTest('Skips when export not completed', async () => {
