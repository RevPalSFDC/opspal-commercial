...
- `runbooks/playwright/cross-platform-automation-governance.md` (snapshot-first + verify loop)
- `runbooks/auth/auth-governance-standard.md` (manual intervention and session policy rules)
