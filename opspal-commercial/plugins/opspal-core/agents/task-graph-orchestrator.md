...
await Promise.all([
  Task(subagent_type='opspal-salesforce:sfdc-apex-developer', prompt=taskSpec_T01),
  Task(subagent_type='opspal-salesforce:sfdc-planner', prompt=taskSpec_T02)
]);

// T-03 waits for both
await Task(subagent_type='opspal-salesforce:sfdc-apex-developer', prompt=taskSpec_T03);
```
...
|--------|-------|-------------|
| salesforce-flow | opspal-salesforce:flow-segmentation-specialist | Flow XML modifications |
| salesforce-apex | opspal-salesforce:sfdc-apex-developer | Apex code development |
| salesforce-metadata | opspal-salesforce:sfdc-metadata-manager | Metadata operations |
| salesforce-data | opspal-salesforce:sfdc-data-operations | Data import/export |
| salesforce-permission | opspal-salesforce:sfdc-permission-orchestrator | Permission management |
| salesforce-deploy | opspal-salesforce:sfdc-deployment-manager | Deployments |
| salesforce-discovery | opspal-salesforce:sfdc-state-discovery | Org analysis |
