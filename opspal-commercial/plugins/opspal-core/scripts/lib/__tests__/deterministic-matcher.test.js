...
describe('DeterministicMatcher', () => {
  ...
  describe('extractAndNormalizeKey', () => {
    ...
    it('should extract phone from record', () => {
      ...
      // Phone normalization adds country code which varies by environment
      const result = matcher.extractAndNormalizeKey(record, 'phone');
      expect(result).toMatch(/^\+\d+5551234567$/);
    });
