...
```bash
node .claude-plugins/opspal-core/scripts/lib/google-drive-auth-helper.js authenticate
```
...
```bash
node .claude-plugins/opspal-core/scripts/lib/google-drive-auth-helper.js test
```
...
```bash
node .claude-plugins/opspal-core/scripts/lib/google-drive-auth-helper.js check
```
...
```bash
node .claude-plugins/opspal-core/scripts/lib/google-drive-auth-helper.js setup
```
...
```bash
node .claude-plugins/opspal-core/scripts/lib/google-drive-auth-helper.js whoami
```
...
```bash
node .claude-plugins/opspal-core/scripts/lib/google-drive-auth-helper.js revoke
```
