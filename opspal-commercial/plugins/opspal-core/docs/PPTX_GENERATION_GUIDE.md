...
The OpsPal Core includes offline PPTX generation built on a shared slide spec. This pipeline produces branded PowerPoint decks from markdown without external APIs.
