...
**Location:** `.claude-plugins/opspal-core/scripts/lib/cohort-fix-planner.js`  
...
```javascript
const { CohortFixPlanner } = require('./.claude-plugins/opspal-core/scripts/lib/cohort-fix-planner');
...
node .claude-plugins/opspal-core/scripts/lib/cohort-fix-planner.js tool-contract
