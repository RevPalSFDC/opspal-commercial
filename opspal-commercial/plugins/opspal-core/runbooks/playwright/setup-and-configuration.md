...
node .claude-plugins/opspal-core/scripts/lib/playwright-mcp-helper.js help

# Verify session status
node .claude-plugins/opspal-core/scripts/lib/playwright-mcp-helper.js check-session myorg salesforce
```
