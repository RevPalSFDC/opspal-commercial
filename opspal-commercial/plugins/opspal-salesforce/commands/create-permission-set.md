...
argument-hint: "--name Sales_Manager --template sales-user"
...
- **Templates**: `.claude-plugins/opspal-salesforce/templates/permission-sets/`
- **Scripts**: `.claude-plugins/opspal-salesforce/scripts/lib/permission-*.js`
