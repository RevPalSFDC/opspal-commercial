...
3. Run LWC validation: `node scripts/lib/lwc-apex-field-validator.js <component-path> [apex-class-path]`
...
8. For comprehensive validation, optionally run:
   - `node scripts/unified-syntax-validator.js --type lwc --path <component-path> --org <org-alias>`
