...
node scripts/lib/debug-log-manager.js cleanup myorg --retention 7

# Dry run to preview
node scripts/lib/debug-log-manager.js cleanup myorg --dry-run

# Trace flags only
node scripts/lib/debug-log-manager.js cleanup myorg --trace-flags-only
```
