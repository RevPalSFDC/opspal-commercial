 ...
 *   node scripts/lib/bulk-job-status-checker.js delta-production Contact
 *
 ...
 *
 *   # Get JSON output
 *   node scripts/lib/bulk-job-status-checker.js delta-production Contact --json
 */
...
Examples:
  # Check for Contact transfer jobs
  node bulk-job-status-checker.js delta-production Contact
