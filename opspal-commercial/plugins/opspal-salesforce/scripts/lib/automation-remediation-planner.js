...
if (require.main === module) {
  ...
  if (!auditDir) {
    ...
    console.error('  node automation-remediation-planner.js instances/gamma-corp/automation-audit-1234567890/');
    console.error('  node automation-remediation-planner.js instances/gamma-corp/automation-audit-1234567890/ --object=Account');
    process.exit(1);
  }
