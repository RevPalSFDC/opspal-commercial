...
if (require.main === module) {
  ...
  if (args.length < 2) {
    console.log('Usage: generate-pdf-enhanced.js <output-dir> <output.pdf> [--org <name>] [--version <ver>] [--verbose]');
    ...
    console.log('\nExample:');
    console.log('  node generate-pdf-enhanced.js ./reports output.pdf --org "gamma-corp" --version "3.29.0" --verbose');
    process.exit(1);
  }
  ...
  generator.generate(documents, outputPdf, { orgName, version })
    .then(() => {
