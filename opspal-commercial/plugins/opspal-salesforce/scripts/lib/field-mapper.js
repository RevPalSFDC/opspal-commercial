 ...
 *   const mapper = new FieldMapper('beta-production');
 *
...
if (require.main === module) {
    (async () => {
        ...
        if (args.length < 3) {
            ...
            console.log('  field-mapper.js beta-production Contact "First Touch Campaign"');
            console.log('  field-mapper.js beta-production --stats');
            console.log('  field-mapper.js beta-production --clear Contact');
            process.exit(1);
        }
