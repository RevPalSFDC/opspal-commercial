 ...
 *   WORKSPACE_DIR - Override workspace base directory (default: uses current working directory)
...
function createSnapshot(org, runbookPath, options = {}) {
  ...
  const workspaceBase = process.env.WORKSPACE_DIR || process.cwd();
...
function printUsage() {
  ...
  console.log('  node runbook-versioner.js --org delta-sandbox');
  console.log('');
  console.log('  # Create minor version bump');
  console.log('  node runbook-versioner.js --org delta-sandbox --bump minor');
  console.log('');
  console.log('  # List versions');
  console.log('  node runbook-versioner.js --org delta-sandbox --action list');
  console.log('');
  console.log('  # Get specific version path');
  console.log('  node runbook-versioner.js --org delta-sandbox --action get --version v1.2.0');
}
