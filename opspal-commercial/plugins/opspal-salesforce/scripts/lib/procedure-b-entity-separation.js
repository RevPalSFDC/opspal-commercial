...
class ProcedureBEntitySeparation {
    ...
    async queryDeletedRecord() {
        ...
        const query = `SELECT Id, Name, IsDeleted, MasterRecordId, Website, BillingCity, BillingState FROM Account WHERE IsDeleted = true AND MasterRecordId = '${this.survivorId}'`;
...
Examples:
  ...
  node procedure-b-entity-separation.js epsilon-corp2021-revpal 001xx000ABC --dry-run
