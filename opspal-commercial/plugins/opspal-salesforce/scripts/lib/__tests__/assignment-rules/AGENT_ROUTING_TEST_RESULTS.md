...
**File**: `.claude-plugins/opspal-salesforce/agents/sfdc-sales-operations.md`
...
**File**: `.claude-plugins/opspal-salesforce/agents/sfdc-automation-auditor.md`
...
**File**: `.claude-plugins/opspal-salesforce/agents/sfdc-deployment-manager.md`
...
**Skill Location**: `.claude-plugins/opspal-salesforce/skills/assignment-rules-framework/`
...
**Script Location**: `.claude-plugins/opspal-salesforce/scripts/lib/`
