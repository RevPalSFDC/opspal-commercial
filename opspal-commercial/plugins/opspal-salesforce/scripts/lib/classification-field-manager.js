 ...
 * const manager = new ClassificationFieldManager('delta-production');
...
Examples:
  node classification-field-manager.js clear Contact delta-production
  node classification-field-manager.js stats Contact delta-production
  node classification-field-manager.js apply Contact analysis.json delta-production
        `);
        process.exit(0);
    }
