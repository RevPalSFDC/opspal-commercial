...
- **User Guide**: `.claude-plugins/opspal-salesforce/docs/ASSIGNMENT_RULES_GUIDE.md`
- **Skill Reference**: `.claude-plugins/opspal-salesforce/skills/assignment-rules-framework/SKILL.md`
- **CLI Commands**: `.claude-plugins/opspal-salesforce/skills/assignment-rules-framework/cli-command-reference.md`
- **Conflict Detection**: `.claude-plugins/opspal-salesforce/skills/assignment-rules-framework/conflict-detection-rules.md`
