...
- **create-beta-corp-tasks.js**: Create Asana Tasks for beta-corp Production Salesforce Work (2025-09-30)
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/add-custom-patterns.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/add-disallowed-tools-to-agents.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/advanced-field-deployer.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/agent-health-monitor.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/agent-testing-framework.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/analyze-2025-renewals.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/analyze-automation-metadata.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/analyze-frontend.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/analyze-validator-telemetry.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/audit-report-generator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/auto-agent-router.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/check-init.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/check-progress.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/config-manager.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-accounts-contacts-diagram.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-activity-reports.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-lucid-masters-mcp.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-lucid-with-zip.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-master-templates-lucid.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-master-templates.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-populated-lucid-diagram.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-real-lucid-diagram.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-real-master-templates.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-report-safe.js
```

---

### create-beta-corp-tasks.js
**Purpose:** Create Asana Tasks for beta-corp Production Salesforce Work (2025-09-30)

**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/create-beta-corp-tasks.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/dashboard-refresh-system.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/deployment-verifier.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/diagnostic-mcp-connectivity.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/discover-task-report-type.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/enrich-leads-with-gov-classification.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/example-with-project-validation.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/false-positive-regression-tests.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/field-deployment-validator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/field-verification-service.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/first-run-wizard.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/fix-soql-query.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/generate-agent-prompts.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/generate-automation-package.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/gong-dashboard-enhancer.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/gong-formula-library.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/gong-list-view-generator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/gong-report-builder.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/integrate-gates-to-agents.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/lucid-create-test-diagrams.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/lucid-create.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/mcp-validation-framework.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/monitor-agent-responses.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/monitor-bulk-job.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/monitoring-dashboard.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/object-analysis-engine.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/object-audit.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/renewal-audit-2025-fixed.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/renewal-audit-2025.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/repair-dashboard-report-summaries.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/report-api-diagnostic.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/report-creation-validator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/report-dashboard-format-audit.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/report-type-resolver.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/report-workarounds.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/route-and-validate.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/salesforce-id-verifier.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/scrape-sf-connected-apps.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/scrape-sf-cpq-pricing-config.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/scrape-sf-permission-assignments.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/scrape-sf-setup-audit-trail.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/send-slack-notification.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/setup-lucid-templates.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/sfdc-activity-query.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/sfdc-activity-reports.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/sfdc-pre-deployment-validator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/smoke.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/soql-query-builder.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/soql-query-rewriter.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/soql-report-converter.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/soql-validator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/submit-validator-feedback.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/sync-disallowed-tools.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-agent-runbook-references.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-auto-bootstrap.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-context-loading.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-date-fix.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-diagram-creation.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-frontend-audit-v2.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-improvements.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-lucid-creation.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-lucid-import.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-lucid-integration.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-lucid-real-creation.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-lucid-sfdc-objects.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-lucid-with-real-api.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-new-tenant-bootstrap.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-report-validation.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/test-universal-report.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/tool-inventory.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/unified-syntax-validator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/update-agent-date-context.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/update-assignee-mcp.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/update-task-assignee.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/validate-asana-compliance.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/validate-organization.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/validate-phase4-automation.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/validate-playbook-usage.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/validate-runbook-content.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/validation-first-creator.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/verify-integration-points.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/verify-master-templates.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/verify-workflow-migration.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/webhook-alerting.js
```
...
**Usage:**
```bash
node .claude-plugins/opspal-salesforce/scripts/week-1-test-runner.js
```
