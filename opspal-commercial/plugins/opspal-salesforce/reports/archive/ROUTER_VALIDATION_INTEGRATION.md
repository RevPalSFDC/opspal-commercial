...
2. **salesforce-plugin** with auto-agent-router:
   ```bash
   ls .claude-plugins/opspal-salesforce/scripts/auto-agent-router.js
   # Should exist
   ```
...
```bash
node .claude-plugins/opspal-salesforce/scripts/route-and-validate.js route \
...
```bash
node .claude-plugins/opspal-salesforce/scripts/route-and-validate.js validate \
...
```bash
node .claude-plugins/opspal-salesforce/scripts/route-and-validate.js full \
  --operation "analyze field usage in delta-corp-prod" \
...
```bash
node .claude-plugins/opspal-salesforce/scripts/route-and-validate.js stats
...
```bash
node .claude-plugins/opspal-salesforce/scripts/route-and-validate.js test
