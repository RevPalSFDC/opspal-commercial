...
```bash
/design-layout --object Contact --persona sales-rep --org acme-production --include-classic --verbose
```
...
```bash
/design-layout --object Opportunity --persona sales-rep --org acme-production --include-classic
```
...
```bash
/design-layout --object Case --persona support-agent --org acme-production
```
...
```bash
/design-layout --object Lead --persona sales-manager --org acme-production
```
...
1. Deploy CompactLayouts to acme-production sandbox
2. Deploy FlexiPages to acme-production sandbox
...
6. ⬜ Deploy CompactLayout to acme-production
...
- [ ] Deployment test to acme-production
