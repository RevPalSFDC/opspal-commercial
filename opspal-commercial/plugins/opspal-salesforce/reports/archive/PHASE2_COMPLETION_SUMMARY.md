...
node bulk-decision-generator.js process acme-production pairs.json \
    --batch-size 500 \
    --concurrency 10 \
...
**Test Org Sizes**:
1. **epsilon-corp** (12 accounts): Small org, quick iteration
2. **acme-corp** (37,466 accounts): Medium org, performance validation
3. **delta-corp** (10k+ accounts): Large org, scalability validation
