...
HOOK_LOGGER="${SCRIPT_DIR}/../../opspal-core/scripts/lib/hook-logger.js"
...
ENV_CONFIG_VALIDATOR="${SCRIPT_DIR}/../../opspal-core/scripts/lib/env-config-validator.js"
...
PRE_OP_ORCHESTRATOR="${SCRIPT_DIR}/../../opspal-core/scripts/lib/pre-operation-validation-orchestrator.js"
