...
# Run benchmark
node scripts/lib/SCRIPT_NAME.js benchmark
...
node scripts/lib/agent-profiler.js --agent sfdc-data-operations --profile
...
node scripts/lib/generate-audit-report.js --output AUDIT_REPORT.md
```
