...
**Files Modified**:
- `.claude-plugins/opspal-salesforce/scripts/lib/submit-reflection.js`
- `.claude-plugins/opspal-hubspot/scripts/lib/submit-reflection.js`
...
**File**: `.claude-plugins/opspal-salesforce/scripts/lib/fix-invalid-reflections.js`
...
node .claude-plugins/opspal-salesforce/scripts/lib/fix-invalid-reflections.js --delete-invalid
```
...
for f in /tmp/test*.json; do
  echo "Testing $f:"
  node scripts/lib/submit-reflection.js "$f" 2>&1 | head -5
  echo ""
done
```
...
- **Reflection Command**: `.claude-plugins/opspal-salesforce/commands/reflect.md`
...
- **Pre-Reflect Hook**: `.claude-plugins/opspal-salesforce/hooks/pre-reflect.sh`
