...
**Location**: `.claude-plugins/opspal-salesforce/docs/FLOW_VERSION_MANAGEMENT.md`
...
**Location**: `.claude-plugins/opspal-salesforce/docs/FLOW_DESIGN_BEST_PRACTICES.md`
...
**Location**: `.claude-plugins/opspal-salesforce/docs/FLOW_ELEMENTS_REFERENCE.md`
...
**Location**: `.claude-plugins/opspal-salesforce/scripts/lib/flow-version-manager.js`
...
**Location**: `.claude-plugins/opspal-salesforce/scripts/lib/flow-best-practices-validator.js`
...
**Location**: `.claude-plugins/opspal-salesforce/agents/sfdc-automation-builder.md`
...
node scripts/lib/flow-version-manager.js getActiveVersion Account_Record_Trigger my-org
# Output: Version 4 is active

# 2. Modify Flow (edit Flow-meta.xml)

# 3. Validate design
node scripts/lib/flow-best-practices-validator.js ./flows/Account_Record_Trigger.flow-meta.xml --verbose
...
node scripts/lib/flow-version-manager.js listVersions Account_Record_Trigger my-org
# Output:
# Version 5: Active (TODAY - HAS BUG)
# Version 4: Inactive (LAST WEEK - GOOD)

# 2. Activate previous version
node scripts/lib/flow-version-manager.js activateVersion Account_Record_Trigger 4 my-org
...
for flow in force-app/main/default/flows/*.flow-meta.xml; do
  ...
  node scripts/lib/flow-best-practices-validator.js "$flow" --json >> flow-audit-report.json
done
```
