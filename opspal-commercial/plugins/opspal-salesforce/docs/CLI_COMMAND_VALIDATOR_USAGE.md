...
```bash
# Test a command
node scripts/lib/cli-command-validator.js "sf data query --query 'SELECT Id FROM Account'"
# Exit code: 0 (valid) or 1 (invalid)

# Test invalid command
node scripts/lib/cli-command-validator.js "sf data export"
...
```
.claude-plugins/opspal-salesforce/data/sf-cli-command-reference.json
```
...
node scripts/lib/cli-command-validator.js "sf data export"  # Should fail
node scripts/lib/cli-command-validator.js "sf data query --query 'SELECT Id FROM Account'"  # Should pass
node scripts/lib/cli-command-validator.js "sf project deploy start --source-path force-app"  # Should warn
```
