...
```bash
node scripts/lib/picklist-describer.js describe Account
```
...
node scripts/lib/picklist-describer.js dependency Account Account_Type__c Industry
...
node scripts/examples/create-picklist-dependency-workflow.js --interactive
