...
- `bash .claude-plugins/opspal-salesforce/test/governance/run-all-tests.sh`
- `HOME=$PWD node .claude-plugins/opspal-salesforce/test/governance/integration.test.js`
- `node .claude-plugins/opspal-salesforce/test/flow-author.test.js`
- `node .claude-plugins/opspal-salesforce/test/flow-deployment-manager.test.js`
- `node .claude-plugins/opspal-salesforce/test/routing-performance-tests.js`
- Phase 1.2 validator tests (direct mocha to avoid network install):
  - `./.claude-plugins/opspal-salesforce/node_modules/.bin/mocha .claude-plugins/opspal-salesforce/test/metadata-dependency-analyzer.test.js --reporter spec`
  - `./.claude-plugins/opspal-salesforce/node_modules/.bin/mocha .claude-plugins/opspal-salesforce/test/flow-xml-validator.test.js --reporter spec`
  - `./.claude-plugins/opspal-salesforce/node_modules/.bin/mocha .claude-plugins/opspal-salesforce/test/csv-parser-safe.test.js --reporter spec`
  - `./.claude-plugins/opspal-salesforce/node_modules/.bin/mocha .claude-plugins/opspal-salesforce/test/automation-feasibility-analyzer.test.js --reporter spec`
- `bash .claude-plugins/opspal-salesforce/test/run-integration-tests.sh --report`
- Phase 6 layout tests (acme-corp-staging):
  `SFDC_INSTANCE=acme-corp-staging INSTANCE_DIR=/home/chris/Desktop/RevPal/Agents/opspal-internal/SFDC/instances/acme-corp-staging bash .claude-plugins/opspal-salesforce/test/run-phase6-tests.sh`
- Phase 6 layout tests (epsilon-corp2021-revpal):
  `SFDC_INSTANCE=epsilon-corp2021-revpal INSTANCE_DIR=/home/chris/Desktop/RevPal/Agents/opspal-internal/SFDC/instances/epsilon-corp2021-revpal bash .claude-plugins/opspal-salesforce/test/run-phase6-tests.sh`
...
- Governance hook checks (non-interactive mode):
  - `HOME=$PWD AGENT_NAME=sfdc-discovery ... bash .claude-plugins/opspal-salesforce/hooks/universal-agent-governance.sh`
  - `HOME=$PWD AGENT_NAME=sfdc-data-operations ... bash .claude-plugins/opspal-salesforce/hooks/universal-agent-governance.sh`
  - `HOME=$PWD AGENT_NAME=sfdc-cli-executor ... bash .claude-plugins/opspal-salesforce/hooks/universal-agent-governance.sh`
  - `HOME=$PWD AGENT_NAME=sfdc-security-admin ... bash .claude-plugins/opspal-salesforce/hooks/universal-agent-governance.sh`
  - `HOME=$PWD AGENT_NAME=sfdc-dedup-safety-copilot ... bash .claude-plugins/opspal-salesforce/hooks/universal-agent-governance.sh`
  - `HOME=$PWD AGENT_NAME=sfdc-data-operations OPERATION_TYPE=UPDATE_RECORDS SALESFORCE_ENVIRONMENT=production RECORD_COUNT=5 bash .claude-plugins/opspal-salesforce/hooks/universal-agent-governance.sh`
  - `HOME=$PWD AGENT_NAME=sfdc-data-operations OPERATION_TYPE=UPDATE_RECORDS SALESFORCE_ENVIRONMENT=production RECORD_COUNT=5 GOVERNANCE_PREP_MODE=true bash .claude-plugins/opspal-salesforce/hooks/universal-agent-governance.sh`
...
- Integration test report (rerun): `.claude-plugins/opspal-salesforce/test/integration-test-report-2025-12-29.md` (PASS)
- Phase 6 results (acme-corp-staging): `/home/chris/Desktop/RevPal/Agents/opspal-internal/SFDC/instances/acme-corp-staging/phase6-tests/PHASE6_TEST_RESULTS_2025-12-29-093934.md`
- Phase 6 results (epsilon-corp2021-revpal): `/home/chris/Desktop/RevPal/Agents/opspal-internal/SFDC/instances/epsilon-corp2021-revpal/phase6-tests/PHASE6_TEST_RESULTS_2025-12-29-093230.md`
...
## Sandbox Validation (beta-corp Revpal)
...
## Org Validation (acme-corp Staging)

Status: PASS
- Phase 6 layout tests ran end-to-end against `acme-corp-staging` (19/19 passed, avg quality 88/100).
- Results: `/home/chris/Desktop/RevPal/Agents/opspal-internal/SFDC/instances/acme-corp-staging/phase6-tests/PHASE6_TEST_RESULTS_2025-12-29-093934.md`.

## Org Validation (epsilon-corp Revpal Sandbox)

Status: PASS
- Phase 6 layout tests ran end-to-end against `epsilon-corp2021-revpal` (19/19 passed, avg quality 88/100).
