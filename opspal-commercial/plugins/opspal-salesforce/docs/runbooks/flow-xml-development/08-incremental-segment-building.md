...
```javascript
const FlowSubflowExtractor = require('./scripts/lib/flow-subflow-extractor');
...
node scripts/lib/export-segment-metadata.js WorkingFlow > working-segments.json

# Compare with current flow
node scripts/lib/export-segment-metadata.js CurrentFlow > current-segments.json
