...
```bash
node scripts/lib/create-flow-test-data.js \
...
node scripts/lib/flow-dependency-analyzer.js \
...
node scripts/lib/org-readiness-checker.js --org production
...
SFDC_INSTANCE=acme-corp-staging python3 .claude-plugins/opspal-salesforce/scripts/lib/validate_and_deploy_flow.py
...
- **Deployment Manager**: `.claude-plugins/opspal-salesforce/scripts/lib/flow-deployment-manager.js`
- **Order of Operations**: `.claude-plugins/opspal-salesforce/docs/ORDER_OF_OPERATIONS_LIBRARY.md`
- **CI/CD Pipeline**: `.claude-plugins/opspal-salesforce/docs/FLOW_CICD_GUIDE.md`
