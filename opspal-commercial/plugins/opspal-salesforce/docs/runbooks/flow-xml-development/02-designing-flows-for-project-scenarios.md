...
```bash
node scripts/lib/flow-pattern-migrator.js --type workflow --input WorkflowRule.xml --output MigratedFlow.flow-meta.xml
```
...
node scripts/lib/flow-consolidation-validator.sh Account
...
|--------|----------|---------------|
| **flow-pattern-migrator.js** | Workflow Rule ’ Flow migration | `scripts/lib/flow-pattern-migrator.js` |
| **flow-consolidation-validator.sh** | Identify consolidation opportunities | `scripts/lib/flow-consolidation-validator.sh` |
| **flow-decision-logic-analyzer.js** | Validate complex decision trees | `scripts/lib/flow-decision-logic-analyzer.js` |
| **flow-conflict-analyzer.js** | Detect conflicting Flows | `scripts/lib/flow-conflict-analyzer.js` |
