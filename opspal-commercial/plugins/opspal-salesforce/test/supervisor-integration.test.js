...
const testCases = [
    // High complexity triggers (note: some have mandatory overrides)
    {
        ...
        expectedAgent: "sfdc-deployment-manager", // Deployment keyword routes here
        expectedReason: /pattern match|deployment/i,
        description: "High complexity production deployment (routes to deployment manager)"
    },
    ...
    {
        input: "Scheduled Apex job failed to update rollups. Error: Illegal assignment from Datetime to Date. Review Rollup Summary Schedule Items.",
        expectedAgent: "sfdc-field-analyzer",
        expectedReason: /rollup field\/type error signature|pattern match|keyword match/i,
        description: "Apex rollup type-conversion failure routes to field analyzer"
    },
...
describe('Supervisor Integration', () => {
    it('should pass all supervisor-auditor integration tests', async () => {
