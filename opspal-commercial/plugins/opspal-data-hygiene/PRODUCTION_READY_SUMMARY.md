...
node .claude-plugins/opspal-data-hygiene/scripts/lib/dedup-snapshot-generator.js ./dedup-config.json
...
```bash
# View summary
node .claude-plugins/opspal-data-hygiene/scripts/lib/dedup-ledger.js summary dedupe-20251014-1200

# List failed operations
node .claude-plugins/opspal-data-hygiene/scripts/lib/dedup-ledger.js list dedupe-20251014-1200 failed

# Export to CSV for auditing
node .claude-plugins/opspal-data-hygiene/scripts/lib/dedup-ledger.js export dedupe-20251014-1200 ./audit.csv
```
...
```bash
# Copy template
cp .claude-plugins/opspal-data-hygiene/templates/dedup-config.template.json ./dedup-config.json
...
**Tested**: Validated against delta-corp cleanup (10,000+ companies, 12,000+ operations, 100% success rate)
